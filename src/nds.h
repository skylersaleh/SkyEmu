...
//////////////////////////////////////////////////////////////////////////////////////////
// MMIO Register listing from GBATEK
...
#define NDS9_DMA0FILL 0x40000E0 /* NDS9 only - DMA0FILL - DMA 0 Filldata       \
                                   (R/W)*/
#define NDS9_DMA1FILL 0x40000E4 /* NDS9 only - DMA1FILL - DMA 1 Filldata       \
                                   (R/W)*/
#define NDS9_DMA2FILL 0x40000E8 /* NDS9 only - DMA2FILL - DMA 2 Filldata       \
                                   (R/W)*/
#define NDS9_DMA3FILL 0x40000EC /* NDS9 only - DMA3FILL - DMA 3 Filldata       \
                                   (R/W)*/
// Timer Registers
...
#define GBA_SIODATA32                                                          \
  0x4000120 /*R/W   SIO Data (Normal-32bit Mode; shared with below) */
#define GBA_SIOMULTI0                                                          \
  0x4000120 /*R/W   SIO Data 0 (Parent)    (Multi-Player Mode) */
#define GBA_SIOMULTI1                                                          \
  0x4000122 /*R/W   SIO Data 1 (1st Child) (Multi-Player Mode) */
#define GBA_SIOMULTI2                                                          \
  0x4000124 /*R/W   SIO Data 2 (2nd Child) (Multi-Player Mode) */
#define GBA_SIOMULTI3                                                          \
  0x4000126 /*R/W   SIO Data 3 (3rd Child) (Multi-Player Mode) */
#define GBA_SIOCNT 0x4000128 /*R/W   SIO Control Register */
#define GBA_SIOMLT_SEND                                                        \
  0x400012A /*R/W   SIO Data (Local of MultiPlayer; shared below) */
...
#define NDS9_GC_ENC0_HI                                                        \
  0x040001B8 /*Gamecard Encryption Seed 0 Upper 7bit (bit7-15 unused)*/
#define NDS9_GC_ENC1_HI                                                        \
  0x040001BA /*Gamecard Encryption Seed 1 Upper 7bit (bit7-15 unused)*/
...
#define NDS9_DIVREM_RESULT                                                     \
  0x040002A8                    /* Division Remainder (=Numer MOD Denom) (R) */
...
#define NDS9_CLRIMAGE_OFFSET                                                   \
  0x04000356                       /* Rear-plane Bitmap Scroll Offsets (W) */
...
#define NDS9_MTX_RESTORE 0x04000450 /* Restore Current Matrix from Stack (W)   \
                                     */
#define NDS9_MTX_IDENTITY                                                      \
  0x04000454 /* Load Unit Matrix to Current Matrix (W) */
...
#define NDS9_MTX_LOAD_4x3 0x0400045C /* Load 4x3 Matrix to Current Matrix (W)  \
                                      */
#define NDS9_MTX_MULT_4x4                                                      \
  0x04000460 /* Multiply Current Matrix by 4x4 Matrix (W) */
#define NDS9_MTX_MULT_4x3                                                      \
  0x04000464 /* Multiply Current Matrix by 4x3 Matrix (W) */
#define NDS9_MTX_MULT_3x3                                                      \
  0x04000468 /* Multiply Current Matrix by 3x3 Matrix (W) */
#define NDS9_MTX_SCALE                                                         \
  0x0400046C /* Multiply Current Matrix by Scale Matrix (W) */
#define NDS9_MTX_TRANS                                                         \
  0x04000470                  /* Mult. Curr. Matrix by Translation Matrix (W) */
...
#define NDS9_DIF_AMB                                                           \
  0x040004C0 /* MaterialColor0 - Diffuse/Ambient Reflect. (W) */
#define NDS9_SPE_EMI                                                           \
  0x040004C4 /* MaterialColor1 - Specular Ref. & Emission (W) */
...
#define NDS9_BOX_TEST                                                          \
  0x040005C0 /* Test if Cuboid Sits inside View Volume (W) */
...
#define NDS9_GXSTAT 0x04000600 /* Geometry Engine Status Register (R and R/W)  \
                                */
#define NDS9_RAM_COUNT                                                         \
  0x04000604 /* Polygon List & Vertex RAM Count Register (R) */
#define NDS9_DISP_1DOT_DEPTH                                                   \
  0x04000610 /* 1-Dot Polygon Display Boundary Depth (W) */
#define NDS9_POS_RESULT 0x04000620 /* Position Test Results (R) */
#define NDS9_VEC_RESULT 0x04000630 /* Vector Test Results (R) */
#define NDS9_CLIPMTX_RESULT                                                    \
  0x04000640 /* Read Current Clip Coordinates Matrix (R) */
#define NDS9_VECMTX_RESULT                                                     \
  0x04000680 /* Read Current Directional Vector Matrix (R) */
...
#define NDS9_B_WINOUT                                                          \
  0x0400104A /* R/W Inside of OBJ Window & Outside of Windows */
...
#define NDS_IPCFIFORECV                                                        \
  (0x04100000 | NDS_IO_MAP_041_OFFSET) /* IPC Receive Fifo (R)*/
#define NDS_GC_BUS                                                             \
  (0x04100010 | NDS_IO_MAP_041_OFFSET) /* Gamecard bus 4-byte data in, for     \
                                          manual or dma read (R) (or W) */
...
#define NDS_GCBUS_SEED0_LO                                                     \
  0x040001B0 /* Gamecard Encryption Seed 0 Lower 32bit */
#define NDS_GCBUS_SEED1_LO                                                     \
  0x040001B4 /* Gamecard Encryption Seed 1 Lower 32bit */
#define NDS_GCBUS_SEED0_HI                                                     \
  0x040001B8 /* Gamecard Encryption Seed 0 Upper 7bit (bit7-15 unused) */
#define NDS_GCBUS_SEED1_HI                                                     \
  0x040001BA /* Gamecard Encryption Seed 1 Upper 7bit (bit7-15 unused) */
#define NDS7_SPI_BUS_CTL                                                       \
  0x040001C0 /* SPI bus Control (Firmware, Touchscreen, Powerman) */
...
#define NDS7_HALTCNT                                                           \
  0x04000301 /* HALTCNT (different bits than on GBA) (plus NOP delay) */
#define NDS7_POWCNT2                                                           \
  0x04000304 /* POWCNT2  Sound/Wifi Power Control Register (R/W) */
#define NDS7_BIOSPROT                                                          \
  0x04000308 /* BIOSPROT - Bios-data-read-protection address */
...
#define NDS7_SOUND0_CNT 0x04000400 /* Sound Channel 0 Control Register (R/W)   \
                                    */
#define NDS7_SOUND0_SAD                                                        \
  0x04000404 /* Sound Channel 0 Data Source Register (W) */
...
#define NDS7_SOUND1_CNT 0x04000410 /* Sound Channel 1 Control Register (R/W)   \
                                    */
#define NDS7_SOUND1_SAD                                                        \
  0x04000414 /* Sound Channel 1 Data Source Register (W) */
...
#define NDS7_SOUND2_CNT 0x04000420 /* Sound Channel 2 Control Register (R/W)   \
                                    */
#define NDS7_SOUND2_SAD                                                        \
  0x04000424 /* Sound Channel 2 Data Source Register (W) */
...
#define NDS7_SOUND3_CNT 0x04000430 /* Sound Channel 3 Control Register (R/W)   \
                                    */
#define NDS7_SOUND3_SAD                                                        \
  0x04000434 /* Sound Channel 3 Data Source Register (W) */
...
#define NDS7_SOUND4_CNT 0x04000440 /* Sound Channel 4 Control Register (R/W)   \
                                    */
#define NDS7_SOUND4_SAD                                                        \
  0x04000444 /* Sound Channel 4 Data Source Register (W) */
...
#define NDS7_SOUND5_CNT 0x04000450 /* Sound Channel 5 Control Register (R/W)   \
                                    */
#define NDS7_SOUND5_SAD                                                        \
  0x04000454 /* Sound Channel 5 Data Source Register (W) */
...
#define NDS7_SOUND6_CNT 0x04000460 /* Sound Channel 6 Control Register (R/W)   \
                                    */
#define NDS7_SOUND6_SAD                                                        \
  0x04000464 /* Sound Channel 6 Data Source Register (W) */
...
#define NDS7_SOUND7_CNT 0x04000470 /* Sound Channel 7 Control Register (R/W)   \
                                    */
#define NDS7_SOUND7_SAD                                                        \
  0x04000474 /* Sound Channel 7 Data Source Register (W) */
...
#define NDS7_SOUND8_CNT 0x04000480 /* Sound Channel 8 Control Register (R/W)   \
                                    */
#define NDS7_SOUND8_SAD                                                        \
  0x04000484 /* Sound Channel 8 Data Source Register (W) */
...
#define NDS7_SOUND9_CNT 0x04000490 /* Sound Channel 9 Control Register (R/W)   \
                                    */
#define NDS7_SOUND9_SAD                                                        \
  0x04000494 /* Sound Channel 9 Data Source Register (W) */
...
#define NDS7_SOUNDA_CNT 0x040004A0 /* Sound Channel 10 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDA_SAD                                                        \
  0x040004A4 /* Sound Channel 10 Data Source Register (W) */
...
#define NDS7_SOUNDB_CNT 0x040004B0 /* Sound Channel 11 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDB_SAD                                                        \
  0x040004B4 /* Sound Channel 11 Data Source Register (W) */
...
#define NDS7_SOUNDC_CNT 0x040004C0 /* Sound Channel 12 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDC_SAD                                                        \
  0x040004C4 /* Sound Channel 12 Data Source Register (W) */
...
#define NDS7_SOUNDD_CNT 0x040004D0 /* Sound Channel 13 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDD_SAD                                                        \
  0x040004D4 /* Sound Channel 13 Data Source Register (W) */
...
#define NDS7_SOUNDE_CNT 0x040004E0 /* Sound Channel 14 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDE_SAD                                                        \
  0x040004E4 /* Sound Channel 14 Data Source Register (W) */
...
#define NDS7_SOUNDF_CNT 0x040004F0 /* Sound Channel 15 Control Register (R/W)  \
                                    */
#define NDS7_SOUNDF_SAD                                                        \
  0x040004F4 /* Sound Channel 15 Data Source Register (W) */
...
#define NDS7_SNDCAP1CNT 0x04000509 /* Sound Capture 1 Control Register (R/W)   \
                                    */
#define NDS7_SNDCAP0DAD                                                        \
  0x04000510 /* Sound Capture 0 Destination Address (R/W) */
#define NDS7_SNDCAP0LEN 0x04000514 /* Sound Capture 0 Length (W) */
#define NDS7_SNDCAP1DAD                                                        \
  0x04000518 /* Sound Capture 1 Destination Address (R/W) */
...
mmio_reg_t nds9_io_reg_desc[] = {
    ...
    {GBA_GREENSWP,
     "GREENSWP",
     {{0, 1,
       "Green Swap  (0=Normal, 1=Swap)"}}}, /* R/W Undocumented - Green Swap */
    {GBA_DISPSTAT,
     "DISPSTAT",
     {
         {
             0,
             1,
             "V-Blank flag (1=VBlank) (set in line 160..226; not 227",
         },
         {
             1,
             1,
             "H-Blank flag (1=HBlank) (toggled in all lines, 0..227",
         },
         {
             2,
             1,
             "V-Counter flag (1=Match) (set in selected line)",
         },
         {
             3,
             1,
             "V-Blank IRQ Enable (1=Enable)",
         },
         {
             4,
             1,
             "H-Blank IRQ Enable (1=Enable)",
         },
         {
             5,
             1,
             "V-Counter IRQ Enable (1=Enable)",
         },
         {
             6,
             1,
             "DSi: LCD Initialization Ready (0=Busy, 1=Ready",
         },
         {
             7,
             1,
             "NDS: MSB of V-Vcount Setting (LYC.Bit8) (0..262",
         },
         {
             8,
             8,
    ...
    {GBA_VCOUNT, "VCOUNT  ", {{0, 8, "LCD-Y"}}}, /* R   Vertical Counter (LY) */
    {GBA_BG0CNT,
     "BG0CNT  ",
     {
         ...
         {13, 1,
          "BG0/BG1: (NDS: Ext Palette ) BG2/BG3: Overflow (0=Transp, 1=Wrap)"},
    ...
    {NDS_DISP3DCNT,
     "DISP3DCNT",
     {
         ...
         {2, 1,
          "Alpha-Test           (0=Disable, 1=Enable) (see ALPHA_TEST_REF)"},
         {3, 1,
          "Alpha-Blending       (0=Disable, 1=Enable) (see various Alpha "
          "values)"},
         {4, 1, "Anti-Aliasing        (0=Disable, 1=Enable)"},
         {5, 1, "Edge-Marking         (0=Disable, 1=Enable) (see EDGE_COLOR)"},
         {6, 1,
          "Fog Color/Alpha Mode (0=Alpha and Color, 1=Only Alpha) (see "
          "FOG_COLOR)"},
         {7, 1, "Fog Master Enable    (0=Disable, 1=Enable)"},
         {8, 4,
          "Fog Depth Shift      (FOG_STEP=400h shr FOG_SHIFT) (see "
          "FOG_OFFSET)"},
         {12, 1,
    ...
    {NDS_DISPCAPCNT,
     "DISPCAPCNT",
     {
         ...
         {16, 2,
          "VRAM Write Block  (0..3 = VRAM A..D) (VRAM must be allocated to "
          "LCDC)"},
         {18, 2, "VRAM Write Offset (0=00000h, 0=08000h, 0=10000h, 0=18000h)"},
         {20, 2,
          "Capture Size      (0=128x128, 1=256x64, 2=256x128, 3=256x192 dots)"},
         {24, 1,
          "Source A          (0=Graphics Screen BG+3D+OBJ, 1=3D Screen)"},
         {25, 1, "Source B          (0=VRAM, 1=Main Memory Display FIFO)"},
         {26, 2, "VRAM Read Offset  (0=00000h, 0=08000h, 0=10000h, 0=18000h)"},
         {29, 2,
          "Capture Source    (0=Source A, 1=Source B, 2/3=Sources A+B "
          "blended)"},
         {31, 1, "Capture Enable    (0=Disable/Ready, 1=Enable/Busy)"},
     }}, /* Display Capture Control Register (R/W) */
    {NDS_DISP_MMEM_FIFO,
     "DISP_MMEM_FIFO",
     {0}}, /* Main Memory Display FIFO (R?/W) */
    {NDS_A_MASTER_BRIGHT,
     "A_MASTER_BRIGHT",
     {
         {0, 5,
          "Factor used for 6bit R,G,B Intensities (0-16, values >16 same as "
          "16)"},
    ...
    {GBA_DMA0CNT_H,
     "DMA0CNT_H",
     {
         ...
         {11, 3,
          "DMA Start Timing (0=Immediately, 1=VBlank, 2=HBlank, 3=Video, "
          "4=Main memory display, 5=DS Cartridge Slot, 6=GBA Cartridge Slot, "
    ...
    {GBA_SIODATA32,
     "SIODATA32",
     {0}}, /*R/W   SIO Data (Normal-32bit Mode; shared with below) */
    {GBA_SIOMULTI0,
     "SIOMULTI0",
     {0}}, /*R/W   SIO Data 0 (Parent)    (Multi-Player Mode) */
    {GBA_SIOMULTI1,
     "SIOMULTI1",
     {0}}, /*R/W   SIO Data 1 (1st Child) (Multi-Player Mode) */
    {GBA_SIOMULTI2,
     "SIOMULTI2",
     {0}}, /*R/W   SIO Data 2 (2nd Child) (Multi-Player Mode) */
    {GBA_SIOMULTI3,
     "SIOMULTI3",
     {0}}, /*R/W   SIO Data 3 (3rd Child) (Multi-Player Mode) */
    {GBA_SIOCNT, "SIOCNT", {0}}, /*R/W   SIO Control Register */
    {GBA_SIOMLT_SEND,
     "SIOMLT_SEND",
     {0}}, /*R/W   SIO Data (Local of MultiPlayer; shared below) */
    {GBA_SIODATA8,
     "SIODATA8",
     {0}}, /*R/W   SIO Data (Normal-8bit and UART Mode) */
    ...
    {NDS9_AUXSPICNT,
     ...
     {
         {0, 2,
          "SPI Baudrate        (0=4MHz/Default, 1=2MHz, 2=1MHz, 3=512KHz)"},
         {6, 1,
         ...
         {14, 1,
          "Transfer Ready IRQ  (0=Disable, 1=Enable) (for ROM, not for "
          "AUXSPI)"},
         {15, 1,
          "NDS Slot Enable     (0=Disable, 1=Enable) (for both ROM and "
          "AUXSPI)"},
    ...
    {NDS_GCBUS_CTL,
     ...
     {
         {0, 13,
          "KEY1 gap1 length  (0-1FFFh) (forced min 08F8h by BIOS) (leading "
          "gap)"},
         {13, 1,
          "KEY2 encrypt data (0=Disable, 1=Enable KEY2 Encryption for Data)"},
         {14, 1, "Unknown (SE)"},
         {15, 1,
          "KEY2 Apply Seed   (0=No change, 1=Apply Encryption Seed) (Write "
          "only)"},
         {16, 6,
          "KEY1 gap2 length  (0-3Fh)   (forced min 18h by BIOS) (200h-byte "
          "gap)"},
         {22, 1,
          "KEY2 encrypt cmd  (0=Disable, 1=Enable KEY2 Encryption for "
          "Commands)"},
         ...
         {28, 1,
          "KEY1 Gap CLKs (0=Hold CLK High during gaps, 1=Output Dummy CLK "
          "Pulses)"},
         {29, 1,
          "RESB Release Reset  (0=Reset, 1=Release) (cannot be cleared once "
          "set)"},
         {30, 1,
          "Data Direction 'WR' (0=Normal/read, 1=Write, for FLASH/NAND carts)"},
         {31, 1,
          "Block Start/Status  (0=Ready, 1=Start/Busy) (IRQ See "
          "40001A0h/Bit14)"},
     }},                                /*Gamecard bus timing/control*/
    {NDS_GCBUS_CMD, "GC_BUS_CMD", {0}}, /*Gamecard bus 8-byte command out*/
    {NDS9_GC_ENC0_LO,
     "GC_ENC0_LO",
     {0}}, /*Gamecard Encryption Seed 0 Lower 32bit*/
    {NDS9_GC_ENC1_LO,
     "GC_ENC1_LO",
     {0}}, /*Gamecard Encryption Seed 1 Lower 32bit*/
    {NDS9_GC_ENC0_HI,
     "GC_ENC0_HI",
     {0}}, /*Gamecard Encryption Seed 0 Upper 7bit (bit7-15 unused)*/
    {NDS9_GC_ENC1_HI,
     "GC_ENC1_HI",
     {0}}, /*Gamecard Encryption Seed 1 Upper 7bit (bit7-15 unused)*/
    ...
    {NDS9_EXMEMCNT,
     ...
     {
         {0, 2,
          "32-pin GBA Slot SRAM Access Time    (0-3 = 10, 8, 6, 18 cycles)"},
         {2, 2,
          "32-pin GBA Slot ROM 1st Access Time (0-3 = 10, 8, 6, 18 cycles)"},
         {4, 1, "32-pin GBA Slot ROM 2nd Access Time (0-1 = 6, 4 cycles)"},
         {6, 2,
          "32-pin GBA Slot PHI-pin out   (0-3 = Low, 4.19MHz, 8.38MHz, "
          "16.76MHz)"},
         {7, 1, "32-pin GBA Slot Access Rights     (0=ARM9, 1=ARM7)"},
         {11, 1, "17-pin NDS Slot Access Rights     (0=ARM9, 1=ARM7)"},
         {13, 1,
          "NDS:Always set?  ;set/tested by DSi bootcode: Main RAM enable, CE2 "
          "pin?"},
         {14, 1,
          "Main Memory Interface Mode Switch (0=Async/GBA/Reserved, "
          "1=Synchronous)"},
         {15, 1,
          "Main Memory Access Priority       (0=ARM9 Priority, 1=ARM7 "
          "Priority)"},
    ...
    {NDS9_WRAMCNT,
     "WRAMCNT",
     {{0, 2,
       "WRAM Mode ARM9/ARM7 (0-3 = 32K/0K, 2nd 16K/1st 16K, 1st 16K/2nd 16K, "
       "0K/32K)"}}}, /* WRAM Bank Control (W) */
    ...
    {NDS9_SQRT_PARAM,
     "SQRT_PARAM",
     {0}}, /* Square Root Parameter Input (R/W) */
    {NDS9_POSTFLG,
     "POSTFLG",
     {
    ...
    {NDS9_POWCNT1,
     "POWCNT1",
     {
         ...
         {1, 1,
          "2D Graphics Engine A      (0=Disable) (Ports 008h-05Fh, Pal "
          "5000000h)"},
         {2, 1, "3D Rendering Engine       (0=Disable) (Ports 320h-3FFh)"},
         {3, 1, "3D Geometry Engine        (0=Disable) (Ports 400h-6FFh)"},
         {9, 1,
          "2D Graphics Engine B      (0=Disable) (Ports 1008h-105Fh, Pal "
          "5000400h)"},
         {15, 1,
    ...
    {NDS9_RDLINES_COUNT,
     "RDLINES_COUNT",
     {0}},                                /* Rendered Line Count Register (R) */
    {NDS9_EDGE_COLOR, "EDGE_COLOR", {0}}, /* Edge Colors 0..7 (W) */
    {NDS9_ALPHA_TEST_REF,
     "ALPHA_TEST_REF",
     {0}}, /* Alpha-Test Comparision Value (W) */
    {NDS9_CLEAR_COLOR,
     "CLEAR_COLOR",
     {0}}, /* Clear Color Attribute Register (W) */
    {NDS9_CLEAR_DEPTH, "CLEAR_DEPTH", {0}}, /* Clear Depth Register (W) */
    {NDS9_CLRIMAGE_OFFSET,
     "CLRIMAGE_OFFSET",
     {0}}, /* Rear-plane Bitmap Scroll Offsets (W) */
    ...
    {NDS9_MTX_RESTORE,
     "MTX_RESTORE",
     {0}}, /* Restore Current Matrix from Stack (W) */
    {NDS9_MTX_IDENTITY,
     "MTX_IDENTITY",
     {0}}, /* Load Unit Matrix to Current Matrix (W) */
    {NDS9_MTX_LOAD_4x4,
     "MTX_LOAD_4x4",
     {0}}, /* Load 4x4 Matrix to Current Matrix (W) */
    {NDS9_MTX_LOAD_4x3,
     "MTX_LOAD_4x3",
     {0}}, /* Load 4x3 Matrix to Current Matrix (W) */
    {NDS9_MTX_MULT_4x4,
     "MTX_MULT_4x4",
     {0}}, /* Multiply Current Matrix by 4x4 Matrix (W) */
    {NDS9_MTX_MULT_4x3,
     "MTX_MULT_4x3",
     {0}}, /* Multiply Current Matrix by 4x3 Matrix (W) */
    {NDS9_MTX_MULT_3x3,
     "MTX_MULT_3x3",
     {0}}, /* Multiply Current Matrix by 3x3 Matrix (W) */
    {NDS9_MTX_SCALE,
     "MTX_SCALE",
     {0}}, /* Multiply Current Matrix by Scale Matrix (W) */
    {NDS9_MTX_TRANS,
     "MTX_TRANS",
     {0}}, /* Mult. Curr. Matrix by Translation Matrix (W) */
    ...
    {NDS9_VTX_16,
     ...
     {{0, 16, "(Param 1)X Coord 1.3.12 fixed point"},
      ...
      {0, 16, "(Param 2)Z Coord 1.3.12 fixed point"}}}, /* Set Vertex XYZ
                                                           Coordinates (W) */
    ...
    {NDS9_TEXIMAGE_PARAM,
     "TEXIMAGE_PARAM",
     {0}}, /* Set Texture Parameters (W) */
    {NDS9_PLTT_BASE,
     "PLTT_BASE",
     {0}}, /* Set Texture Palette Base Address (W) */
    {NDS9_DIF_AMB,
     "DIF_AMB",
     {0}}, /* MaterialColor0 - Diffuse/Ambient Reflect. (W) */
    {NDS9_SPE_EMI,
     "SPE_EMI",
     {0}}, /* MaterialColor1 - Specular Ref. & Emission (W) */
    {NDS9_LIGHT_VECTOR,
     "LIGHT_VECTOR",
     {0}}, /* Set Light's Directional Vector (W) */
    {NDS9_LIGHT_COLOR, "LIGHT_COLOR", {0}}, /* Set Light Color (W) */
    {NDS9_SHININESS,
     "SHININESS",
     {0}}, /* Specular Reflection Shininess Table (W) */
    {NDS9_BEGIN_VTXS,
     "BEGIN_VTXS",
     {
         {0, 2,
          "Primitive Type(0=Triangles, 1=Quads, 2=Tri Strips, 3=Quad Strips"},
     }},                              /* Start of Vertex List (W) */
    {NDS9_END_VTXS, "END_VTXS", {0}}, /* End of Vertex List (W) */
    {NDS9_SWAP_BUFFERS,
     "SWAP_BUFFERS",
     {0}},                            /* Swap Rendering Engine Buffer (W) */
    {NDS9_VIEWPORT, "VIEWPORT", {0}}, /* Set Viewport (W) */
    {NDS9_BOX_TEST,
     "BOX_TEST",
     {0}}, /* Test if Cuboid Sits inside View Volume (W) */
    {NDS9_POS_TEST,
     "POS_TEST",
     {0}}, /* Set Position Coordinates for Test (W) */
    ...
    {NDS9_GXSTAT,
     "GXSTAT",
     {
         ...
         {8, 5,
          "Position & Vector Matrix Stack Level (0..31) (lower 5bit of 6bit "
          "value)"},
         {13, 1, "Projection Matrix Stack Level        (0..1)"},
         {14, 1,
          "Matrix Stack Busy (0=No, 1=Yes; Currently executing a Push/Pop "
          "command)"},
         {15, 1,
          "Matrix Stack Overflow/Underflow Error (0=No, "
          "1=Error/Acknowledge/Reset)"},
         {16, 9, "Number of 40bit-entries in Command FIFO  (0..256)"},
         {25, 1,
          "Command FIFO Less Than Half Full  (0=No, 1=Yes; Less than "
          "Half-full)"},
         {26, 1, "Command FIFO Empty                (0=No, 1=Yes; Empty)"},
         {27, 1,
          "Geometry Engine Busy (0=No, 1=Yes; Busy; Commands are executing)"},
         {30, 2,
          "Command FIFO IRQ (0=Never, 1=Less than half full, 2=Empty, "
          "3=Reserved)"},
     }}, /* Geometry Engine Status Register (R and R/W) */
    {NDS9_RAM_COUNT,
     "RAM_COUNT",
     {0}}, /* Polygon List & Vertex RAM Count Register (R) */
    {NDS9_DISP_1DOT_DEPTH,
     "DISP_1DOT_DEPTH",
     {0}}, /* 1-Dot Polygon Display Boundary Depth (W) */
    {NDS9_POS_RESULT, "POS_RESULT", {0}}, /* Position Test Results (R) */
    {NDS9_VEC_RESULT, "VEC_RESULT", {0}}, /* Vector Test Results (R) */
    {NDS9_CLIPMTX_RESULT,
     "CLIPMTX_RESULT",
     {0}}, /* Read Current Clip Coordinates Matrix (R) */
    {NDS9_VECMTX_RESULT,
     "VECMTX_RESULT",
     {0}}, /* Read Current Directional Vector Matrix (R) */
    {NDS9_B_DISPCNT,
     "(2D-B)DISPCNT ",
     {{0, 3, "BG Mode (0-5=Video Mode 0-5, 6-7=Prohibited)"},
    ...
    {NDS9_B_BG2PA,
     "(2D-B) BG2PA",
     {0}}, /* W   BG2 Rotation/Scaling Parameter A (dx) */
    {NDS9_B_BG2PB,
     "(2D-B) BG2PB",
     {0}}, /* W   BG2 Rotation/Scaling Parameter B (dmx) */
    {NDS9_B_BG2PC,
     "(2D-B) BG2PC",
     {0}}, /* W   BG2 Rotation/Scaling Parameter C (dy) */
    {NDS9_B_BG2PD,
     "(2D-B) BG2PD",
     {0}}, /* W   BG2 Rotation/Scaling Parameter D (dmy) */
    {NDS9_B_BG2X,
     "(2D-B) BG2X",
     {0}}, /* W   BG2 Reference Point X-Coordinate */
    {NDS9_B_BG2Y,
     "(2D-B) BG2Y",
     {0}}, /* W   BG2 Reference Point Y-Coordinate */
    {NDS9_B_BG3PA,
     "(2D-B) BG3PA",
     {0}}, /* W   BG3 Rotation/Scaling Parameter A (dx) */
    {NDS9_B_BG3PB,
     "(2D-B) BG3PB",
     {0}}, /* W   BG3 Rotation/Scaling Parameter B (dmx) */
    {NDS9_B_BG3PC,
     "(2D-B) BG3PC",
     {0}}, /* W   BG3 Rotation/Scaling Parameter C (dy) */
    {NDS9_B_BG3PD,
     "(2D-B) BG3PD",
     {0}}, /* W   BG3 Rotation/Scaling Parameter D (dmy) */
    {NDS9_B_BG3X,
     "(2D-B) BG3X",
     {0}}, /* W   BG3 Reference Point X-Coordinate */
    {NDS9_B_BG3Y,
     "(2D-B) BG3Y",
     {0}}, /* W   BG3 Reference Point Y-Coordinate */
    {NDS9_B_WIN0H,
     "(2D-B) WIN0H",
     {
         {0, 8, "X2, Rightmost coordinate of window, plus 1 "},
...
mmio_reg_t nds7_io_reg_desc[] = {
    ...
    {GBA_DMA0CNT_H,
     "DMA0CNT_H",
     {
         ...
         {10, 1, "DMA Transfer Type (0=16bit, 1=32bit)"},
         {11, 2,
          "DMA Start Timing (0=Immediately, 1=VBlank, 2=DS Cartridge Slot, "
          "3=Wireless interrupt"},
         {14, 1, "IRQ upon end of Word Count (0=Disable, 1=Enable)"},
         {15, 1, "DMA Enable (0=Off, 1=On)"},
     }},                               /* R/W  DMA 0 Control */
    {GBA_DMA1SAD, "DMA1SAD", {0}},     /* W    DMA 1 Source Address */
    ...
    {NDS7_EXTKEYIN,
     "EXTKEYIN",
     {
         ...
         {6, 1,
          "Pen down     (0=Pressed, 1=Released/Disabled) (always 0 in DSi "
          "mode)"},
    ...
    {NDS7_SPI_BUS_CTL,
     ...
     {
         {0, 2,
          "Baudrate (0=4MHz/Firmware, 1=2MHz/Touchscr, 2=1MHz/Powerman., "
          "3=512KHz)"},
         {2, 1,
          "DSi: Baudrate MSB   (4=8MHz, 5..7=None/0Hz) (when "
          "SCFG_EXT7.bit9=1)"},
         {7, 1, "Busy Flag           (0=Ready, 1=Busy) (presumably Read-only)"},
         {8, 2,
          "Device Select       (0=Powerman., 1=Firmware, 2=Touchscr, "
          "3=Reserved)"},
    ...
    {NDS7_WRAMSTAT,
     ...
     {{0, 2,
       "WRAM Mode ARM9/ARM7 (0-3 = 32K/0K, 2nd 16K/1st 16K, 1st 16K/2nd 16K, "
       "0K/32K)"}}}, /* WRAMSTAT - WRAM Bank Status (R) */
    {NDS7_POSTFLG,
     "POSTFLG",
     {
         {0, 1, "First Boot Flag  (0=First, 1=Further)"},
    ...
    {NDS7_HALTCNT,
     ...
     {
         {0, 2,
          " Power Down Mode  (0=No function, 1=Enter GBA Mode, 2=Halt, "
          "3=Sleep)"},
    ...
    {NDS7_BIOSPROT,
     "BIOSPROT",
     {0}}, /* BIOSPROT - Bios-data-read-protection address */
    ...
    {NDS7_SOUND0_CNT,
     "SOUND0_CNT",
     {
         ...
         {24, 3,
          "Wave Duty (0..7) ;HIGH=(N+1)*12.5%, LOW=(7-N)*12.5% (PSG only)"},
         {27, 2,
          "Repeat Mode (0=Manual, 1=Loop Infinite, 2=One-Shot, 3=Prohibited)"},
    ...
    {NDS7_SOUND0_SAD,
     "SOUND0_SAD",
     {0}}, /* Sound Channel 0 Data Source Register (W) */
    {NDS7_SOUND0_TMR,
     "SOUND0_TMR",
     {0}}, /* Sound Channel 0 Timer Register (W) */
    {NDS7_SOUND0_PNT,
     "SOUND0_PNT",
     {0}}, /* Sound Channel 0 Loopstart Register (W) */
    {NDS7_SOUND0_LEN,
     "SOUND0_LEN",
     {0}}, /* Sound Channel 0 Length Register (W) */
    {NDS7_SOUND1_CNT,
     "SOUND1_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND1_SAD,
     "SOUND1_SAD",
     {0}}, /* Sound Channel 1 Data Source Register (W) */
    {NDS7_SOUND1_TMR,
     "SOUND1_TMR",
     {0}}, /* Sound Channel 1 Timer Register (W) */
    {NDS7_SOUND1_PNT,
     "SOUND1_PNT",
     {0}}, /* Sound Channel 1 Loopstart Register (W) */
    {NDS7_SOUND1_LEN,
     "SOUND1_LEN",
     {0}}, /* Sound Channel 1 Length Register (W) */
    {NDS7_SOUND2_CNT,
     "SOUND2_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND2_SAD,
     "SOUND2_SAD",
     {0}}, /* Sound Channel 2 Data Source Register (W) */
    {NDS7_SOUND2_TMR,
     "SOUND2_TMR",
     {0}}, /* Sound Channel 2 Timer Register (W) */
    {NDS7_SOUND2_PNT,
     "SOUND2_PNT",
     {0}}, /* Sound Channel 2 Loopstart Register (W) */
    {NDS7_SOUND2_LEN,
     "SOUND2_LEN",
     {0}}, /* Sound Channel 2 Length Register (W) */
    {NDS7_SOUND3_CNT,
     "SOUND3_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND3_SAD,
     "SOUND3_SAD",
     {0}}, /* Sound Channel 3 Data Source Register (W) */
    {NDS7_SOUND3_TMR,
     "SOUND3_TMR",
     {0}}, /* Sound Channel 3 Timer Register (W) */
    {NDS7_SOUND3_PNT,
     "SOUND3_PNT",
     {0}}, /* Sound Channel 3 Loopstart Register (W) */
    {NDS7_SOUND3_LEN,
     "SOUND3_LEN",
     {0}}, /* Sound Channel 3 Length Register (W) */
    {NDS7_SOUND4_CNT,
     "SOUND4_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND4_SAD,
     "SOUND4_SAD",
     {0}}, /* Sound Channel 4 Data Source Register (W) */
    {NDS7_SOUND4_TMR,
     "SOUND4_TMR",
     {0}}, /* Sound Channel 4 Timer Register (W) */
    {NDS7_SOUND4_PNT,
     "SOUND4_PNT",
     {0}}, /* Sound Channel 4 Loopstart Register (W) */
    {NDS7_SOUND4_LEN,
     "SOUND4_LEN",
     {0}}, /* Sound Channel 4 Length Register (W) */
    {NDS7_SOUND5_CNT,
     "SOUND5_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND5_SAD,
     "SOUND5_SAD",
     {0}}, /* Sound Channel 5 Data Source Register (W) */
    {NDS7_SOUND5_TMR,
     "SOUND5_TMR",
     {0}}, /* Sound Channel 5 Timer Register (W) */
    {NDS7_SOUND5_PNT,
     "SOUND5_PNT",
     {0}}, /* Sound Channel 5 Loopstart Register (W) */
    {NDS7_SOUND5_LEN,
     "SOUND5_LEN",
     {0}}, /* Sound Channel 5 Length Register (W) */
    {NDS7_SOUND6_CNT,
     "SOUND6_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND6_SAD,
     "SOUND6_SAD",
     {0}}, /* Sound Channel 6 Data Source Register (W) */
    {NDS7_SOUND6_TMR,
     "SOUND6_TMR",
     {0}}, /* Sound Channel 6 Timer Register (W) */
    {NDS7_SOUND6_PNT,
     "SOUND6_PNT",
     {0}}, /* Sound Channel 6 Loopstart Register (W) */
    {NDS7_SOUND6_LEN,
     "SOUND6_LEN",
     {0}}, /* Sound Channel 6 Length Register (W) */
    {NDS7_SOUND7_CNT,
     "SOUND7_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND7_SAD,
     "SOUND7_SAD",
     {0}}, /* Sound Channel 7 Data Source Register (W) */
    {NDS7_SOUND7_TMR,
     "SOUND7_TMR",
     {0}}, /* Sound Channel 7 Timer Register (W) */
    {NDS7_SOUND7_PNT,
     "SOUND7_PNT",
     {0}}, /* Sound Channel 7 Loopstart Register (W) */
    {NDS7_SOUND7_LEN,
     "SOUND7_LEN",
     {0}}, /* Sound Channel 7 Length Register (W) */
    {NDS7_SOUND8_CNT,
     "SOUND8_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND8_SAD,
     "SOUND8_SAD",
     {0}}, /* Sound Channel 8 Data Source Register (W) */
    {NDS7_SOUND8_TMR,
     "SOUND8_TMR",
     {0}}, /* Sound Channel 8 Timer Register (W) */
    {NDS7_SOUND8_PNT,
     "SOUND8_PNT",
     {0}}, /* Sound Channel 8 Loopstart Register (W) */
    {NDS7_SOUND8_LEN,
     "SOUND8_LEN",
     {0}}, /* Sound Channel 8 Length Register (W) */
    {NDS7_SOUND9_CNT,
     "SOUND9_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUND9_SAD,
     "SOUND9_SAD",
     {0}}, /* Sound Channel 9 Data Source Register (W) */
    {NDS7_SOUND9_TMR,
     "SOUND9_TMR",
     {0}}, /* Sound Channel 9 Timer Register (W) */
    {NDS7_SOUND9_PNT,
     "SOUND9_PNT",
     {0}}, /* Sound Channel 9 Loopstart Register (W) */
    {NDS7_SOUND9_LEN,
     "SOUND9_LEN",
     {0}}, /* Sound Channel 9 Length Register (W) */
    {NDS7_SOUNDA_CNT,
     "SOUNDA_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDA_SAD,
     "SOUNDA_SAD",
     {0}}, /* Sound Channel 10 Data Source Register (W) */
    {NDS7_SOUNDA_TMR,
     "SOUNDA_TMR",
     {0}}, /* Sound Channel 10 Timer Register (W) */
    {NDS7_SOUNDA_PNT,
     "SOUNDA_PNT",
     {0}}, /* Sound Channel 10 Loopstart Register (W) */
    {NDS7_SOUNDA_LEN,
     "SOUNDA_LEN",
     {0}}, /* Sound Channel 10 Length Register (W) */
    {NDS7_SOUNDB_CNT,
     "SOUNDB_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDB_SAD,
     "SOUNDB_SAD",
     {0}}, /* Sound Channel 11 Data Source Register (W) */
    {NDS7_SOUNDB_TMR,
     "SOUNDB_TMR",
     {0}}, /* Sound Channel 11 Timer Register (W) */
    {NDS7_SOUNDB_PNT,
     "SOUNDB_PNT",
     {0}}, /* Sound Channel 11 Loopstart Register (W) */
    {NDS7_SOUNDB_LEN,
     "SOUNDB_LEN",
     {0}}, /* Sound Channel 11 Length Register (W) */
    {NDS7_SOUNDC_CNT,
     "SOUNDC_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDC_SAD,
     "SOUNDC_SAD",
     {0}}, /* Sound Channel 12 Data Source Register (W) */
    {NDS7_SOUNDC_TMR,
     "SOUNDC_TMR",
     {0}}, /* Sound Channel 12 Timer Register (W) */
    {NDS7_SOUNDC_PNT,
     "SOUNDC_PNT",
     {0}}, /* Sound Channel 12 Loopstart Register (W) */
    {NDS7_SOUNDC_LEN,
     "SOUNDC_LEN",
     {0}}, /* Sound Channel 12 Length Register (W) */
    {NDS7_SOUNDD_CNT,
     "SOUNDD_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDD_SAD,
     "SOUNDD_SAD",
     {0}}, /* Sound Channel 13 Data Source Register (W) */
    {NDS7_SOUNDD_TMR,
     "SOUNDD_TMR",
     {0}}, /* Sound Channel 13 Timer Register (W) */
    {NDS7_SOUNDD_PNT,
     "SOUNDD_PNT",
     {0}}, /* Sound Channel 13 Loopstart Register (W) */
    {NDS7_SOUNDD_LEN,
     "SOUNDD_LEN",
     {0}}, /* Sound Channel 13 Length Register (W) */
    {NDS7_SOUNDE_CNT,
     "SOUNDE_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDE_SAD,
     "SOUNDE_SAD",
     {0}}, /* Sound Channel 14 Data Source Register (W) */
    {NDS7_SOUNDE_TMR,
     "SOUNDE_TMR",
     {0}}, /* Sound Channel 14 Timer Register (W) */
    {NDS7_SOUNDE_PNT,
     "SOUNDE_PNT",
     {0}}, /* Sound Channel 14 Loopstart Register (W) */
    {NDS7_SOUNDE_LEN,
     "SOUNDE_LEN",
     {0}}, /* Sound Channel 14 Length Register (W) */
    {NDS7_SOUNDF_CNT,
     "SOUNDF_CNT",
     {
         {0, 7, "Volume Mul (0..127=silent..loud)"},
    ...
    {NDS7_SOUNDF_SAD,
     "SOUNDF_SAD",
     {0}}, /* Sound Channel 15 Data Source Register (W) */
    {NDS7_SOUNDF_TMR,
     "SOUNDF_TMR",
     {0}}, /* Sound Channel 15 Timer Register (W) */
    {NDS7_SOUNDF_PNT,
     "SOUNDF_PNT",
     {0}}, /* Sound Channel 15 Loopstart Register (W) */
    {NDS7_SOUNDF_LEN,
     "SOUNDF_LEN",
     {0}}, /* Sound Channel 15 Length Register (W) */
    ...
    {NDS7_SNDCAP0DAD,
     "SNDCAP0DAD",
     {0}}, /* Sound Capture 0 Destination Address (R/W) */
    {NDS7_SNDCAP0LEN, "SNDCAP0LEN", {0}}, /* Sound Capture 0 Length (W) */
    {NDS7_SNDCAP1DAD,
     "SNDCAP1DAD",
     {0}}, /* Sound Capture 1 Destination Address (R/W) */
...
#define NDS_INT_GC_TRANSFER_DONE                                               \
...
typedef struct {
  ...
  uint8_t wram[96 * 1024]; /*96KB   WRAM (64K mapped to NDS7, plus 32K mappable
                              to NDS7 or NDS9)*/
  ...
  uint8_t vram[1024 * 1024]; /* VRAM (allocateable as
                                BG/OBJ/2D/3D/Palette/Texture/WRAM memory) */
  uint64_t vram_translation_cache[1024 * 16];
  uint8_t palette[2 * 1024];
  uint8_t *save_data;

  uint8_t oam[4 * 1024]; /* OAM/PAL (2K OBJ Attribute Memory, 2K Standard
                            Palette RAM) */
...
typedef struct {
  ...
  uint8_t
      gamecode[4]; /* Gamecode    (Uppercase ASCII, NTR-<code>) (0=homebrew) */
  uint8_t makercode[2]; /* Makercode   (Uppercase ASCII, eg. "01"=Nintendo)
                           (0=homebrew) */
  uint8_t unitcode; /* Unitcode    (00h=NDS, 02h=NDS+DSi, 03h=DSi) (bit1=DSi) */
  uint8_t seed_sel; /* Encryption Seed Select (00..07h, usually 00h) */
  uint8_t device_capacity; /* Devicecapacity         (Chipsize = 128KB SHL nn)
                              (eg. 7 = 16MB) */
  uint8_t reserved[8];
  uint8_t region; /* NDS Region  (00h=Normal, 80h=China, 40h=Korea) (other on
                     DSi) */
  uint8_t rom_version; /* ROM Version (usually 00h) */
  uint8_t autostart;   /* Autostart (Bit2: Skip "Press Button" after Health and
                          Safety) */
  // Byte 32..63
  ...
  uint32_t arm7_entrypoint;  /* ARM7 entry_address (2000000h..23BFE00h, or
                                37F8000h..3807E00h) */
  uint32_t arm7_ram_address; /* ARM7 ram_address   (2000000h..23BFE00h, or
                                37F8000h..3807E00h) */
  uint32_t arm7_size;        /* ARM7 size          (max 3BFE00h, or FE00h)
                                (3839.5KB, 63.5KB) */
  ...
  // Byte 96..127
  uint32_t
      port0; /* Port 40001A4h setting for normal commands (usually 00586000h) */
  uint32_t
      port1; /* Port 40001A4h setting for KEY1 commands   (usually 001808F8h) */
  uint32_t icon_title_offset; /* Icon/Title offset (0=None) (8000h and up) */
  uint16_t
      sec_checksum;   /* Secure Area Checksum, CRC-16 of [[020h]..00007FFFh] */
  uint16_t sec_delay; /* Secure Area Delay (in 131kHz units) (051Eh=10ms or
                         0D7Eh=26ms) */
  uint32_t arm9_autoload; /* ARM9 Auto Load List Hook RAM Address (?) ;\endaddr
                             of auto-load */
  uint32_t
      arm7_autoload; /* ARM7 Auto Load List Hook RAM Address (?) ;/functions */
  uint8_t sec_disable[8]; /* Secure Area Disable (by encrypted "NmMdOnly")
                             (usually zero) */
  // Byte 128..159
  uint32_t rom_size_used; /* Total Used ROM size (remaining/unused bytes usually
                             FFh-padded) */
...
static uint8_t nds_process_flash_write(nds_t *nds, uint8_t write_data,
                                       nds_flash_t *flash, uint8_t *flash_data,
                                       uint32_t flash_size);
...
static uint32_t nds_save_best_effort_state(nds_t *nds) {
  ...
  nds->bess.card_transfer_data_seg =
      (uint8_t *)nds->mem.card_transfer_data - (uint8_t *)nds;
  ...
  for (int cpu = 0; cpu < 2; ++cpu)
    for (int i = 0; i < 4; ++i)
      nds->bess.timer_reload_values[cpu][i] = nds->timers[cpu][i].reload_value;
  return ((uint8_t *)&nds->bess) - (uint8_t *)(nds);
}
static bool nds_load_best_effort_state(nds_t *nds, uint8_t *save_state_data,
                                       uint32_t size, uint32_t bess_offset) {
  if (bess_offset + sizeof(nds_bess_info_t) > size)
    return false;
  nds_bess_info_t *bess = (nds_bess_info_t *)(save_state_data + bess_offset);
  if (bess->bess_version != 1)
    return false;

  if (bess->cpu9_reg_seg + sizeof(nds->arm9.registers) > size)
    return false;
  if (bess->cpu7_reg_seg + sizeof(nds->arm7.registers) > size)
    return false;
  if (bess->ram_seg + sizeof(nds->mem.ram) > size)
    return false;
  if (bess->wram_seg + sizeof(nds->mem.wram) > size)
    return false;
  if (bess->code_tcm_seg + sizeof(nds->mem.code_tcm) > size)
    return false;
  if (bess->data_tcm_seg + sizeof(nds->mem.data_tcm) > size)
    return false;
  if (bess->code_cache_seg + sizeof(nds->mem.code_cache) > size)
    return false;
  if (bess->data_cache_seg + sizeof(nds->mem.data_cache) > size)
    return false;
  if (bess->vram_seg + sizeof(nds->mem.vram) > size)
    return false;
  if (bess->palette_seg + sizeof(nds->mem.palette) > size)
    return false;
  if (bess->oam_seg + sizeof(nds->mem.oam) > size)
    return false;
  if (bess->io_seg + sizeof(nds->mem.io) > size)
    return false;
  if (bess->card_transfer_data_seg + sizeof(nds->mem.card_transfer_data) > size)
    return false;
  if (bess->coproc_reg_seg + sizeof(nds->cp15.reg) > size)
    return false;

  memcpy((uint8_t *)nds->arm9.registers, save_state_data + bess->cpu9_reg_seg,
         sizeof(nds->arm9.registers));
  memcpy((uint8_t *)nds->arm7.registers, save_state_data + bess->cpu7_reg_seg,
         sizeof(nds->arm7.registers));
  memcpy((uint8_t *)nds->mem.ram, save_state_data + bess->ram_seg,
         sizeof(nds->mem.ram));
  memcpy((uint8_t *)nds->mem.wram, save_state_data + bess->wram_seg,
         sizeof(nds->mem.wram));
  memcpy((uint8_t *)nds->mem.code_tcm, save_state_data + bess->code_tcm_seg,
         sizeof(nds->mem.code_tcm));
  memcpy((uint8_t *)nds->mem.data_tcm, save_state_data + bess->data_tcm_seg,
         sizeof(nds->mem.data_tcm));
  memcpy((uint8_t *)nds->mem.code_cache, save_state_data + bess->code_cache_seg,
         sizeof(nds->mem.code_cache));
  memcpy((uint8_t *)nds->mem.data_cache, save_state_data + bess->data_cache_seg,
         sizeof(nds->mem.data_cache));
  memcpy((uint8_t *)nds->mem.vram, save_state_data + bess->vram_seg,
         sizeof(nds->mem.vram));
  memcpy((uint8_t *)nds->mem.palette, save_state_data + bess->palette_seg,
         sizeof(nds->mem.palette));
  memcpy((uint8_t *)nds->mem.oam, save_state_data + bess->oam_seg,
         sizeof(nds->mem.oam));
  memcpy((uint8_t *)nds->mem.io, save_state_data + bess->io_seg,
         sizeof(nds->mem.io));
  memcpy((uint8_t *)nds->mem.card_transfer_data,
         save_state_data + bess->card_transfer_data_seg,
         sizeof(nds->mem.card_transfer_data));
  memcpy((uint8_t *)nds->cp15.reg, save_state_data + bess->coproc_reg_seg,
         sizeof(nds->cp15.reg));

  printf("ARM7 PC: %08x ARM9 PC: %08x\n", nds->arm7.registers[15],
         nds->arm9.registers[15]);
  ...
  for (int cpu = 0; cpu < 2; ++cpu)
    for (int i = 0; i < 4; ++i)
      nds->timers[cpu][i].reload_value = nds->bess.timer_reload_values[cpu][i];
  printf("Bess restore successful\n");
  return true;
}
static void FORCE_INLINE nds9_send_interrupt(nds_t *nds, int delay,
                                             int if_bit) {
  nds->active_if_pipe_stages |= 1 << delay;
  nds->nds9_pipelined_if[delay] |= if_bit;
}
static void FORCE_INLINE nds7_send_interrupt(nds_t *nds, int delay,
                                             int if_bit) {
  nds->active_if_pipe_stages |= 1 << delay;
...
static FORCE_INLINE void nds9_io_store8(nds_t *nds, unsigned baddr,
                                        uint8_t data) {
  nds->mem.io[baddr & 0xffff] = data;
}
static FORCE_INLINE void nds9_io_store16(nds_t *nds, unsigned baddr,
                                         uint16_t data) {
  *(uint16_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}
static FORCE_INLINE void nds9_io_store32(nds_t *nds, unsigned baddr,
                                         uint32_t data) {
  *(uint32_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}

static FORCE_INLINE uint8_t nds9_io_read8(nds_t *nds, unsigned baddr) {
  return nds->mem.io[baddr & 0xffff];
}
static FORCE_INLINE uint16_t nds9_io_read16(nds_t *nds, unsigned baddr) {
  return *(uint16_t *)(nds->mem.io + (baddr & 0xffff));
}
static FORCE_INLINE uint32_t nds9_io_read32(nds_t *nds, unsigned baddr) {
...
static FORCE_INLINE sb_debug_mmio_access_t nds_debug_mmio_access(
    nds_t *nds, int cpu, unsigned baddr, int trigger_breakpoint) {
  if (baddr >= 0x04100000)
    baddr += NDS_IO_MAP_041_OFFSET;
  if (cpu == NDS_ARM7)
  ...
  if (trigger_breakpoint != -1) {
    ...
    if (trigger_breakpoint != 0)
      nds->mem.mmio_debug_access_buffer[baddr] |= 0x80;
  }
...
static FORCE_INLINE void nds7_io_store8(nds_t *nds, unsigned baddr,
                                        uint8_t data) {
  baddr += NDS_IO_MAP_SPLIT_OFFSET;
  nds->mem.io[baddr & 0xffff] = data;
}
static FORCE_INLINE void nds7_io_store16(nds_t *nds, unsigned baddr,
                                         uint16_t data) {
  baddr += NDS_IO_MAP_SPLIT_OFFSET;
  *(uint16_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}
static FORCE_INLINE void nds7_io_store32(nds_t *nds, unsigned baddr,
                                         uint32_t data) {
  baddr += NDS_IO_MAP_SPLIT_OFFSET;
  *(uint32_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}
...
static FORCE_INLINE void nds_io_store8(nds_t *nds, int cpu_id, unsigned baddr,
                                       uint8_t data) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  nds->mem.io[baddr & 0xffff] = data;
}
static FORCE_INLINE void nds_io_store16(nds_t *nds, int cpu_id, unsigned baddr,
                                        uint16_t data) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  *(uint16_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}
static FORCE_INLINE void nds_io_store32(nds_t *nds, int cpu_id, unsigned baddr,
                                        uint32_t data) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  *(uint32_t *)(nds->mem.io + (baddr & 0xffff)) = data;
}
static FORCE_INLINE uint8_t nds_io_read8(nds_t *nds, int cpu_id,
                                         unsigned baddr) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  return nds->mem.io[baddr & 0xffff];
}
static FORCE_INLINE uint16_t nds_io_read16(nds_t *nds, int cpu_id,
                                           unsigned baddr) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  return *(uint16_t *)(nds->mem.io + (baddr & 0xffff));
}
static FORCE_INLINE uint32_t nds_io_read32(nds_t *nds, int cpu_id,
                                           unsigned baddr) {
  if (cpu_id == NDS_ARM7)
    baddr += NDS_IO_MAP_SPLIT_OFFSET;
  return *(uint32_t *)(nds->mem.io + (baddr & 0xffff));
...
static FORCE_INLINE uint32_t nds_apply_mem_op(uint8_t *memory, uint32_t address,
                                              uint32_t data,
                                              int transaction_type) {
  if (transaction_type & NDS_MEM_4B) {
    address &= ~3;
    if (transaction_type & NDS_MEM_WRITE)
      *(uint32_t *)(memory + address) = data;
    else
      data = *(uint32_t *)(memory + address);
  } else if (transaction_type & NDS_MEM_2B) {
    address &= ~1;
    if (transaction_type & NDS_MEM_WRITE)
      *(uint16_t *)(memory + address) = data;
    else
      data = *(uint16_t *)(memory + address);
  } else {
    if (transaction_type & NDS_MEM_WRITE)
      memory[address] = data;
    else
...
static FORCE_INLINE uint32_t nds_apply_vram_mem_op(nds_t *nds, uint32_t address,
                                                   uint32_t data,
                                                   int transaction_type) {
  ...
  const uint32_t offset_table[10][5] = {
      ...
      {NDS_VRAM_SLOT_OFF * 0, NDS_VRAM_SLOT_OFF * 1, NDS_VRAM_SLOT_OFF * 2,
       NDS_VRAM_SLOT_OFF * 3}, // Slot 0-3 (mirrored)
      {NDS_VRAM_SLOT_OFF * 0, NDS_VRAM_SLOT_OFF * 2, NDS_VRAM_SLOT_OFF * 0,
       NDS_VRAM_SLOT_OFF * 2}, // Slot 0-1 (OFS=0), Slot 2-3 (OFS=1)
      {NDS_VRAM_SLOT_OFF * 0, NDS_VRAM_SLOT_OFF * 1, NDS_VRAM_SLOT_OFF * 4,
       NDS_VRAM_SLOT_OFF * 5}, // Slot (OFS.0*1)+(OFS.1*4)
      {0x20000 * 0, 0x20000 * 1, 0x20000 * 2, 0x20000 * 3}, //(0x20000*OFS)
      {0x10000 * 0, 0x10000 * 1, 0x10000 * 2,
       0x10000 *
           3}, //   E       64K   4    -     Slot 0-3  ;only lower 32K used
      {0x4000 * 0, 0x4000 * 1, 0x4000 * 0, 0x4000 * 1}, // 16KB slot
      {16 * 1024 * 0, 16 * 1024 * 1, 16 * 1024 * 4,
       16 * 1024 * 5}, // Slot (OFS.0*1)+(OFS.1*4)
  };
  ...
  const static vram_bank_info_t bank_info[9][8] = {
      {
          // Bank A
          {NDS_MEM_ARM7, 0, 0x06800000,
           0x100000 - 1}, // MST 0 6800000h-681FFFFh
          {NDS_MEM_ARM7, 1, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(20000h*OFS)
          {NDS_MEM_ARM7, 6, 0x06400000,
           0x40000 - 1}, // MST 2 6400000h+(20000h*OFS.0)  ;OFS.1 must be zero
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 6,
           NDS_VRAM_TEX_SLOT0}, // MST 3 Slot OFS(0-3)   ;(Slot2-3: Texture, or
                                // Rear-plane)
      ...
      {
          // Bank B
          {NDS_MEM_ARM7, 0, 0x06820000,
           0x100000 - 1}, // MST 0 6820000h-683FFFFh
          {NDS_MEM_ARM7, 1, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(20000h*OFS)
          {NDS_MEM_ARM7, 6, 0x06400000,
           0x40000 - 1}, // MST 2 6400000h+(20000h*OFS.0)  ;OFS.1 must be zero
      ...
      {
          // Bank C
          {NDS_MEM_ARM7, 0, 0x06840000,
           0x100000 - 1}, // MST 0 6840000h-685FFFFh
          {NDS_MEM_ARM7, 1, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(20000h*OFS)
          {NDS_MEM_ARM9 | NDS_MEM_PPU, 6, 0x06000000,
           0x80000 - 1}, // MST 2 6000000h+(20000h*OFS.0)  ;OFS.1 must be zero
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 6,
           NDS_VRAM_TEX_SLOT0}, // MST 3 Slot OFS(0-3)   ;(Slot2-3: Texture, or
                                // Rear-plane)
      ...
      {
          // Bank D
          {NDS_MEM_ARM7, 0, 0x06860000,
           0x100000 - 1}, // MST 0 6860000h-687FFFFh
          {NDS_MEM_ARM7, 1, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(20000h*OFS)
          {NDS_MEM_ARM9 | NDS_MEM_PPU, 6, 0x06000000,
           0x80000 - 1}, // MST 2 6000000h+(20000h*OFS.0)  ;OFS.1 must be zero
      ...
      {
          // Bank E
          {NDS_MEM_ARM7, 0, 0x06880000,
           0x100000 - 1},                             // MST 0 6880000h-688FFFFh
          {NDS_MEM_ARM7, 0, 0x06000000, 0x80000 - 1}, // MST 1 6000000h
          {NDS_MEM_ARM7, 0, 0x06400000, 0x40000 - 1}, // MST 2 6400000h
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_TEX_PAL_SLOT0}, // MST 3 Slots 0-3;OFS=don't care
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_BGA_SLOT0}, // MST 4 (64K Slot 0-3  ;only lower 32K used)
          {0xffffffff, 0, 0x0}, // MST 5 INVALID
          {0xffffffff, 0, 0x0}, // MST 6 INVALID
          {0xffffffff, 0, 0x0}, // MST 7 INVALID
      },
      {
          // Bank F
          {NDS_MEM_ARM7, 0, 0x06890000,
           0x100000 - 1}, // MST 0 6890000h-6893FFFh
          {NDS_MEM_ARM7, 2, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(4000h*OFS.0)+(10000h*OFS.1)
          {NDS_MEM_ARM7, 2, 0x06400000,
           0x40000 - 1}, // MST 2 6400000h+(4000h*OFS.0)+(10000h*OFS.1)
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 9,
           NDS_VRAM_TEX_PAL_SLOT0}, // MST 3 Slot (OFS.0*1)+(OFS.1*4)  ;ie. Slot
                                    // 0, 1, 4, or 5
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 8,
           NDS_VRAM_BGA_SLOT0}, // MST 4 0..1  Slot 0-1 (OFS=0), Slot 2-3
                                // (OFS=1)
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_OBJA_SLOT0}, // MST 5 Slot 0  ;16K each (only lower 8K used)
          {0xffffffff, 0, 0x0},  // MST 6 INVALID
          {0xffffffff, 0, 0x0},  // MST 7 INVALID
      },
      {
          // Bank G
          {NDS_MEM_ARM7, 0, 0x06894000,
           0x100000 - 1}, // MST 0 6894000h-6897FFFh
          {NDS_MEM_ARM7, 2, 0x06000000,
           0x80000 - 1}, // MST 1 6000000h+(4000h*OFS.0)+(10000h*OFS.1)
          {NDS_MEM_ARM7, 2, 0x06400000,
           0x40000 - 1}, // MST 2 6400000h+(4000h*OFS.0)+(10000h*OFS.1)
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 9,
           NDS_VRAM_TEX_PAL_SLOT0}, // MST3 Slot (OFS.0*1)+(OFS.1*4)  ;ie. Slot
                                    // 0, 1, 4, or 5
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 8,
           NDS_VRAM_BGA_SLOT0}, // MST 4 0..1  Slot 0-1 (OFS=0), Slot 2-3
                                // (OFS=1)
      ...
      {
          // Bank H
          {NDS_MEM_ARM7, 0, 0x06898000,
           0x100000 - 1},                             // MST 0 6898000h-689FFFFh
          {NDS_MEM_ARM7, 0, 0x06200000, 0x10000 - 1}, // MST 1 6200000h
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_BGB_SLOT0}, // MST 2 Slot 0-3
          {0xffffffff, 0, 0x0}, // MST 3 INVALID
          {NDS_MEM_ARM7, 0, 0x06898000,
           0x100000 - 1},                             // MST 4 6898000h-689FFFFh
          {NDS_MEM_ARM7, 0, 0x06200000, 0x10000 - 1}, // MST 5 6200000h
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_BGB_SLOT0}, // MST 6 Slot 0-3
          {0xffffffff, 0, 0x0}, // MST 7 INVALID
      },
      {
          // Bank I
          {NDS_MEM_ARM7, 0, 0x068A0000,
           0x100000 - 1},                             // MST 0 68A0000h-68A3FFFh
          {NDS_MEM_ARM7, 0, 0x06208000, 0x10000 - 1}, // MST 1 6208000h
          {NDS_MEM_ARM7, 0, 0x06600000, 0x4000 - 1},  // MST 2 6600000h
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_OBJB_SLOT0}, // MST 3 Slot 0  ;16K each (only lower 8K used)
          {NDS_MEM_ARM7, 0, 0x068A0000,
           0x100000 - 1},                             // MST 4 68A0000h-68A3FFFh
          {NDS_MEM_ARM7, 0, 0x06208000, 0x10000 - 1}, // MST 5 6208000h
          {NDS_MEM_ARM7, 0, 0x06600000, 0x4000 - 1},  // MST 6 6600000h
          {NDS_MEM_ARM7 | NDS_MEM_ARM9, 0,
           NDS_VRAM_OBJB_SLOT0}, // MST 7 Slot 0  ;16K each (only lower 8K used)
      }};
  int total_banks = 9;
  int vram_offset = 0;
  ...
  for (int b = 0; b < total_banks; ++b) {
    ...
    const static int vram_cnt_array[] = {
        NDS9_VRAMCNT_A, NDS9_VRAMCNT_B, NDS9_VRAMCNT_C, NDS9_VRAMCNT_D,
        NDS9_VRAMCNT_E, NDS9_VRAMCNT_F, NDS9_VRAMCNT_G,
    ...
    if (transaction_type & bank.transaction_mask)
      continue;

    int base = bank.mem_address_start;
    base += offset_table[bank.offset_table][off];
    if ((address & 0x0ffe0000) != (base & 0x0ffe0000))
      continue;

    int bank_offset = address - base;
    bank_offset &= bank.mirror ? bank.mirror : -1;
    if (bank_offset >= bank_size[b])
      continue;
    int vram_addr = bank_offset + vram_off;

    if (special_case_multiple_found)
      nds->mem.vram_translation_cache[lookup_addr] = 0;
    else
      nds->mem.vram_translation_cache[lookup_addr] =
          nds->mem.curr_vram_translation_key | SB_BFE(vram_addr, 14, 10);

    special_case_multiple_found = true;

    ret_data |=
        nds_apply_mem_op(nds->mem.vram, vram_addr, data, transaction_type);
  }
  return ret_data;
}

static bool nds_preprocess_mmio(nds_t *nds, uint32_t addr, uint32_t data,
                                int transaction_type);
static void nds_postprocess_mmio_write(nds_t *nds, uint32_t addr, uint32_t data,
                                       int transaction_type);
static FORCE_INLINE uint32_t nds9_process_memory_transaction(
    nds_t *nds, uint32_t addr, uint32_t data, int transaction_type) {
  uint32_t *ret = &nds->mem.openbus_word;
  switch (addr >> 24) {
  case 0x2: // Main RAM
    if (!(transaction_type & (NDS_MEM_ARM9)) ||
        (transaction_type & (NDS_MEM_WRITE)))
      nds->mem.slow_bus_cycles += (transaction_type & NDS_MEM_SEQ) ? 1 : 9;
    /*else{
      bool found = false;
  ...
  case 0x4:
    nds->mem.slow_bus_cycles += (transaction_type & NDS_MEM_SEQ) ? 1 : 4;
    if ((addr & 0xffff) >= 0x2000 || addr >= 0x04200000) {
      *ret = 0;
      return *ret;
    }
    if (addr >= 0x04100000 && addr < 0x04200000) {
      addr |= NDS_IO_MAP_041_OFFSET;
    }
    ...
    if (!(transaction_type & NDS_MEM_DEBUG)) {
      nds->mem.mmio_debug_access_buffer[baddr / 4] |=
          (transaction_type & NDS_MEM_WRITE) ? 0x70 : 0xf;
      if (nds->mem.mmio_debug_access_buffer[baddr / 4] & 0x80)
        nds->arm7.trigger_breakpoint = true;
    }
    if ((transaction_type & NDS_MEM_WRITE)) {
  ...
  case 0xFF:
    if (addr >= 0xFFFF0000) {
      addr &= 4 * 1024 - 1;
      *ret = nds_apply_mem_op(nds->mem.nds9_bios, addr, data,
                              transaction_type & ~NDS_MEM_WRITE);
    }
    break;
  }
...
static FORCE_INLINE uint32_t nds9_process_memory_transaction_cpu(
    nds_t *nds, uint32_t addr, uint32_t data, int transaction_type) {
  uint32_t *ret = &nds->mem.openbus_word;
  if (addr >= nds->mem.dtcm_start_address && addr < nds->mem.dtcm_end_address) {
    if (SB_LIKELY(
            nds->mem.dtcm_enable &&
            (!nds->mem.dtcm_load_mode || (transaction_type & NDS_MEM_WRITE)))) {
      nds->mem.openbus_word = nds_apply_mem_op(
          nds->mem.data_tcm,
          (addr - nds->mem.dtcm_start_address) & (16 * 1024 - 1), data,
          transaction_type);
      return *ret;
    }
  }
  if (addr >= nds->mem.itcm_start_address && addr < nds->mem.itcm_end_address) {
    if (SB_LIKELY(
            nds->mem.itcm_enable &&
            (!nds->mem.itcm_load_mode || (transaction_type & NDS_MEM_WRITE)))) {
      nds->mem.openbus_word = nds_apply_mem_op(
          nds->mem.code_tcm,
          (addr - nds->mem.itcm_start_address) & (32 * 1024 - 1), data,
          transaction_type);
      return *ret;
    }
  }
...
static FORCE_INLINE uint32_t nds7_process_memory_transaction(
    nds_t *nds, uint32_t addr, uint32_t data, int transaction_type) {
  uint32_t *ret = &nds->mem.openbus_word;
  switch (addr >> 24) {
  case 0x0: // BIOS(NDS7), TCM(NDS9)
    if (addr < 0x4000) {
      if (nds->arm7.registers[PC] < 0x4000)
        nds->mem.arm7_bios_word = nds_apply_mem_op(
            nds->mem.nds7_bios, addr, data, transaction_type & ~NDS_MEM_WRITE);
  ...
  case 0x3: // Shared WRAM
  {
    ...
    if (addr <= 0x037FFFFF) {
      ...
      if (mask[cnt] == 0)
        addr = 32 * 1024 + ((addr) & (64 * 1024 - 1));
      else
        addr = (addr & mask[cnt]) + offset[cnt];
    } else
      addr = 32 * 1024 + ((addr - 0x03800000) & (64 * 1024 - 1));
    *ret = nds_apply_mem_op(nds->mem.wram, addr, data, transaction_type);
  } break;
  case 0x4:
    if (addr >= 0x04200000) {
      ...
      if (addr >= 0x04800000 && addr <= 0x0480ffff) {
        ...
        *ret =
            nds_apply_mem_op(nds->mem.wifi_io, baddr, data, transaction_type);
        if ((addr & ~1) == 0x04808158 && (transaction_type & NDS_MEM_WRITE) &&
            !(transaction_type & NDS_MEM_1B)) {
          ...
          if (index < sizeof(nds->mem.baseband_io)) {
            if (direction == 5)
              nds->mem.baseband_io[index] = nds->mem.wifi_io[0x815A];
            if (direction == 6)
              nds->mem.wifi_io[0x815C] = nds->mem.baseband_io[index];
          }
        }
      }
      break;
...
static FORCE_INLINE void nds9_write32(nds_t *nds, unsigned baddr,
                                      uint32_t data) {
  nds9_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_4B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds7_write32(nds_t *nds, unsigned baddr,
                                      uint32_t data) {
  nds7_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_4B | NDS_MEM_ARM7);
}
static FORCE_INLINE void nds9_write16(nds_t *nds, unsigned baddr,
                                      uint16_t data) {
  nds9_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_2B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds7_write16(nds_t *nds, unsigned baddr,
                                      uint16_t data) {
  nds7_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_2B | NDS_MEM_ARM7);
}
static FORCE_INLINE void nds9_write8(nds_t *nds, unsigned baddr, uint8_t data) {
  nds9_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_1B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds7_write8(nds_t *nds, unsigned baddr, uint8_t data) {
  nds7_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_1B | NDS_MEM_ARM7);
}
static FORCE_INLINE void nds9_debug_write32(nds_t *nds, unsigned baddr,
                                            uint32_t data) {
  nds9_process_memory_transaction_cpu(nds, baddr, data,
                                      NDS_MEM_WRITE | NDS_MEM_4B |
                                          NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE void nds9_debug_write16(nds_t *nds, unsigned baddr,
                                            uint16_t data) {
  nds9_process_memory_transaction_cpu(nds, baddr, data,
                                      NDS_MEM_WRITE | NDS_MEM_2B |
                                          NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE void nds9_debug_write8(nds_t *nds, unsigned baddr,
                                           uint8_t data) {
  nds9_process_memory_transaction_cpu(nds, baddr, data,
                                      NDS_MEM_WRITE | NDS_MEM_1B |
                                          NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE void nds7_debug_write8(nds_t *nds, unsigned baddr,
                                           uint8_t data) {
  nds7_process_memory_transaction(nds, baddr, data,
                                  NDS_MEM_WRITE | NDS_MEM_1B | NDS_MEM_ARM7 |
                                      NDS_MEM_DEBUG);
...
static FORCE_INLINE uint32_t nds9_cpu_read32(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(nds, baddr, 0,
                                             NDS_MEM_4B | NDS_MEM_ARM9);
}
static FORCE_INLINE uint16_t nds9_cpu_read16(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(nds, baddr, 0,
                                             NDS_MEM_2B | NDS_MEM_ARM9);
}
static FORCE_INLINE uint32_t nds9_cpu_read32_seq(nds_t *nds, unsigned baddr,
                                                 bool is_sequential) {
  return nds9_process_memory_transaction_cpu(
      nds, baddr, 0,
      NDS_MEM_4B | NDS_MEM_ARM9 | NDS_MEM_CODE |
          (is_sequential ? NDS_MEM_SEQ : 0));
}
static FORCE_INLINE uint16_t nds9_cpu_read16_seq(nds_t *nds, unsigned baddr,
                                                 bool is_sequential) {
  return nds9_process_memory_transaction_cpu(
      nds, baddr, 0,
      NDS_MEM_2B | NDS_MEM_ARM9 | NDS_MEM_CODE |
          (is_sequential ? NDS_MEM_SEQ : 0));
}
static FORCE_INLINE uint8_t nds9_cpu_read8(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(nds, baddr, 0,
                                             NDS_MEM_1B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds9_cpu_write32(nds_t *nds, unsigned baddr,
                                          uint32_t data) {
  nds9_process_memory_transaction_cpu(
      nds, baddr, data, NDS_MEM_WRITE | NDS_MEM_4B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds9_cpu_write16(nds_t *nds, unsigned baddr,
                                          uint16_t data) {
  nds9_process_memory_transaction_cpu(
      nds, baddr, data, NDS_MEM_WRITE | NDS_MEM_2B | NDS_MEM_ARM9);
}
static FORCE_INLINE void nds9_cpu_write8(nds_t *nds, unsigned baddr,
                                         uint8_t data) {
  nds9_process_memory_transaction_cpu(
      nds, baddr, data, NDS_MEM_WRITE | NDS_MEM_1B | NDS_MEM_ARM9);
}
static FORCE_INLINE uint32_t nds9_read32(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction(nds, baddr, 0,
                                         NDS_MEM_4B | NDS_MEM_ARM9);
}
static FORCE_INLINE uint32_t nds7_read32(nds_t *nds, unsigned baddr) {
  return nds7_process_memory_transaction(nds, baddr, 0,
                                         NDS_MEM_4B | NDS_MEM_ARM7);
}
static FORCE_INLINE uint32_t nds7_read32_seq(nds_t *nds, unsigned baddr,
                                             bool is_sequential) {
  return nds7_process_memory_transaction(nds, baddr, 0,
                                         NDS_MEM_4B | NDS_MEM_ARM7 |
                                             NDS_MEM_CODE |
...
static FORCE_INLINE uint16_t nds7_read16_seq(nds_t *nds, unsigned baddr,
                                             bool is_sequential) {
  return nds7_process_memory_transaction(nds, baddr, 0,
                                         NDS_MEM_2B | NDS_MEM_ARM7 |
                                             NDS_MEM_CODE |
                                             (is_sequential ? NDS_MEM_SEQ : 0));
}
...
static FORCE_INLINE uint8_t nds7_read8(nds_t *nds, unsigned baddr) {
  return nds7_process_memory_transaction(nds, baddr, 0,
                                         NDS_MEM_1B | NDS_MEM_ARM7);
}
static FORCE_INLINE uint32_t nds9_debug_read32(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(
      nds, baddr, 0, NDS_MEM_4B | NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE uint16_t nds9_debug_read16(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(
      nds, baddr, 0, NDS_MEM_2B | NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE uint8_t nds9_debug_read8(nds_t *nds, unsigned baddr) {
  return nds9_process_memory_transaction_cpu(
      nds, baddr, 0, NDS_MEM_1B | NDS_MEM_ARM9 | NDS_MEM_DEBUG);
}
static FORCE_INLINE uint8_t nds7_debug_read8(nds_t *nds, unsigned baddr) {
  return nds7_process_memory_transaction(
      nds, baddr, 0, NDS_MEM_1B | NDS_MEM_ARM7 | NDS_MEM_DEBUG);
}
static uint32_t nds_apply_vram_mem_op(nds_t *nds, uint32_t address,
                                      uint32_t data, int transaction_type);
...
uint32_t nds9_arm_read32(void *user_data, uint32_t address) {
  return nds9_cpu_read32((nds_t *)user_data, address);
}
uint32_t nds9_arm_read16(void *user_data, uint32_t address) {
  return nds9_cpu_read16((nds_t *)user_data, address);
}
uint32_t nds9_arm_read32_seq(void *user_data, uint32_t address,
                             bool is_sequential) {
  return nds9_cpu_read32_seq((nds_t *)user_data, address, is_sequential);
}
uint32_t nds9_arm_read16_seq(void *user_data, uint32_t address,
                             bool is_sequential) {
  return nds9_cpu_read16_seq((nds_t *)user_data, address, is_sequential);
}
uint8_t nds9_arm_read8(void *user_data, uint32_t address) {
  return nds9_cpu_read8((nds_t *)user_data, address);
}
void nds9_arm_write32(void *user_data, uint32_t address, uint32_t data) {
  nds9_cpu_write32((nds_t *)user_data, address, data);
}
void nds9_arm_write16(void *user_data, uint32_t address, uint16_t data) {
  nds9_cpu_write16((nds_t *)user_data, address, data);
}
void nds9_arm_write8(void *user_data, uint32_t address, uint8_t data) {
  nds9_cpu_write8((nds_t *)user_data, address, data);
}

uint32_t nds7_arm_read32(void *user_data, uint32_t address) {
  return nds7_read32((nds_t *)user_data, address);
}
uint32_t nds7_arm_read16(void *user_data, uint32_t address) {
  return nds7_read16((nds_t *)user_data, address);
}
uint32_t nds7_arm_read32_seq(void *user_data, uint32_t address,
                             bool is_sequential) {
  return nds7_read32_seq((nds_t *)user_data, address, is_sequential);
}
uint32_t nds7_arm_read16_seq(void *user_data, uint32_t address,
                             bool is_sequential) {
  return nds7_read16_seq((nds_t *)user_data, address, is_sequential);
}
uint8_t nds7_arm_read8(void *user_data, uint32_t address) {
  return nds7_read8((nds_t *)user_data, address);
}
void nds7_arm_write32(void *user_data, uint32_t address, uint32_t data) {
  nds7_write32((nds_t *)user_data, address, data);
}
void nds7_arm_write16(void *user_data, uint32_t address, uint16_t data) {
  nds7_write16((nds_t *)user_data, address, data);
}
void nds7_arm_write8(void *user_data, uint32_t address, uint8_t data) {
  nds7_write8((nds_t *)user_data, address, data);
}

uint32_t nds_coprocessor_read(void *user_data, int coproc, int opcode, int Cn,
                              int Cm, int Cp);
void nds_coprocessor_write(void *user_data, int coproc, int opcode, int Cn,
                           int Cm, int Cp, uint32_t data);

static FORCE_INLINE uint32_t nds_compute_access_cycles_dma(
...
void nds9_copy_card_region_to_ram(nds_t *nds, const char *region_name,
                                  uint32_t rom_offset, uint32_t ram_offset,
                                  uint32_t size) {
  printf("Copy %s: Card[0x%x]-> RAM[0x%x] Size: %d Card Size:%zu\n",
         region_name, rom_offset, ram_offset, size, nds->mem.card_size);
  for (int i = 0; i < size; ++i) {
    if (rom_offset + i < nds->mem.card_size)
      nds9_write8(nds, ram_offset + i, nds->mem.card_data[rom_offset + i]);
  }
}
void nds7_copy_card_region_to_ram(nds_t *nds, const char *region_name,
                                  uint32_t rom_offset, uint32_t ram_offset,
                                  uint32_t size) {
  printf("Copy %s: Card[0x%x]-> RAM[0x%x] Size: %d Card Size:%zu\n",
         region_name, rom_offset, ram_offset, size, nds->mem.card_size);
  for (int i = 0; i < size; ++i) {
    if (rom_offset + i < nds->mem.card_size)
      nds7_write8(nds, ram_offset + i, nds->mem.card_data[rom_offset + i]);
  }
}
...
bool nds_load_rom(sb_emu_state_t *emu, nds_t *nds, nds_scratch_t *scratch) {
  if (!sb_path_has_file_ext(emu->rom_path, ".nds"))
    return false;
  ...
  if (nds->mem.card_data)
    memcpy(&nds->card, nds->mem.card_data, sizeof(nds->card));
  bool load_nds7 =
      se_load_bios_file("NDS7 BIOS", nds->save_file_path, "nds7.bin",
                        scratch->nds7_bios, sizeof(scratch->nds7_bios));
  if (!load_nds7)
    memcpy(scratch->nds7_bios, drastic_bios_arm7_bin,
           sizeof(drastic_bios_arm7_bin));

  bool load_nds9 =
      se_load_bios_file("NDS9 BIOS", nds->save_file_path, "nds9.bin",
                        scratch->nds9_bios, sizeof(scratch->nds9_bios));
  if (!load_nds9)
    memcpy(scratch->nds9_bios, drastic_bios_arm9_bin,
           sizeof(drastic_bios_arm9_bin));

  bool loaded_firmware =
      se_load_bios_file("NDS Firmware", nds->save_file_path, "firmware.bin",
                        scratch->firmware, sizeof(scratch->firmware));
  ...
  if (fast_boot) {
    ...
    for (int i = 0; i < 37; ++i)
      nds->arm7.registers[i] = initial_regs[i];
    for (int i = 0; i < 37; ++i)
      nds->arm9.registers[i] = initial_regs_arm9[i];
    const uint32_t initial_mmio_writes[] = {
        0x4000000, 0x80,      0x4000004, 0x7e0000, 0x4000020, 0x100,
        0x4000024, 0x1000000, 0x4000030, 0x100,    0x4000034, 0x1000000,
        0x4000080, 0xe0000,   0x4000084, 0xf,      0x4000088, 0x200,
        0x4000100, 0xff8a,    0x4000130, 0x3ff,    0x4000134, 0x8000,
        0x4000300, 0x1,
    };
    for (int i = 0; i < sizeof(initial_mmio_writes) / sizeof(uint32_t);
         i += 2) {
    ...
    nds9_copy_card_region_to_ram(
        nds, "ARM9 Executable", nds->card.arm9_rom_offset,
        nds->card.arm9_ram_address, nds->card.arm9_size);
    nds7_copy_card_region_to_ram(
        nds, "ARM7 Executable", nds->card.arm7_rom_offset,
        nds->card.arm7_ram_address, nds->card.arm7_size);
    nds->arm9.registers[PC] = nds->card.arm9_entrypoint;
    nds->arm7.registers[PC] = nds->card.arm7_entrypoint;

    printf("ARM9 Entry:0x%x ARM7 Entry:0x%x\n", nds->card.arm9_entrypoint,
           nds->card.arm7_entrypoint);

    // Copy NDS Header into 27FFE00h..27FFF6F
    int header_size = 0x27FFF70 - 0x27FFE00;
    for (int i = 0; i < header_size; i += 4) {
      nds9_write32(nds, 0x027FFE00 + i,
                   *(uint32_t *)(((uint8_t *)&nds->card) + i));
    }
  ...
  if (nds->arm7.log_cmp_file) {
    fclose(nds->arm7.log_cmp_file);
    nds->arm7.log_cmp_file = NULL;
  };
  if (nds->arm9.log_cmp_file) {
    fclose(nds->arm9.log_cmp_file);
    nds->arm9.log_cmp_file = NULL;
  };
  ...
  if (!loaded_firmware) {
    uint8_t stub_header_data[0x200] = {
        ,
    };
    for (int i = 0; i < 0x200; ++i) {
      firm_data[(i) & (sizeof(scratch->firmware) - 1)] = stub_header_data[i];
    }
    user_data_off = ((firm_data[0x21] << 8) | (firm_data[0x20])) * 8;
    uint8_t user_d_stub[] = {
        0x05, 0x00, 0x00, 0x07, 0x05, 0x00, 0x53, 0x00, 0x6b, 0x00, 0x79, 0x00,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xf0, 0x01, 0xe0, 0x01, 0x20, 0x20, 0xe0, 0x0d,
        0xd0, 0x09, 0xe0, 0xa0, 0x01, 0xfc, 0x05, 0x7e, 0x28, 0xa0, 0x3c, 0x0a,
        0x00, 0x00, 0x00, 0x00, 0x30, 0x00, 0xf2, 0x72, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        ...
        ,
    ...
    for (int i = 0x3FE00; i < 0x40000; ++i) {
      firm_data[i] = user_d_stub[i - 0x3FE00];
    }
  } else {
    for (int i = 0x3FE00; i < 0x40000; ++i) {
      printf("0x%02x,", firm_data[i]);
      if ((i % 8) == 7)
        printf("\n");
    }
  }
  ...
  for (int i = 0; i < 0x070; ++i) {
    nds9_write8(
        nds, i + 0x27FFC80,
        firm_data[(user_data_off + i) & (sizeof(scratch->firmware) - 1)]);
  }
  nds_reset_gpu(nds);

  uint32_t game_code =
      (nds->card.gamecode[0] << 0) | (nds->card.gamecode[1] << 8) |
      (nds->card.gamecode[2] << 16) | (nds->card.gamecode[3] << 24);
  nds_rom_entry_t *rom_entry = (nds_rom_entry_t *)bsearch(
      &game_code, nds_rom_database,
      sizeof(nds_rom_database) / sizeof(nds_rom_database[0]),
      sizeof(nds_rom_database[0]), nds_rom_db_compare_func);
  if (rom_entry && rom_entry->GameCode == game_code) {
    nds->backup.backup_type = rom_entry->SaveMemType;
  } else {
    printf("Save type could not be looked up in the database. A default will "
           "be assumed");
  ...
  if (data) {
    ...
    if (bytes >= nds_get_save_size(nds))
      bytes = nds_get_save_size(nds);
    memcpy(nds->mem.save_data, data, bytes);
    sb_free_file_data(data);
  } else {
    printf("Could not find save file: %s\n", emu->save_file_path);
    for (int i = 0; i < sizeof(nds->mem.save_data); ++i)
      nds->mem.save_data[i] = 0;
  }
...
static void nds_process_gc_bus_read(nds_t *nds, int cpu_id) {
  ...
  if (nds->mem.card_transfer_bytes <= 0) {
    ...
    if (transfer_ready_irq) {
      if (cpu_id == NDS_ARM7)
        nds7_send_interrupt(nds, 4, 1 << NDS_INT_GC_TRANSFER_DONE);
      else
        nds9_send_interrupt(nds, 4, 1 << NDS_INT_GC_TRANSFER_DONE);
    }
  }
}
...
static void nds_process_gc_bus_ctl(nds_t *nds, int cpu_id) {
  uint16_t exmemcnt = nds9_io_read16(nds, NDS9_EXMEMCNT);
  bool arm7_has_slot = SB_BFE(exmemcnt, 11, 1);
  if (arm7_has_slot && cpu_id != NDS_ARM7)
    return;
  nds->activate_dmas = true;
  uint32_t gcbus_ctl = nds_io_read32(nds, cpu_id, NDS_GCBUS_CTL);
  ...
  if (start_transfer) {
    ...
    uint8_t commands[8];
    for (int i = 0; i < 7; ++i)
      commands[i] = nds9_io_read8(nds, NDS_GCBUS_CMD + i);
    if (nds->gc_log)
      fprintf(nds->gc_log, "GCBUS CMD: %02x %02x %02x%02x %02x%02x %02x%02x\n",
              commands[0], commands[1], commands[2], commands[3], commands[4],
              commands[5], commands[6], commands[7]);
    switch (commands[0]) {
    case NDS_CARD_MAIN_DATA_READ: {
      // Encrypted data read;
      int read_off = (((int)commands[1]) << 24) | (((int)commands[2]) << 16) |
                     (((int)commands[3]) << 8) | (((int)commands[4]) << 0);
      if (read_off <= 0x7FFF)
        read_off = 0x8000 + (read_off & 0x1FF);
      nds->mem.card_read_offset = read_off;
      int data_block_size = SB_BFE(gcbus_ctl, 24, 3);
      const int transfer_size_map[8] = {0,      0x200,  0x400,  0x800,
                                        0x1000, 0x2000, 0x4000, 4};
      for (int i = 0; i < 0x1000; ++i) {
        nds->mem.card_transfer_data[i] =
            nds->mem.card_data[(i + (read_off & ~0xfff)) % nds->mem.card_size];
      }
      nds->mem.card_transfer_bytes = transfer_size_map[data_block_size];
      if (nds->gc_log)
        fprintf(nds->gc_log, "Encrypted Read: 0x%08x transfer_size: %08x\n",
    ...
    case NDS_CARD_CHIP_ID_READ: {
      ...
      nds->mem.card_transfer_bytes = 4;
      if (nds->gc_log)
        fprintf(nds->gc_log, "CHIPID Read transfer:\n");
      gcbus_ctl |= (1 << 23) | (1 << 31); // Set data_ready bit and busy
    } break;
    default:
...
/* Only simulates a small subset of the RTC needed to make time events work in
 * the pokemon games. */
...
#define NDS_RTC_TIME 3
  ...
  if (cs != 0) {
    ...
    if (new_bit) {
      ...
      if (nds->rtc.serial_bits_clocked == 8)
        nds->rtc.state = SB_BFE(nds->rtc.input_register, 0, 4);
      int cmd = SB_BFE(rtc->state, 1, 3);
      bool read = SB_BFE(rtc->state, 0, 1);
      switch (cmd) {
      case NDS_RTC_RECV_CMD:
        break;
      case NDS_RTC_STATUS: {
        if (rtc->serial_bits_clocked == 8)
          rtc->output_register = rtc->status_register;
        if (rtc->serial_bits_clocked == 16) {
          if (!read)
            rtc->status_register = SB_BFE(rtc->input_register, 0, 8);
          rtc->state = NDS_RTC_RECV_CMD;
          rtc->serial_bits_clocked = 0;
        }
        break;
      ...
      case NDS_RTC_TIME: {
        if (rtc->serial_bits_clocked == 8)
          rtc->output_register = ((uint64_t)(rtc->hour & 0xff) << (0 * 8)) |
...
static uint32_t nds_get_save_size(nds_t *nds) {
  ...
  case NDS_BACKUP_NONE:
    save_size = 0;
    break;
  case NDS_BACKUP_EEPROM_512B:
    save_size = 512;
    break;
  case NDS_BACKUP_EEPROM_8KB:
    save_size = 8 * 1024;
    break;
  case NDS_BACKUP_EEPROM_64KB:
    save_size = 64 * 1024;
    break;
  case NDS_BACKUP_EEPROM_128KB:
    save_size = 128 * 1024;
    break;
  case NDS_BACKUP_FLASH_256KB:
    save_size = 256 * 1024;
    break;
  case NDS_BACKUP_FLASH_512KB:
    save_size = 512 * 1024;
    break;
  case NDS_BACKUP_FLASH_1MB:
    save_size = 1024 * 1024;
    break;
  case NDS_BACKUP_NAND_8MB:
    save_size = 8 * 1024 * 1024;
    break;
  case NDS_BACKUP_NAND_16MB:
    save_size = 16 * 1024 * 1024;
    break;
  case NDS_BACKUP_NAND_64MB:
    save_size = 64 * 1024 * 1024;
    break;
  }
  return save_size;
}
static uint32_t nds_get_curr_backup_address(nds_t *nds) {
  ...
  if (bak->backup_type == NDS_BACKUP_EEPROM_512B) {
    ...
    if (bak->command_offset < 3)
      return 0xffffffff;
    // Handle high address commands
    if (bak->command[0] == 0x0B || bak->command[0] == 0x0A)
      base_addr |= 0x100;
    return (base_addr + bak->command_offset - 3) % save_size;
  }
  if (bak->backup_type >= NDS_BACKUP_EEPROM_8KB &&
      bak->backup_type <= NDS_BACKUP_EEPROM_64KB) {
    uint32_t base_addr =
        (nds->backup.command[1] << 8) | (nds->backup.command[2]);
    if (bak->command_offset < 4)
      return 0xffffffff;
    return (base_addr + bak->command_offset - 4) % save_size;
  }
  if (bak->backup_type == NDS_BACKUP_EEPROM_128KB) {
    uint32_t base_addr = (nds->backup.command[1] << 16) |
                         (nds->backup.command[2] << 8) |
                         (nds->backup.command[3]);
    if (bak->command_offset < 5)
      return 0xffffffff;
    return (base_addr + bak->command_offset - 5) % save_size;
  }
  if (bak->backup_type == NDS_BACKUP_NONE)
    return 0xffffffff;
...
static void nds_process_gc_spi(nds_t *nds, int cpu_id) {
  ...
  if (slot_enable == false || slot_mode == false)
    return;
  ...
  if (back->command[0] == 0x08) {
    ...
    if (nds->backup.backup_type >= NDS_BACKUP_FLASH_256KB &&
        nds->backup.backup_type <= NDS_BACKUP_FLASH_1MB) {
      ret_data =
          nds_process_flash_write(nds, spi_data, &nds->backup.flash,
                                  nds->mem.save_data, nds_get_save_size(nds));
      ...
      case 0x00: /*NOP*/
        break;
      case 0x06: /*WREN*/
        back->write_enable = true;
        break;
      case 0x04: /*WRDI*/
        back->write_enable = false;
        break;
      case 0x05: /*RDSR*/
        /*
          Status Register
            0   WIP  Write in Progress (1=Busy) (Read only) (always 0 for FRAM
          chips) 1   WEL  Write Enable Latch (1=Enable) (Read only, except by
          WREN,WRDI) 2-3 WP   Write Protect (0=None, 1=Upper quarter, 2=Upper
          Half, 3=All memory) For 0.5K EEPROM: 4-7 ONEs Not used (all four bits
          are always set to "1" each) For 8K..64K EEPROM and for FRAM: 4-6 ZERO
          Not used (all three bits are always set to "0" each) 7   SRWD Status
          Register Write Disable (0=Normal, 1=Lock) (Only if /W=LOW)
        */
        back->status_reg &= (3 << 2) | (1 << 7);
        if (back->write_enable)
          back->status_reg |= 0x2;
        if (back->backup_type == NDS_BACKUP_EEPROM_512B)
          back->status_reg |= 0xf0;
        ret_data = back->status_reg;
        break;
      case 0x01: /*WRSR*/
        back->status_reg = spi_data;
        break;
      case 0x9f: /*RDID*/
        ret_data = 0xff;
        break;
      ...
      case 0x0B: /*RDHI*/ {
        ...
        if (addr != 0xffffffff)
          ret_data = nds->mem.save_data[addr];
        break;
      }
      case 0x02: /*WR/WRLO*/
      case 0x0A: /*WRHI*/ {
      ...
      default:
        if (back->command_offset == 1)
          printf("Unknown AUX SPI command:%02x\n", back->command[0]);
        break;
      }
    }
  }
...
static FORCE_INLINE uint32_t nds_align_data(uint32_t addr, uint32_t data,
                                            int transaction_type) {
  if (transaction_type & NDS_MEM_2B)
    data = (data & 0xffff) << ((addr & 2) * 8);
  if (transaction_type & NDS_MEM_1B)
    data = (data & 0xff) << ((addr & 3) * 8);
  return data;
}
static FORCE_INLINE uint32_t nds_word_mask(uint32_t addr,
                                           int transaction_type) {
  if (transaction_type & NDS_MEM_2B)
    return (0xffffu) << ((addr & 2) * 8);
  if (transaction_type & NDS_MEM_1B)
    return (0xffu) << ((addr & 3) * 8);
  return 0xffffffff;
}
...
static uint8_t nds_process_flash_write(nds_t *nds, uint8_t write_data,
  ...
  if (flash->state == NDS_FLASH_RECV_CMD) {
    ...
    case 0x06:
      ...
      break; // WriteEnable(WREM)
    case 0x04:
      flash->write_enable = false;
      break; // WriteDisable(WRDI)
    ...
    case 0xD8: // SectorErase(SE)
      ...
      break;
    case 0xB9:
      break; // DeepPowerDown(DP)
    case 0xAB:
      break; // ReleaseDeepPowerDown(RDP)
    }
    ...
    case 0x0A: // PageWrite(PW)
    {
      uint32_t addr = flash->addr;
      flash->addr =
          ((flash->addr + 1) & page_mask) | (flash->addr & ~page_mask);
      if (flash->write_enable)
        return_data = flash_data[addr & (flash_size - 1)] = write_data;
      break;
    }
    case 0x02: // PageProgram(PP)
    {
    ...
    case 0xDB: // PageErase(PE)
    {
      ...
      if (flash->write_enable)
        for (int i = 0; i <= page_mask; ++i)
          return_data = flash_data[(flash->addr | i) & (flash_size - 1)] = 0xff;
      break;
    }
    case 0xD8: // SectorErase(SE)
    {
...
static uint8_t nds_process_touch_ctrl_write(nds_t *nds, uint8_t data) {
  ...
  if (data & 0x80) {
    ...
    case 0:
      touch->tx_reg = 0x7FF8;
      break; // Temperature 0 (requires calibration, step 2.1mV per 1'C
             // accuracy)
    case 1:
      touch->tx_reg = touch->y_reg;
      break; // Touchscreen Y-Position  (somewhat 0B0h..F20h, or FFFh=released)
    case 2:
      touch->tx_reg = 0xf0;
      break; // Battery Voltage         (not used, connected to GND in NDS,
             // always 000h)
    case 3:
      touch->tx_reg = 0x7FF8;
      break; // Touchscreen Z1-Position (diagonal position for pressure
             // measurement)
    case 4:
      touch->tx_reg = 0x7FF8;
      break; // Touchscreen Z2-Position (diagonal position for pressure
             // measurement)
    case 5:
      touch->tx_reg = touch->x_reg;
      break; // Touchscreen X-Position  (somewhat 100h..ED0h, or 000h=released)
    case 6:
      touch->tx_reg = 0x7FF8;
      break; // AUX Input               (connected to Microphone in the NDS)
    case 7:
      touch->tx_reg = 0x7FF8;
      break; // Temperature 1 (difference to Temp 0, without calibration, 2'C
             // accuracy)
    }
...
static float *nds_gpu_get_active_matrix(nds_t *nds) {
  ...
  case NDS_MATRIX_PROJ:
    return nds->gpu.proj_matrix;
  case NDS_MATRIX_DIR:
  case NDS_MATRIX_MV:
    return nds->gpu.mv_matrix;
  case NDS_MATRIX_TEX:
    return nds->gpu.tex_matrix;
  default:
...
void nds_mult_matrix4(float *res, float *m2) {
  // printf("Mult Matrix:\n");
  // for(int y=0;y<4;++y)printf("%f %f %f
  ...
  for (int y = 0; y < 4; ++y)
    for (int x = 0; x < 4; ++x) {
      res[x + y * 4] =
          m2[0 + y * 4] * t[x + 0 * 4] + m2[1 + y * 4] * t[x + 1 * 4] +
          m2[2 + y * 4] * t[x + 2 * 4] + m2[3 + y * 4] * t[x + 3 * 4];
    }
}
...
static bool nds_sample_texture(nds_t *nds, float *tex_color, float *uv) {
  ...
  case 0x1: /*Format 1: A3I5 Translucent Texture (3bit Alpha, 5bit Color
               Index)*/
  {
    uint32_t palette =
        nds_ppu_read8(nds, NDS_VRAM_TEX_SLOT0 + vram_offset + x + y * sz[0]);
    uint32_t alpha = SB_BFE(palette, 5, 3);
    palette = SB_BFE(palette, 0, 5);
    uint32_t palette_base = SB_BFE(nds->gpu.tex_plt_base, 0, 13) * 16;
    uint16_t color = nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_base +
                                             palette * 2);
  ...
  {
    uint32_t palette = nds_ppu_read8(nds, NDS_VRAM_TEX_SLOT0 + vram_offset +
                                              x / 4 + y * sz[0] / 4);
    palette = SB_BFE(palette, 2 * (x & 3), 2);
    uint32_t palette_base = SB_BFE(nds->gpu.tex_plt_base, 0, 13) * 8;
    uint16_t color = nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_base +
                                             palette * 2);
    if (palette == 0 && color0_transparent)
      tex_color[3] = 0;
    tex_color[0] = SB_BFE(color, 0, 5) / 31.;
    tex_color[1] = SB_BFE(color, 5, 5) / 31.;
    tex_color[2] = SB_BFE(color, 10, 5) / 31.;
  ...
  case 0x5: {
    ...
    uint32_t slot1_addr =
        slot0_addr >= 128 * 1024 ? slot0_addr / 2 - 64 * 1024 : slot0_addr / 2;

    uint16_t pal_index_data =
        nds_ppu_read16(nds, NDS_VRAM_TEX_SLOT1 + slot1_addr);
    int palette_off = SB_BFE(pal_index_data, 0, 14);
    int mode = SB_BFE(pal_index_data, 14, 2);
    int slot = slot0_addr / (128 * 1024);
    uint32_t palette_addr =
        palette_off * 4 + SB_BFE(nds->gpu.tex_plt_base, 0, 13) * 16;

    switch (texel) {
    case 0: {
      uint16_t color =
          nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr);
      tex_color[0] = SB_BFE(color, 0, 5) / 31.;
      tex_color[1] = SB_BFE(color, 5, 5) / 31.;
      tex_color[2] = SB_BFE(color, 10, 5) / 31.;
      tex_color[3] = 1.0;
    ...
    case 1: {
      uint16_t color =
          nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 2);
      tex_color[0] = SB_BFE(color, 0, 5) / 31.;
      tex_color[1] = SB_BFE(color, 5, 5) / 31.;
      tex_color[2] = SB_BFE(color, 10, 5) / 31.;
      tex_color[3] = 1.0;
    ...
    case 2: {
      if (mode == 0 || mode == 2) {
        uint16_t color =
            nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 4);
        tex_color[0] = SB_BFE(color, 0, 5) / 31.;
        tex_color[1] = SB_BFE(color, 5, 5) / 31.;
        tex_color[2] = SB_BFE(color, 10, 5) / 31.;
        tex_color[3] = 1.0;
        ...
        uint16_t color0 =
            nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 0);
        uint16_t color1 =
            nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 2);
        if (mode == 1) {
          tex_color[0] =
              (SB_BFE(color0, 0, 5) + SB_BFE(color1, 0, 5)) / 31. * 0.5;
          tex_color[1] =
              (SB_BFE(color0, 5, 5) + SB_BFE(color1, 5, 5)) / 31. * 0.5;
          tex_color[2] =
              (SB_BFE(color0, 10, 5) + SB_BFE(color1, 10, 5)) / 31. * 0.5;
        } else {
          tex_color[0] =
              (SB_BFE(color0, 0, 5) * 5 + SB_BFE(color1, 0, 5) * 3) / 8. / 31.;
          tex_color[1] =
              (SB_BFE(color0, 5, 5) * 5 + SB_BFE(color1, 5, 5) * 3) / 8. / 31.;
          tex_color[2] =
              (SB_BFE(color0, 10, 5) * 5 + SB_BFE(color1, 10, 5) * 3) / 8. /
              31.;
        }
        tex_color[3] = 1.0;
      }
    ...
    case 3: {
      if (mode == 0 || mode == 1) {
        ...
        uint16_t color =
            nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 6);
        tex_color[0] = SB_BFE(color, 0, 5) / 31.;
        tex_color[1] = SB_BFE(color, 5, 5) / 31.;
        tex_color[2] = SB_BFE(color, 10, 5) / 31.;
        tex_color[3] = 1.0;
        ...
        uint16_t color1 =
            nds_ppu_read16(nds, NDS_VRAM_TEX_PAL_SLOT0 + palette_addr + 2);
        tex_color[0] =
            (SB_BFE(color0, 0, 5) * 3 + SB_BFE(color1, 0, 5) * 5) / 8. / 31.;
        tex_color[1] =
            (SB_BFE(color0, 5, 5) * 3 + SB_BFE(color1, 5, 5) * 5) / 8. / 31.;
        tex_color[2] =
            (SB_BFE(color0, 10, 5) * 3 + SB_BFE(color1, 10, 5) * 5) / 8. / 31.;
        tex_color[3] = 1.0;
      }
    } break;
    }
  } break;
  case 0x6: /*Format 6: A5I3 Translucent Texture (5bit Alpha, 3bit Color
               Index)*/
  {
    uint32_t palette =
        nds_ppu_read8(nds, NDS_VRAM_TEX_SLOT0 + vram_offset + x + y * sz[0]);
  ...
  {
    uint32_t color = nds_ppu_read16(nds, NDS_VRAM_TEX_SLOT0 + vram_offset +
                                             x * 2 + y * sz[0] * 2);
    tex_color[0] = SB_BFE(color, 0, 5) / 31.;
    tex_color[1] = SB_BFE(color, 5, 5) / 31.;
    tex_color[2] = SB_BFE(color, 10, 5) / 31.;
...
static bool nds_gpu_draw_tri(nds_t *nds, int vi0, int vi1, int vi2) {
  if (nds->gpu.poly_ram_offset >= 2048)
    return true; // Ignore extra polygons for now
  uint32_t disp3dcnt = nds9_io_read32(nds, NDS_DISP3DCNT);

  bool tex_map =
      SB_BFE(disp3dcnt, 0, 1); /*Texture Mapping      (0=Disable, 1=Enable)*/
  bool shade_mode =
      SB_BFE(disp3dcnt, 1,
             1); /*PolygonAttr Shading  (0=Toon Shading, 1=Highlight Shading)*/
  bool alpha_test = SB_BFE(
      disp3dcnt, 2,
      1); /*Alpha-Test           (0=Disable, 1=Enable) (see ALPHA_TEST_REF)*/
  bool alpha_blend =
      SB_BFE(disp3dcnt, 3, 1); /*Alpha-Blending       (0=Disable, 1=Enable) (see
                                  various Alpha values)*/
  bool anti_alias =
      SB_BFE(disp3dcnt, 4, 1); /*Anti-Aliasing        (0=Disable, 1=Enable)*/
  bool edge_mark =
      SB_BFE(disp3dcnt, 5,
             1); /*Edge-Marking         (0=Disable, 1=Enable) (see EDGE_COLOR)*/
  bool fogalpha_mode =
      SB_BFE(disp3dcnt, 6, 1); /*Fog Color/Alpha Mode (0=Alpha and Color, 1=Only
                                  Alpha) (see FOG_COLOR)*/
  bool fog_enable =
      SB_BFE(disp3dcnt, 7, 1); /*Fog Master Enable    (0=Disable, 1=Enable)*/
  int fog_depth_shift =
      SB_BFE(disp3dcnt, 8, 4); /*Fog Depth Shift      (FOG_STEP=400h shr
                                  FOG_SHIFT) (see FOG_OFFSET)*/
  bool rear_plane_mode = SB_BFE(disp3dcnt,
                                14, 1); /*Rear-Plane Mode (0=Blank, 1=Bitmap)*/

  nds_vert_t *v[3] = {nds->gpu.vert_buffer + vi0, nds->gpu.vert_buffer + vi1,
                      nds->gpu.vert_buffer + vi2};
  for (int i = 0; i < 3; ++i) {
  ...
  int polygon_mode =
      SB_BFE(poly_attr, 4,
             2); //(0=Modulation,1=Decal,2=Toon/Highlight Shading,3=Shadow)
  ...
  bool front_face = true;
  {
    ...
    if (!((front_face && render_front) || (!front_face && render_back)))
      return true;
  ...
  float tri_area =
      sub_tri_area_ref[0] + sub_tri_area_ref[1] + sub_tri_area_ref[2];
  ...
  for (float y = min_p[1]; y < max_p[1]; y += y_inc) {
    ...
    for (float x = min_p[0]; x < max_p[0]; x += x_inc) {
      ...
      float z = v[0]->pos[2] + bary[1] * (v[1]->pos[2] - v[0]->pos[2]) +
                bary[2] * (v[2]->pos[2] - v[0]->pos[2]);
      float w = v[0]->pos[3] + bary[1] * (v[1]->pos[3] - v[0]->pos[3]) +
                bary[2] * (v[2]->pos[3] - v[0]->pos[3]);
      // if(z<=0)continue;
      ...
      if (nds->framebuffer_3d_depth[p] < z * 0.999999)
        continue;
      float uv[2];
      ...
      bool discard = false;
      if (tex_map)
        discard |= nds_sample_texture(nds, tex_color, uv);
      if (discard)
        continue;
      ...
      float col_v[4];
      SE_RPT3 col_v[r] =
          (v[0]->color[r] + color_i[r] * bary[1] + color_j[r] * bary[2]) / 255.;
      col_v[3] = alpha / 31.;
      ...
      if (polygon_mode == 0) {
        ...
        // Decal Mode
        SE_RPT3 output_col[r] =
            (tex_color[r] * tex_color[3] + col_v[r] * (1 - tex_color[3] + 0.5));
        output_col[3] = col_v[3];
      } else if (polygon_mode == 2) {
        int toon_highlight_entry = floor(col_v[0] * 255 / 8.);
        // printf("toon entry: %d\n",toon_highlight_entry);
        uint16_t color =
            nds9_io_read16(nds, NDS9_TOON_TABLE + toon_highlight_entry * 2);
      ...
      if (alpha_test) {
        ...
        if (output_col[3] <= alpha_test_ref / 31.)
          continue;
      }
      if (translucent_has_depth || alpha_blend_factor > 0.95)
        nds->framebuffer_3d_depth[p] = z;
      for (int c = 0; c < 3; ++c) {
        nds->framebuffer_3d[p * 4 + c] =
            output_col[c] * 255 * alpha_blend_factor +
            (nds->framebuffer_3d[p * 4 + c]) * (1.0 - alpha_blend_factor);
      }
      if (nds->framebuffer_3d[p * 4 + 3] < alpha_blend_factor * 255)
        nds->framebuffer_3d[p * 4 + 3] = alpha_blend_factor * 255;
    }
...
static bool nds_gpu_clip_tri(nds_t *nds, int vi0, int vi1, int vi2) {
  ...
  if (vb[inds[0]].pos[3] > 0.) {
    if (vb[inds[2]].pos[3] > 0.) {
      if (vb[inds[1]].pos[3] > 0.)
        return nds_gpu_draw_tri(nds, inds[0], inds[1], inds[2]);
      int i = inds[0];
      inds[0] = inds[2];
      inds[2] = inds[1];
      inds[1] = i;
    }
  } else if (vb[inds[1]].pos[3] > 0.) {
    int i = inds[0];
    inds[0] = inds[1];
    inds[1] = inds[2];
    inds[2] = i;
  } else if (vb[inds[2]].pos[3] > 0.) {
    int i = inds[0];
    inds[0] = inds[2];
    inds[2] = inds[1];
    inds[1] = i;
  ...
  if (vb[inds[1]].pos[3] < 0.) {
    ...
    vb[extra_ind0] = vb[inds[1]];
    vb[extra_ind1] = vb[inds[2]];
    nds_interp_wp_vert(nds, inds[0], extra_ind0);
    nds_interp_wp_vert(nds, inds[0], extra_ind1);
    return nds_gpu_draw_tri(nds, inds[0], extra_ind0, extra_ind1);
  }

  int extra_ind0 = NDS_MAX_VERTS - 1;
  int extra_ind1 = NDS_MAX_VERTS - 2;
  vb[extra_ind0] = vb[inds[2]];
  vb[extra_ind1] = vb[inds[2]];
  nds_interp_wp_vert(nds, inds[0], extra_ind0);
  nds_interp_wp_vert(nds, inds[1], extra_ind1);
  bool culled = nds_gpu_draw_tri(nds, inds[0], inds[1], extra_ind1);
  culled &= nds_gpu_draw_tri(nds, inds[0], extra_ind1, extra_ind0);
  return culled;
}
static void nds_gpu_process_vertex(nds_t *nds, int16_t vx, int16_t vy,
                                   int16_t vz) {
  if (nds->gpu.curr_vert >= 6144)
    return;
  nds->gpu.last_vertex_pos[0] = vx;
  nds->gpu.last_vertex_pos[1] = vy;
  nds->gpu.last_vertex_pos[2] = vz;

  if (SB_UNLIKELY(nds->vert_log))
  ...
  float uv[4] = {nds->gpu.curr_tex_coord[0] / 16.,
                 nds->gpu.curr_tex_coord[1] / 16., 0, 1};
  ...
  /*Triangles */ case 0:
    if ((nds->gpu.curr_draw_vert % 3) == 0) {
      bool culled =
          nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 3, nds->gpu.curr_vert - 2,
                           nds->gpu.curr_vert - 1);
      if (culled)
        nds->gpu.curr_vert -= 3;
      else
  ...
  /*Quads     */ case 1:
    if ((nds->gpu.curr_draw_vert % 4) == 0) {
      bool culled = nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 4 + 0,
                                     nds->gpu.curr_vert - 4 + 1,
                                     nds->gpu.curr_vert - 4 + 2);
      culled &= nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 4 + 2,
                                 nds->gpu.curr_vert - 4 + 3,
                                 nds->gpu.curr_vert - 4 + 0);
      if (culled)
        nds->gpu.curr_vert -= 4;
      else
        nds->gpu.poly_ram_offset++;
  ...
  /*Tristrip  */ case 2:
    if (nds->gpu.curr_draw_vert >= 3) {
      bool culled = true;
      if (nds->gpu.curr_draw_vert & 1)
        culled &=
            nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 3,
                             nds->gpu.curr_vert - 2, nds->gpu.curr_vert - 1);
      else
        culled &=
            nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 3,
                             nds->gpu.curr_vert - 1, nds->gpu.curr_vert - 2);
      nds->gpu.rendered_primitive_tracker <<= 1;
      if (culled) {
        nds->gpu.rendered_primitive_tracker |= 1;
        if ((nds->gpu.rendered_primitive_tracker & 0x7) == 0x7) {
          nds->gpu.vert_buffer[nds->gpu.curr_vert - 3] =
              nds->gpu.vert_buffer[nds->gpu.curr_vert - 2];
          nds->gpu.vert_buffer[nds->gpu.curr_vert - 2] =
              nds->gpu.vert_buffer[nds->gpu.curr_vert - 1];
          nds->gpu.curr_vert--;
        } else
          nds->gpu.poly_ram_offset++;
      }
  ...
  /*Quadstrip */ case 3:
    if (nds->gpu.curr_draw_vert >= 4 && (nds->gpu.curr_draw_vert % 2) == 0) {
      ...
      if (nds->gpu.curr_draw_vert % 4) {
        culled &= nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 6 + 2,
                                   nds->gpu.curr_vert - 6 + 3,
                                   nds->gpu.curr_vert - 6 + 5);
        culled &= nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 6 + 5,
                                   nds->gpu.curr_vert - 6 + 4,
                                   nds->gpu.curr_vert - 6 + 2);
      } else {
        culled &= nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 4 + 0,
                                   nds->gpu.curr_vert - 4 + 1,
                                   nds->gpu.curr_vert - 4 + 3);
        culled &= nds_gpu_clip_tri(nds, nds->gpu.curr_vert - 4 + 3,
                                   nds->gpu.curr_vert - 4 + 2,
                                   nds->gpu.curr_vert - 4 + 0);
      }
      if (culled) {
        ...
        if ((nds->gpu.rendered_primitive_tracker & 0x3) == 0x3) {
          nds->gpu.vert_buffer[nds->gpu.curr_vert - 4] =
              nds->gpu.vert_buffer[nds->gpu.curr_vert - 2];
          nds->gpu.vert_buffer[nds->gpu.curr_vert - 3] =
              nds->gpu.vert_buffer[nds->gpu.curr_vert - 1];
          nds->gpu.curr_vert -= 2;
...
static int nds_gpu_cmd_params(int cmd) {
  switch (cmd) {
  case 0x10:
    return 1; /*MTX_MODE - Set Matrix Mode (W)*/
  case 0x11:
    return 0; /*MTX_PUSH - Push Current Matrix on Stack (W)*/
  case 0x12:
    return 1; /*MTX_POP - Pop Current Matrix from Stack (W)*/
  case 0x13:
    return 1; /*MTX_STORE - Store Current Matrix on Stack (W)*/
  case 0x14:
    return 1; /*MTX_RESTORE - Restore Current Matrix from Stack (W)*/
  case 0x15:
    return 0; /*MTX_IDENTITY - Load Unit Matrix to Current Matrix (W)*/
  case 0x16:
    return 16; /*MTX_LOAD_4x4 - Load 4x4 Matrix to Current Matrix (W)*/
  case 0x17:
    return 12; /*MTX_LOAD_4x3 - Load 4x3 Matrix to Current Matrix (W)*/
  case 0x18:
    return 16; /*MTX_MULT_4x4 - Multiply Current Matrix by 4x4 Matrix (W)*/
  case 0x19:
    return 12; /*MTX_MULT_4x3 - Multiply Current Matrix by 4x3 Matrix (W)*/
  case 0x1A:
    return 9; /*MTX_MULT_3x3 - Multiply Current Matrix by 3x3 Matrix (W)*/
  case 0x1B:
    return 3; /*MTX_SCALE - Multiply Current Matrix by Scale Matrix (W)*/
  case 0x1C:
    return 3; /*MTX_TRANS - Mult. Curr. Matrix by Translation Matrix (W)*/
  case 0x20:
    return 1; /*COLOR - Directly Set Vertex Color (W)*/
  case 0x21:
    return 1; /*NORMAL - Set Normal Vector (W)*/
  case 0x22:
    return 1; /*TEXCOORD - Set Texture Coordinates (W)*/
  case 0x23:
    return 2; /*VTX_16 - Set Vertex XYZ Coordinates (W)*/
  case 0x24:
    return 1; /*VTX_10 - Set Vertex XYZ Coordinates (W)*/
  case 0x25:
    return 1; /*VTX_XY - Set Vertex XY Coordinates (W)*/
  case 0x26:
    return 1; /*VTX_XZ - Set Vertex XZ Coordinates (W)*/
  case 0x27:
    return 1; /*VTX_YZ - Set Vertex YZ Coordinates (W)*/
  case 0x28:
    return 1; /*VTX_DIFF - Set Relative Vertex Coordinates (W)*/
  case 0x29:
    return 1; /*POLYGON_ATTR - Set Polygon Attributes (W)*/
  case 0x2A:
    return 1; /*TEXIMAGE_PARAM - Set Texture Parameters (W)*/
  case 0x2B:
    return 1; /*PLTT_BASE - Set Texture Palette Base Address (W)*/
  case 0x30:
    return 1; /*DIF_AMB - MaterialColor0 - Diffuse/Ambient Reflect. (W)*/
  case 0x31:
    return 1; /*SPE_EMI - MaterialColor1 - Specular Ref. & Emission (W)*/
  case 0x32:
    return 1; /*LIGHT_VECTOR - Set Light's Directional Vector (W)*/
  case 0x33:
    return 1; /*LIGHT_COLOR - Set Light Color (W)*/
  case 0x34:
    return 32; /*SHININESS - Specular Reflection Shininess Table (W)*/
  case 0x40:
    return 1; /*BEGIN_VTXS - Start of Vertex List (W)*/
  case 0x41:
    return 0; /*END_VTXS - End of Vertex List (W)*/
  case 0x50:
    return 1; /*SWAP_BUFFERS - Swap Rendering Engine Buffer (W)*/
  case 0x60:
    return 1; /*VIEWPORT - Set Viewport (W)*/
  case 0x70:
    return 3; /*BOX_TEST - Test if Cuboid Sits inside View Volume (W)*/
  case 0x71:
    return 2; /*POS_TEST - Set Position Coordinates for Test (W)*/
  case 0x72:
    return 1; /*VEC_TEST - Set Directional Vector for Test (W)*/
  }
  return 0;
}
...
static int nds_gpu_cmd_cycles(int cmd) {
  ...
  case 0x10:
    return 1; /*MTX_MODE - Set Matrix Mode (W)*/
  case 0x11:
    return 17; /*MTX_PUSH - Push Current Matrix on Stack (W)*/
  case 0x12:
    return 36; /*MTX_POP - Pop Current Matrix from Stack (W)*/
  case 0x13:
    return 17; /*MTX_STORE - Store Current Matrix on Stack (W)*/
  case 0x14:
    return 36; /*MTX_RESTORE - Restore Current Matrix from Stack (W)*/
  case 0x15:
    return 19; /*MTX_IDENTITY - Load Unit Matrix to Current Matrix (W)*/
  case 0x16:
    return 34; /*MTX_LOAD_4x4 - Load 4x4 Matrix to Current Matrix (W)*/
  case 0x17:
    return 30; /*MTX_LOAD_4x3 - Load 4x3 Matrix to Current Matrix (W)*/
  case 0x18:
    return 35; /*MTX_MULT_4x4 - Multiply Current Matrix by 4x4 Matrix (W)*/
  case 0x19:
    return 31; /*MTX_MULT_4x3 - Multiply Current Matrix by 4x3 Matrix (W)*/
  case 0x1A:
    return 28; /*MTX_MULT_3x3 - Multiply Current Matrix by 3x3 Matrix (W)*/
  case 0x1B:
    return 22; /*MTX_SCALE - Multiply Current Matrix by Scale Matrix (W)*/
  case 0x1C:
    return 22; /*MTX_TRANS - Mult. Curr. Matrix by Translation Matrix (W)*/
  case 0x20:
    return 1; /*COLOR - Directly Set Vertex Color (W)*/
  case 0x21:
    return 9; /*NORMAL - Set Normal Vector (W)*/
  case 0x22:
    return 1; /*TEXCOORD - Set Texture Coordinates (W)*/
  case 0x23:
    return 9; /*VTX_16 - Set Vertex XYZ Coordinates (W)*/
  case 0x24:
    return 8; /*VTX_10 - Set Vertex XYZ Coordinates (W)*/
  case 0x25:
    return 8; /*VTX_XY - Set Vertex XY Coordinates (W)*/
  case 0x26:
    return 8; /*VTX_XZ - Set Vertex XZ Coordinates (W)*/
  case 0x27:
    return 8; /*VTX_YZ - Set Vertex YZ Coordinates (W)*/
  case 0x28:
    return 8; /*VTX_DIFF - Set Relative Vertex Coordinates (W)*/
  case 0x29:
    return 1; /*POLYGON_ATTR - Set Polygon Attributes (W)*/
  case 0x2A:
    return 1; /*TEXIMAGE_PARAM - Set Texture Parameters (W)*/
  case 0x2B:
    return 1; /*PLTT_BASE - Set Texture Palette Base Address (W)*/
  case 0x30:
    return 4; /*DIF_AMB - MaterialColor0 - Diffuse/Ambient Reflect. (W)*/
  case 0x31:
    return 4; /*SPE_EMI - MaterialColor1 - Specular Ref. & Emission (W)*/
  case 0x32:
    return 6; /*LIGHT_VECTOR - Set Light's Directional Vector (W)*/
  case 0x33:
    return 1; /*LIGHT_COLOR - Set Light Color (W)*/
  case 0x34:
    return 32; /*SHININESS - Specular Reflection Shininess Table (W)*/
  case 0x40:
    return 1; /*BEGIN_VTXS - Start of Vertex List (W)*/
  case 0x41:
    return 1; /*END_VTXS - End of Vertex List (W)*/
  case 0x50:
    return 392; /*SWAP_BUFFERS - Swap Rendering Engine Buffer (W)*/
  case 0x60:
    return 1; /*VIEWPORT - Set Viewport (W)*/
  case 0x70:
    return 103; /*BOX_TEST - Test if Cuboid Sits inside View Volume (W)*/
  case 0x71:
    return 9; /*POS_TEST - Set Position Coordinates for Test (W)*/
  case 0x72:
    return 5; /*VEC_TEST - Set Directional Vector for Test (W)*/
  }
  return 1;
}
...
static FORCE_INLINE void nds_gxfifo_push(nds_t *nds, uint8_t cmd,
                                         uint32_t data) {
...
static void nds_vertex_lighting(nds_t *nds, int16_t nxi, int16_t nyi,
                                int16_t nzi) {
  ...
  for (int i = 0; i < 4; ++i) {
    ...
    SE_RPT3 color[r] += ((float)gpu->curr_diffuse_color[r]) *
                        (float)gpu->light_color[i * 3 + r] * diffuse /
                        (255. * 255.);
    SE_RPT3 color[r] += (float)gpu->curr_specular_color[r] *
                        (float)gpu->light_color[i * 3 + r] * specular /
                        (255. * 255.);
    SE_RPT3 color[r] += (float)gpu->curr_ambient_color[r] *
                        (float)gpu->light_color[i * 3 + r] / (255. * 255.);
  }
  SE_RPT3 gpu->curr_color[r] = fmax(0.0, fmin(255.0, color[r] * 255));
}
static FORCE_INLINE void nds_tick_gx(nds_t *nds) {
  nds_gpu_t *gpu = &nds->gpu;
  if (gpu->cmd_busy_cycles > 0) {
    gpu->cmd_busy_cycles--;
    return;
  }
  if (gpu->pending_swap) {
    nds_gpu_swap_buffers(nds);
    gpu->pending_swap = false;
  }
  int sz = nds_gxfifo_size(nds);
  if (sz <= NDS_GX_DMA_THRESHOLD) {
    nds->activate_dmas |= nds->dma_wait_gx;
  }
  ...
  switch (irq_mode) {
  case 1:
    if (less_than_half_full)
      if9 |= (1 << NDS9_INT_GX_FIFO);
    break;
  case 2:
    if (empty)
      if9 |= (1 << NDS9_INT_GX_FIFO);
  ...
  if (gpu->box_test_result)
    gxstat |= (1 << 1); // Box test
  if (gpu->matrix_stack_error)
    gxstat |= 1 << 15;
  gxstat |= (sz & 0x1ff) << 16;
  if (less_than_half_full)
    gxstat |= 1 << 25; // Less than half full
  if (empty)
    gxstat |= 1 << 26; // Empty
  uint8_t cmd = gpu->fifo_cmd[gpu->fifo_read_ptr % NDS_GXFIFO_STORAGE];
  uint32_t cmd_params = nds_gpu_cmd_params(cmd);
  if (sz != 0 && sz >= cmd_params)
    gxstat |= 1 << 27; // is busy

  if (nds->gpu.test_busy > 0)
    gxstat |= 1 << 0;

  nds9_io_store32(nds, NDS9_GXSTAT, gxstat);
  if (sz < cmd_params || sz == 0)
    return;
  if (cmd_params < 1)
    cmd_params = 1;
  ...
  for (int i = 0; i < cmd_params; ++i)
    p[i] = gpu->fifo_data[(gpu->fifo_read_ptr++) % NDS_GXFIFO_STORAGE];
  /*
  ...
  if (SB_UNLIKELY(nds->gx_log && cmd)) {
    ...
    for (int i = 0; i < 16; ++i)
      fprintf(nds->gx_log, "%f ", gpu->proj_matrix[i]);
    fprintf(nds->gx_log, "\nmv: ");
    for (int i = 0; i < 16; ++i)
      fprintf(nds->gx_log, "%f ", gpu->mv_matrix[i]);
    fprintf(nds->gx_log, "\n");
  }
  ...
  case 0x0: /*NOP*/
    break;
  case 0x10: /*MTX_MODE*/
    nds->gpu.matrix_mode = SB_BFE(p[0], 0, 2);
    break;
  case 0x11: /*MTX_PUSH*/
  {
    ...
    case NDS_MATRIX_MV:
    case NDS_MATRIX_DIR:
      if (gpu->mv_matrix_stack_ptr > 31) {
        gpu->matrix_stack_error = true;
        gpu->mv_matrix_stack_ptr = 31;
      }
      for (int i = 0; i < 16; ++i) {
        gpu->mv_matrix_stack[gpu->mv_matrix_stack_ptr * 16 + i] =
            gpu->mv_matrix[i];
      }
      for (int i = 0; i < 16; ++i) {
        gpu->direction_matrix_stack[gpu->mv_matrix_stack_ptr * 16 + i] =
            gpu->direction_matrix[i];
      }
      gpu->mv_matrix_stack_ptr++;
      break;
    case NDS_MATRIX_TEX:
      if (gpu->tex_matrix_stack_ptr >= 1) {
        gpu->matrix_stack_error = true;
        gpu->tex_matrix_stack_ptr = 0;
      }
      for (int i = 0; i < 16; ++i) {
        gpu->tex_matrix_stack[i] = gpu->tex_matrix[i];
      }
      gpu->tex_matrix_stack_ptr++;
      break;
    case NDS_MATRIX_PROJ:
      if (gpu->proj_matrix_stack_ptr >= 1) {
        gpu->matrix_stack_error = true;
        gpu->proj_matrix_stack_ptr = 0;
      }
      for (int i = 0; i < 16; ++i) {
        gpu->proj_matrix_stack[i] = gpu->proj_matrix[i];
      }
  ...
  case 0x12: /*MTX_POP*/
  {
    ...
    case NDS_MATRIX_TEX:
      ...
      for (int i = 0; i < 16; ++i) {
        gpu->tex_matrix[i] = gpu->tex_matrix_stack[i];
      }
      break;
    case NDS_MATRIX_PROJ:
      gpu->proj_matrix_stack_ptr--;
      ...
      for (int i = 0; i < 16; ++i) {
        gpu->proj_matrix[i] = gpu->proj_matrix_stack[i];
      }
      break;
    }
    break;
  ...
  case 0x13: { /*MTX_STORE*/
    ...
    case NDS_MATRIX_DIR:
      for (int i = 0; i < 16; ++i)
        gpu->mv_matrix_stack[new_stack + i] = m[i];
      for (int i = 0; i < 16; ++i)
        gpu->direction_matrix_stack[new_stack + i] = gpu->direction_matrix[i];
      break;
    case NDS_MATRIX_TEX:
      for (int i = 0; i < 16; ++i)
        gpu->tex_matrix_stack[i] = m[i];
      break;
    case NDS_MATRIX_PROJ:
      for (int i = 0; i < 16; ++i)
        gpu->proj_matrix_stack[i] = m[i];
      break;
    }
    break;
  }
  case 0x14: { /*MTX_RESTORE*/
    ...
    case NDS_MATRIX_DIR:
      for (int i = 0; i < 16; ++i)
        m[i] = gpu->mv_matrix_stack[new_stack + i];
      for (int i = 0; i < 16; ++i)
        gpu->direction_matrix[i] = gpu->direction_matrix_stack[new_stack + i];
      break;
    case NDS_MATRIX_TEX:
      for (int i = 0; i < 16; ++i)
        m[i] = gpu->tex_matrix_stack[i];
      break;
    case NDS_MATRIX_PROJ:
      for (int i = 0; i < 16; ++i)
        m[i] = gpu->proj_matrix_stack[i];
      break;
    }
    break;
  }
  case 0x15: /*MTX_IDENTITY - Load Unit Matrix to Current Matrix (W)*/
    ...
    if (gpu->matrix_mode == NDS_MATRIX_DIR)
      nds_identity_matrix(gpu->direction_matrix);
    break;
  case 0x16: /*MTX_LOAD_4x4 - Load 4x4 Matrix to Current Matrix (W)*/
    for (int i = 0; i < 16; ++i)
      nds_gpu_get_active_matrix(nds)[i] = p[i] * fixed_to_float;
    if (gpu->matrix_mode == NDS_MATRIX_DIR) {
      for (int i = 0; i < 16; ++i)
        gpu->direction_matrix[i] = p[i] * fixed_to_float;
    }
    break;
  case 0x17: { /*MTX_LOAD_4x3 - Load 4x3 Matrix to Current Matrix (W)*/
    float m2[16] = {
        p[0] * fixed_to_float,  p[1] * fixed_to_float,
        p[2] * fixed_to_float,  0,
        p[3] * fixed_to_float,  p[4] * fixed_to_float,
        p[5] * fixed_to_float,  0,
        p[6] * fixed_to_float,  p[7] * fixed_to_float,
        p[8] * fixed_to_float,  0,
        p[9] * fixed_to_float,  p[10] * fixed_to_float,
        p[11] * fixed_to_float, 1.,
    };
    float *m = nds_gpu_get_active_matrix(nds);
    for (int i = 0; i < 16; ++i)
      m[i] = m2[i];
    if (gpu->matrix_mode == NDS_MATRIX_DIR) {
      for (int i = 0; i < 16; ++i)
        gpu->direction_matrix[i] = m2[i];
    }
    break;
  }
  case 0x18: { /*MTX_MULT_4x4 - Multiply Current Matrix by 4x4 Matrix (W)*/
    float m[16] = {
        p[0] * fixed_to_float,  p[1] * fixed_to_float,  p[2] * fixed_to_float,
        p[3] * fixed_to_float,  p[4] * fixed_to_float,  p[5] * fixed_to_float,
        p[6] * fixed_to_float,  p[7] * fixed_to_float,  p[8] * fixed_to_float,
        p[9] * fixed_to_float,  p[10] * fixed_to_float, p[11] * fixed_to_float,
        p[12] * fixed_to_float, p[13] * fixed_to_float, p[14] * fixed_to_float,
        p[15] * fixed_to_float};
  ...
  case 0x1c: /*MTX_TRAN*/
    if (nds->gpu.matrix_mode == NDS_MATRIX_DIR) {
      ...
      nds_translate_matrix(gpu->direction_matrix, p[0] * fixed_to_float,
                           p[1] * fixed_to_float, p[2] * fixed_to_float);
    }
  ...
  case 0x22: /*TEXCOORD*/
    ...
    break;
  case 0x23: /*VTX_16*/
    nds_gpu_process_vertex(nds, SB_BFE(p[0], 0, 16), SB_BFE(p[0], 16, 16),
                           SB_BFE(p[1], 0, 16));
    break;
  ...
  case 0x26: /*VTX_XZ*/
    nds_gpu_process_vertex(nds, SB_BFE(p[0], 0, 16),
                           nds->gpu.last_vertex_pos[1], SB_BFE(p[0], 16, 16));
    break;
  case 0x27: /*VTX_YZ*/
    nds_gpu_process_vertex(nds, nds->gpu.last_vertex_pos[0],
                           SB_BFE(p[0], 0, 16), SB_BFE(p[0], 16, 16));
    break;
  case 0x28: /*VTX_DIFF*/
    nds_gpu_process_vertex(nds,
                           (((int16_t)(SB_BFE(p[0], 0, 10) << 6)) >> 6) +
                               nds->gpu.last_vertex_pos[0],
                           (((int16_t)(SB_BFE(p[0], 10, 10) << 6)) >> 6) +
                               nds->gpu.last_vertex_pos[1],
                           (((int16_t)(SB_BFE(p[0], 20, 10) << 6)) >> 6) +
                               nds->gpu.last_vertex_pos[2]);
    break;

  case 0x29: /*POLYGON_ATTR*/
    nds->gpu.poly_attr = p[0];
    break;
  case 0x30: /*DIF_AMB - MaterialColor0 - Diffuse/Ambient Reflect. (W)*/
  {
    ...
    if (set_vertex_color)
      SE_RPT3 nds->gpu.curr_color[r] = nds->gpu.curr_diffuse_color[r];
  ...
  case 0x32: { /*LIGHT_VECTOR - Set Light Color (W)*/
    ...
    nds_mult_matrix_vector(nds->gpu.light_vector + light * 4,
                           gpu->direction_matrix, lv, 4);
  } break;
  ...
  case 0x2A:
    nds->gpu.tex_image_param = p[0];
    break; /*TEXIMAGE_PARAM  - Set Texture Parameters*/
  case 0x2B:
    nds->gpu.tex_plt_base = p[0];
    break; /*PLTT_BASE - Set Texture Palette Base Address (W)*/
  ...
  case 0x70: /*BOX_TEST*/ {
    ...
    for (int p = 0; p < 3; ++p) {
      for (int i = 4; i--;)
        planes[p * 2 * 4 + i] = m[i * 4 + 3] + m[i * 4 + p];
      for (int i = 4; i--;)
        planes[(p * 2 + 1) * 4 + i] = m[i * 4 + 3] - m[i * 4 + p];
    }
    ...
    for (int p = 0; p < 6; ++p) {
      ...
      if (nds_point_plane_distance(pos_vert, planes + p * 4) < 0.) {
        box_position = 1;
        break;
      } // outside
      if (nds_point_plane_distance(neg_vert, planes + p * 4) < 0.)
        box_position = 2; // collides
    }
...
static void nds_tick_ipc_fifo(nds_t *nds) {
  for (int cpu = 0; cpu < 2; ++cpu) {
    ...
    if (send_size == 1) {
      ...
      if (fifo_empty_irq) {
        if (cpu == NDS_ARM9)
          nds9_send_interrupt(nds, 4, 1 << NDS_INT_IPC_FIFO_SEND);
        else
          nds7_send_interrupt(nds, 4, 1 << NDS_INT_IPC_FIFO_SEND);
      }
    }
    if (recv_size != 0) {
      uint16_t cnt = nds_io_read16(nds, cpu, NDS_IPCFIFOCNT);
      ...
      if (fifo_not_empty_irq) {
        if (cpu == NDS_ARM9)
          nds9_send_interrupt(nds, 4, 1 << NDS_INT_IPC_FIFO_RECV);
        else
          nds7_send_interrupt(nds, 4, 1 << NDS_INT_IPC_FIFO_RECV);
      }
    }
  }
}
...
static bool nds_preprocess_mmio(nds_t *nds, uint32_t addr, uint32_t data,
  ...
  uint32_t baddr = addr;
  addr &= ~3;
  if (addr >= GBA_TM0CNT_L && addr <= GBA_TM3CNT_H)
  ...
  // if(addr>=0x4000620&&addr<0x04000800&&!(transaction_type&NDS_MEM_DEBUG))printf("MMIO
  // Read: %08x\n",addr);

  // Reading ClipMTX
  if (addr >= NDS9_CLIPMTX_RESULT && addr <= NDS9_CLIPMTX_RESULT + 0x40 &&
      cpu == NDS_ARM9) {
    float clipmtx[16];
    for (int i = 0; i < 16; ++i)
      clipmtx[i] = nds->gpu.mv_matrix[i];
  ...
  case NDS_IPCFIFOCNT: {
    ...
    bool recv_fifo_full = recv_size == 16;
    cnt &= 0xbc0c;
    cnt |= (send_fifo_empty << 0) | (send_fifo_full << 1) |
           (recv_fifo_empty << 8) | (recv_fifo_full << 9);
  ...
  case NDS9_RAM_COUNT:
    if (cpu != NDS_ARM9 || (transaction_type & NDS_MEM_DEBUG))
      return true;
  ...
  case NDS_GC_BUS:
    nds_process_gc_bus_read(nds, cpu);
    break;
  case NDS9_DIVCNT:
  case NDS9_DIV_RESULT:
  case NDS9_DIVREM_RESULT:
  case NDS9_DIV_RESULT + 4:
  case NDS9_DIVREM_RESULT + 4: {
    if (cpu != NDS_ARM9)
      return true;
  ...
  case NDS9_SQRTCNT:
  case NDS9_SQRT_RESULT:
  case NDS9_SQRT_RESULT + 4: {
    if (cpu != NDS_ARM9)
      return true;
    ...
    switch (mode) {
    case 0:
      result = nds_sqrt_u64((uint32_t)numer);
      break;
    case 1:
      result = nds_sqrt_u64(numer);
      break;
    }
    cnt &= 1;
    cnt |= (busy << 15);
...
static void nds_postprocess_mmio_write(nds_t *nds, uint32_t baddr,
                                       uint32_t data, int transaction_type) {
  uint32_t addr = baddr & ~3;
  uint32_t mmio = (transaction_type & NDS_MEM_ARM9) ? nds9_io_read32(nds, addr)
                                                    : nds7_io_read32(nds, addr);
  int cpu = (transaction_type & NDS_MEM_ARM9) ? NDS_ARM9 : NDS_ARM7;

  if (addr >= GBA_DMA0SAD && addr <= GBA_DMA3CNT_H)
    nds->activate_dmas = true;
  if (addr >= 0x4000440 && addr < 0x40005CC && cpu == NDS_ARM9) {
    nds_gxfifo_push(nds, (addr - 0x4000400) / 4,
                    nds_align_data(baddr, data, transaction_type));
  }
  if (addr >= 0x4000400 && addr < 0x4000440 && cpu == NDS_ARM9) {
    nds_gpu_write_packed_cmd(nds, mmio);
  }
  if (addr >= NDS9_VRAMCNT_A && addr <= NDS9_VRAMCNT_I)
    nds_update_vram_mapping(nds);
  switch (addr) {
  ...
  case NDS7_HALTCNT & ~3: {
    ...
    if (halt)
      nds->arm7.wait_for_interrupt = true;
  } break;
  case NDS_IPCSYNC: {
    ...
    if (send_irq && recv_interrupt) {
      if (cpu == NDS_ARM7)
        nds9_send_interrupt(nds, 4, 1 << NDS_INT_IPC_SYNC);
      else
        nds7_send_interrupt(nds, 4, 1 << NDS_INT_IPC_SYNC);
    }
    mmio &= 0x4f0f;
    nds_io_store32(nds, cpu, addr, mmio);
  } break;
  case NDS7_SPI_BUS_CTL: {
    ...
    if (nds_word_mask(baddr, transaction_type) & 0xff0000) {
      ...
      switch (device) {
      case NDS_SPI_POWER: /*TODO*/
        break;
      case NDS_SPI_TOUCH:
        data = nds_process_touch_ctrl_write(nds, cmd);
        break;
      case NDS_SPI_FIRMWARE:
        data = nds_process_flash_write(nds, cmd, &nds->firmware,
                                       nds->mem.firmware, NDS_FIRMWARE_SIZE);
        break;
      default:
        break;
      }
      ...
      if (!keep_selected)
        nds_deselect_spi(nds);
      if (irq_en)
        nds7_send_interrupt(nds, 4, 1 << NDS7_INT_SPI);
    }
  } break;
  case NDS7_RTC_BUS:
    if (cpu != NDS_ARM7)
  ...
  case NDS_IPCFIFOSEND: {
    ...
    int other_cnt = cpu == NDS_ARM7 ? nds9_io_read16(nds, NDS_IPCFIFOCNT)
                                    : nds7_io_read16(nds, NDS_IPCFIFOCNT);
  ...
  case NDS9_DIVCNT:
  case NDS9_DIV_DENOM:
  case NDS9_DIV_DENOM + 4:
  case NDS9_DIV_NUMER:
  case NDS9_DIV_NUMER + 4:
    if (cpu == NDS_ARM7)
      break;
  ...
  case NDS9_SQRTCNT:
  case NDS9_SQRT_PARAM:
  case NDS9_SQRT_PARAM + 4:
    if (cpu == NDS_ARM7)
      break;
  ...
  case NDS9_AUXSPICNT:
    if (nds_word_mask(baddr, transaction_type) & 0xff0000)
      nds_process_gc_spi(nds, cpu);
    break;
  case NDS_GCBUS_CTL | NDS_IO_MAP_SPLIT_OFFSET:
  case NDS_GCBUS_CTL:
    nds->activate_dmas = true;
    nds_process_gc_bus_ctl(nds, cpu);
    break;
  case GBA_TM0CNT_L:
  case GBA_TM1CNT_L:
  case GBA_TM2CNT_L:
  case GBA_TM3CNT_L:
    if (nds_word_mask(baddr, transaction_type) & 0xffff) {
      ...
      nds->timers[cpu][t].pending_reload_value =
          nds_io_read16(nds, cpu, GBA_TM0CNT_L + t * 4);
    }
    break;
  case NDS9_GXSTAT:
    if (cpu == NDS_ARM7)
...
static FORCE_INLINE int nds_ppu_compute_max_fast_forward(nds_t *nds) {
  ...
  if (scanline_clock >= NDS_LCD_W * NDS_CLOCKS_PER_DOT &&
      scanline_clock <= 355 * NDS_CLOCKS_PER_DOT)
    return 355 * NDS_CLOCKS_PER_DOT - scanline_clock - 1;
  // If inside hrender, can fastforward to hblank if not the first pixel and not
  // visible
  bool not_visible =
      nds->ppu[0].scan_clock > NDS_LCD_H * 355 * NDS_CLOCKS_PER_DOT ||
      NDS_SCANLINE_PPU;
  if (not_visible &&
      (scanline_clock >= 1 && scanline_clock <= NDS_LCD_W * NDS_CLOCKS_PER_DOT))
    return NDS_LCD_W * NDS_CLOCKS_PER_DOT - scanline_clock - 1;
  return (NDS_CLOCKS_PER_DOT - 1) -
         ((nds->ppu[0].scan_clock) % NDS_CLOCKS_PER_DOT);
}
static FORCE_INLINE void nds_tick_ppu(nds_t *nds, bool render) {
  if (SB_LIKELY(nds->ppu_fast_forward_ticks-- > 0))
    return;
  ...
  for (int ppu_id = 0; ppu_id < 2; ++ppu_id) {
    ...
    if (lcd_x == 0 || lcd_x == NDS_LCD_W) {
      ...
      if (hblank != ppu->last_hblank) {
        ...
        if (!hblank) {
          ...
          ppu->dispcnt_pipeline[2] =
              nds9_io_read16(nds, GBA_DISPCNT + reg_offset);
        } else {
          uint16_t dispcnt = ppu->dispcnt_pipeline[0];
          int bg_mode = SB_BFE(dispcnt, 0, 3);
          // From Mirei: Affine registers are only incremented when bg_mode is
          // not 0 and the bg is enabled.
          if (bg_mode != 0) {
            for (int aff = 0; aff < 2; ++aff) {
              ...
              int32_t d = (int16_t)nds9_io_read16(nds, GBA_BG2PD + (aff)*0x10 +
                                                           reg_offset);
              uint16_t bgcnt =
                  nds9_io_read16(nds, GBA_BG2CNT + aff * 2 + reg_offset);
      ...
      if (vblank != ppu->last_vblank) {
        ...
        if (vblank) {
          ...
          for (int aff = 0; aff < 2; ++aff) {
            ppu->aff[aff].internal_bgx =
                nds9_io_read32(nds, GBA_BG2X + (aff)*0x10 + reg_offset);
            ppu->aff[aff].internal_bgy =
                nds9_io_read32(nds, GBA_BG2Y + (aff)*0x10 + reg_offset);

            ppu->aff[aff].internal_bgx =
                SB_BFE(ppu->aff[aff].internal_bgx, 0, 28);
            ppu->aff[aff].internal_bgy =
                SB_BFE(ppu->aff[aff].internal_bgy, 0, 28);
    ...
    if (lcd_y < NDS_LCD_H && lcd_x == 0) {
      ...
      // Render sprites over scanline when it completes
      uint8_t default_window_control =
          0x3f; // bitfield [0-3:bg0-bg3 enable 4:obj enable, 5: special effect
                // enable]
      ...
      if (display_obj) {
        ...
        for (int o = 0; o < 128; ++o) {
          ...
          int obj_mode = SB_BFE(
              attr0, 10,
              2); //(0=Normal, 1=Semi-Transparent, 2=OBJ Window, 3=bitmap)
          bool mosaic = SB_BFE(attr0, 12, 1);
          bool colors_or_palettes = SB_BFE(attr0, 13, 1);
          int obj_shape = SB_BFE(
              attr0, 14, 2); //(0=Square,1=Horizontal,2=Vertical,3=Prohibited)
          ...
          // 2     32x32    32x16       16x32
          // 3     64x64    64x32       32x64
          const int xsize_lookup[16] = {8,  16, 8,  0, 16, 32, 8,  0,
                                        32, 32, 16, 0, 64, 64, 32, 0};
          const int ysize_lookup[16] = {8,  8,  16, 0, 16, 8,  32, 0,
                                        32, 16, 32, 0, 64, 32, 64, 0};
          ...
          if (((lcd_y - y_coord) & 0xff) < y_size * (double_size ? 2 : 1)) {
            ...
            uint16_t attr2 =
                *(uint16_t *)(nds->mem.oam + o * 8 + 4 + oam_offset);
            ...
            for (int x = x_start; x < x_end; ++x) {
              ...
              if (rot_scale) {
                ...
                int64_t x2 =
                    a * (x1 - objref_x) + b * (y1 - objref_y) + (x_size << 15);
                int64_t y2 =
                    c * (x1 - objref_x) + d * (y1 - objref_y) + (y_size << 15);
              ...
              if (obj_mode == 3) {
                ...
                int y_tile_stride =
                    obj_vram_map_2d ? 32
                                    : x_size / 8 * (colors_or_palettes ? 2 : 1);
                ...
                int tile = tile_base * tile_boundry / 32 +
                           (((sx / 8)) * (colors_or_palettes ? 2 : 1) +
                            (sy / 8) * y_tile_stride);
                // tile*=tile_boundry/32;
                uint16_t palette_id;
                bool use_obj_ext_palettes = SB_BFE(dispcnt, 31, 1);
                if (colors_or_palettes == false) {
                  palette_id = nds_ppu_read8(nds, obj_vram_base + tile * 32 +
                                                      tx / 2 + ty * 4);
                  palette_id = (palette_id >> ((tx & 1) * 4)) & 0xf;
                  if (palette_id == 0)
                    continue;
                  palette_id += palette * 16;
                  use_obj_ext_palettes = false; // Not supported in 16 color
                                                // mode
                } else {
                  palette_id = nds_ppu_read8(nds, obj_vram_base + tile * 32 +
                                                      tx + ty * 8);
                ...
                if (use_obj_ext_palettes) {
                  ...
                  uint32_t read_addr =
                      (ppu_id ? NDS_VRAM_OBJB_SLOT0 : NDS_VRAM_OBJA_SLOT0) +
                      palette_id * 2;
                  col = nds_ppu_read16(nds, read_addr);
                } else {
                  uint32_t pallete_offset = ppu_id ? 0x600 : 0x200;
                  col = *(uint16_t *)(nds->mem.palette + pallete_offset +
                                      palette_id * 2);
                }
              }

              // Handle window objects(not displayed but control the windowing
              // of other things)
              if (obj_mode == 2) {
                ppu->window[x] = obj_window_control;
              } else {
                int type = 4;
                col =
                    col | (type << 17) | ((5 - priority) << 28) | ((0x7) << 25);
                if (obj_mode == 1)
                  col |= 1 << 16;
                if ((col >> 17) > (ppu->first_target_buffer[x] >> 17))
                  ppu->first_target_buffer[x] = col;
              }
            }
          }
        }
      ...
      int enabled_windows =
          SB_BFE(dispcnt, 13, 3); // [0: win0, 1:win1, 2: objwin]
      if (enabled_windows) {
        for (int win = 1; win >= 0; --win) {
          ...
          if (win_ymin > win_ymax)
            win_ymax = NDS_LCD_H + 1;
          if (win_xmax > NDS_LCD_W)
            win_xmax = NDS_LCD_W;
          if (lcd_y < win_ymin || lcd_y >= win_ymax)
            continue;
        ...
        int backdrop_type = 5;
        uint32_t backdrop_col =
            (*(uint16_t *)(nds->mem.palette + GBA_BG_PALETTE + 0 * 2 +
                           ppu_id * 1024)) |
            (backdrop_type << 17);
        for (int x = 0; x < NDS_LCD_W; ++x) {
          uint8_t window_control = ppu->window[x];
          if (SB_BFE(window_control, 4, 1) == 0)
            ppu->first_target_buffer[x] = backdrop_col;
        }
      }
    }
    if (visible) {
...
#define NDS_BG_INVALID 4
              ...
              if (SB_UNLIKELY(enable_3d && bg == 0)) {
                ...
                if (SB_BFE(nds->framebuffer_3d_disp[p * 4 + 3], 3, 5) == 0)
                  continue;
              } else {
                bool bitmap_mode =
                    SB_BFE(bgcnt, 7, 1) && (bg_type == NDS_BG_BITMAP ||
                                            bg_type == NDS_BG_LARGE_BITMAP);
                bool extended_bgmap =
                    !SB_BFE(bgcnt, 7, 1) && (bg_type == NDS_BG_BITMAP ||
                                             bg_type == NDS_BG_LARGE_BITMAP);
                // NDS can have an affine "bitmap" that is really a large affine
                // tile map
                uint32_t bg_type_for_size =
                    (bg_type == 2 && !bitmap_mode) ? 1 : bg_type;
                int screen_size_x =
                    bg_size_table[(bg_type_for_size * 4 + screen_size) * 2 + 0];
                int screen_size_y =
                    bg_size_table[(bg_type_for_size * 4 + screen_size) * 2 + 1];
                ...
                if (rot_scale) {
                  ...
                  int32_t a = (int16_t)nds9_io_read16(
                      nds, GBA_BG2PA + (bg - 2) * 0x10 + reg_offset);
                  int32_t c = (int16_t)nds9_io_read16(
                      nds, GBA_BG2PC + (bg - 2) * 0x10 + reg_offset);
                  ...
                  if (mosaic) {
                    int16_t mos_reg =
                        nds9_io_read16(nds, GBA_MOSAIC + reg_offset);
                  ...
                  if (display_overflow == 0) {
                    if (bg_x < 0 || bg_x >= screen_size_x || bg_y < 0 ||
                        bg_y >= screen_size_y)
                      continue;
                  } else {
                    bg_x %= screen_size_x;
                  ...
                  int16_t hoff = SB_BFE(
                      nds9_io_read16(nds, GBA_BG0HOFS + bg * 4 + reg_offset), 0,
                      9);
                  int16_t voff = SB_BFE(
                      nds9_io_read16(nds, GBA_BG0VOFS + bg * 4 + reg_offset), 0,
                      9);
                  hoff = (hoff << 7) >> 7;
                  voff = (voff << 7) >> 7;
                  bg_x = (hoff + lcd_x);
                ...
                if (bitmap_mode) {
                  ...
                  if (bitmap_mode) {
                    ...
                    if (direct_color) {
                      col = nds_ppu_read16(nds,
                                           bg_base + screen_base_addr + p * 2);
                      if (!SB_BFE(col, 15, 1))
                        continue;
                    } else {
                      int pallete_id =
                          nds_ppu_read8(nds, bg_base + screen_base_addr + p);
                      if (pallete_id == 0)
                        continue;
                      col = *(uint16_t *)(nds->mem.palette + pallete_offset +
                                          pallete_id * 2);
                    ...
                    col =
                        nds_ppu_read16(nds, bg_base + screen_base_addr + p * 2);
                  }
                } else {
                  ...
                  if (extended_bgmap) {
                    tile_data = nds_ppu_read16(nds, bg_base + screen_base_addr +
                                                        tile_off * 2);
                    ...
                    tile_data = nds_ppu_read8(nds, bg_base + screen_base_addr +
                                                       tile_off);
                  ...
                  if (colors == false) {
                    tile_d = nds_ppu_read8(nds, bg_base + character_base_addr +
                                                    tile_id * 8 * 4 + px / 2 +
                                                    py * 4);
                    ...
                    tile_d =
                        nds_ppu_read8(nds, bg_base + character_base_addr +
                                               tile_id * 8 * 8 + px + py * 8);
                    if (tile_d == 0)
                      continue;
                  }
                  ...
                  if (use_ext_palettes) {
                    ...
                    if (bg < 2)
                      ext_palette_slot += SB_BFE(bgcnt, 13, 1) * 2;
                    uint32_t read_addr =
                        (ppu_id ? NDS_VRAM_BGB_SLOT0 : NDS_VRAM_BGA_SLOT0) +
                        palette_id * 2 + 0x2000 * (ext_palette_slot);
                    col = nds_ppu_read16(nds, read_addr);
                  } else
                    col = *(uint16_t *)(nds->mem.palette + pallete_offset +
                                        palette_id * 2);
              ...
              if (col > ppu->second_target_buffer[lcd_x])
                ppu->second_target_buffer[lcd_x] = col;
            }
          }
          ...
          if (effect_enable) {
            ...
            case 1: {
              ...
              if (blend) {
                uint16_t bldalpha =
                    nds9_io_read16(nds, GBA_BLDALPHA + reg_offset);
                ...
                if (enable_3d && type == 0) {
                  eva =
                      nds->framebuffer_3d_disp[(lcd_x + lcd_y * NDS_LCD_W) * 4 +
                                               3] /
                      16;
                  if (eva == 15)
                    eva = 16;
          ...
          if (display_mode == 2 && ppu_id == 0) {
            ...
            uint16_t value =
                ((uint16_t *)nds->mem
                     .vram)[lcd_x + lcd_y * NDS_LCD_W + vram_block * 64 * 1024];
            r = SB_BFE(value, 0, 5);
            g = SB_BFE(value, 5, 5);
            b = SB_BFE(value, 10, 5);
          ...
          if (enable_capture) {
            ...
            if (lcd_x < szx && lcd_y < szy) {
              uint16_t color = (((uint16_t)r & 0x1f)) |
                               (((uint16_t)g & 0x1f) << 5) |
                               (((uint16_t)b & 0x1f) << 10);
              ...
              if (source_a && lcd_x < NDS_LCD_W && lcd_y < NDS_LCD_H) {
                ...
                color |= SB_BFE(nds->framebuffer_3d_disp[p * 4 + 2], 3, 5)
                         << 10;
              }
              ...
              if (capture_mode >= 2) {
                ...
                if (display_mode == 2)
                  color2 = ppu->first_target_buffer[lcd_x];
          ...
          int disp_b = b;
          {
            uint16_t master_brightness = nds9_io_read16(
                nds, ppu_id == 0 ? NDS_A_MASTER_BRIGHT : NDS9_B_MASTER_BRIGHT);
          ...
          if (screen_blend_factor > 1.0)
            screen_blend_factor = 1;
          if (screen_blend_factor < 0.0)
            screen_blend_factor = 0;

          uint8_t *framebuffer = (ppu_id == 0) ^ nds->display_flip
                                     ? nds->framebuffer_bottom
                                     : nds->framebuffer_top;
          framebuffer[p + 0] = disp_r * 7 * screen_blend_factor +
                               framebuffer[p + 0] * (1.0 - screen_blend_factor);
          framebuffer[p + 1] = disp_g * 7 * screen_blend_factor +
                               framebuffer[p + 1] * (1.0 - screen_blend_factor);
          framebuffer[p + 2] = disp_b * 7 * screen_blend_factor +
                               framebuffer[p + 2] * (1.0 - screen_blend_factor);
          int backdrop_type = 5;
          uint32_t backdrop_col =
              (*(uint16_t *)(nds->mem.palette + GBA_BG_PALETTE + 0 * 2 +
                             ppu_id * 1024)) |
...
static void nds_tick_keypad(sb_joy_t *joy, nds_t *nds) {
  for (int cpu = 0; cpu < 2; ++cpu) {
    ...
    if (joy) {
      ...
      reg_value = nds_io_read16(nds, cpu, GBA_KEYINPUT);
    ...
    if (irq_enable) {
      ...
      if (if_bit && !nds->prev_key_interrupt) {
        if (cpu)
          ...
          nds7_send_interrupt(nds, 4, if_bit);
        nds->prev_key_interrupt = true;
      } else
        nds->prev_key_interrupt = false;
    }
  }
  uint16_t ext_key = 0;
  if (joy) {
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      if (enable) {
        ...
        if (!nds->dma[cpu][i].last_enable) {
          ...
          nds->dma[cpu][i].source_addr =
              nds_io_read32(nds, cpu, GBA_DMA0SAD + 12 * i);
          nds->dma[cpu][i].dest_addr =
              nds_io_read32(nds, cpu, GBA_DMA0DAD + 12 * i);
        ...
        int dst_addr_ctl =
            SB_BFE(cnt_h, 5, 2); // 0: incr 1: decr 2: fixed 3: incr reload
        int src_addr_ctl =
            SB_BFE(cnt_h, 7, 2); // 0: incr 1: decr 2: fixed 3: not allowed
        bool dma_repeat = SB_BFE(cnt_h, 9, 1);
        int mode = nds->dma[cpu][i].trigger_mode;
        if (cpu == NDS_ARM7)
          mode = SB_BFE(cnt_h, 12, 2);
        ...
        if (nds->dma[cpu][i].current_transaction == 0) {
          ...
          if (mode == 2) {
            ...
            if (vcount >= NDS_LCD_H || !nds->ppu[0].last_hblank || last_hblank)
              continue;
          }
          // Video dma
          if ((mode == 3) && cpu == NDS_ARM9) {
            nds->dma_wait_ppu = true;
            uint16_t vcount = nds_io_read16(nds, cpu, GBA_VCOUNT);
            if (!nds->ppu[0].last_hblank || last_hblank)
              continue;
            // Video dma starts at scanline 2
            if (vcount < 2)
              continue;
            if (vcount == NDS_LCD_H + 1)
              dma_repeat = false;
          }
          // GC Card DMA
          if ((mode == 5 && cpu == NDS_ARM9) ||
              (mode == 2 && cpu == NDS_ARM7)) {
            uint32_t ctl = nds_io_read32(nds, cpu, NDS_GCBUS_CTL);
            uint32_t ready_mask =
                (1u << 31) | (1 << 23); // Block Status = Word Status = 1;
            if ((ctl & ready_mask) != ready_mask)
              continue;
          }
          if (dst_addr_ctl == 3) {
            nds->dma[cpu][i].dest_addr =
          ...
          if (nds->dma[cpu][i].source_addr >= 0x08000000 &&
              nds->dma[cpu][i].dest_addr >= 0x08000000) {
          ...
          if (cpu == NDS_ARM7) {
            static const uint32_t src_mask[] = {0x07FFFFFF, 0x0FFFFFFF,
                                                0x0FFFFFFF, 0x0FFFFFFF};
            static const uint32_t dst_mask[] = {0x07FFFFFF, 0x07FFFFFF,
                                                0x07FFFFFF, 0x0FFFFFFF};
            static const uint32_t len_mask[] = {0x3FFF, 0x3FFF, 0x3FFF,
                                                0x1FFFFF};
            ...
            static const uint32_t src_mask[] = {0x0FFFFFFF, 0x0FFFFFFF,
                                                0x0FFFFFFF, 0x0FFFFFFF};
            static const uint32_t dst_mask[] = {0x0FFFFFFF, 0x0FFFFFFF,
                                                0x0FFFFFFF, 0x0FFFFFFF};
            nds->dma[cpu][i].source_addr &= src_mask[i];
            nds->dma[cpu][i].dest_addr &= dst_mask[i];
            cnt &= 0x1FFFFF;
          ...
          if (nds->dma_log)
            fprintf(nds->dma_log,
                    "DMA[%d][%d]: Src: 0x%08x DST: 0x%08x Cnt:%d mode: %d\n",
                    cpu, i, nds->dma[cpu][i].source_addr,
                    nds->dma[cpu][i].dest_addr, cnt, mode);
          // printf("DMA[%d][%d]: Src: 0x%08x DST: 0x%08x Cnt:%d mode:
        ...
        if (!skip_dma) {
          // This code is complicated to handle the per channel DMA latches that
          // are present Correct implementation is needed to pass latch.gba,
          // Pokemon Pinball (intro explosion), and the text in Lufia
          // TODO: There in theory should be separate latches per DMA, but that
          // breaks Hello Kitty and Tomb Raider
              ...
              if (src_addr >= 0x02000000) {
                if (cpu == NDS_ARM7)
                  nds->dma[cpu][i].latched_transfer =
                      nds7_read32(nds, src_addr);
                else
                  nds->dma[cpu][i].latched_transfer =
                      nds9_read32(nds, src_addr);
              }
              if (cpu == NDS_ARM7)
                nds7_write32(nds, dst_addr, nds->dma[cpu][i].latched_transfer);
              else
                nds9_write32(nds, dst_addr, nds->dma[cpu][i].latched_transfer);
            } else {
              int v = 0;
              if (src_addr >= 0x02000000) {
                if (cpu == NDS_ARM7)
                  v = nds->dma[cpu][i].latched_transfer =
                      nds7_read16(nds, src_addr) & 0xffff;
                else
                  v = nds->dma[cpu][i].latched_transfer =
                      nds9_read16(nds, src_addr) & 0xffff;
                nds->dma[cpu][i].latched_transfer |=
                    nds->dma[cpu][i].latched_transfer << 16;
              } else
                v = nds->dma[cpu][i].latched_transfer >> (((dst_addr)&0x3) * 8);
              if (cpu == NDS_ARM7)
                nds7_write16(nds, dst_addr, nds->dma[cpu][i].latched_transfer);
              else
                nds9_write16(nds, dst_addr, nds->dma[cpu][i].latched_transfer);
            }
          }
        }
...
static FORCE_INLINE void nds_tick_timers(nds_t *nds) {
  if (nds->current_clock >= nds->next_timer_clock)
    nds_compute_timers(nds);
}
static void nds_compute_timers(nds_t *nds) {
    ...
    for (int t = 0; t < 4; ++t) {
      ...
      if (enable) {
        ...
        if (timer->startup_delay >= 0) {
          ...
          if (timer->startup_delay >= 0) {
            if (timer->startup_delay < timer_ticks_before_event && irq_en)
              timer_ticks_before_event = timer->startup_delay;
            continue;
          }
        ...
        if (count_up) {
          ...
          if (ticks_before_overflow < timer_ticks_before_event && irq_en)
...
static FORCE_INLINE float nds_compute_vol_env_slope(int length_of_step,
                                                    int dir) {
...
static FORCE_INLINE float nds_bandlimited_square(float t, float duty_cycle,
                                                 float dt) {
...
static FORCE_INLINE void nds_tick_audio(nds_t *nds, sb_emu_state_t *emu,
  ...
  while (audio->current_sample_generated_time < audio->current_sim_time) {
    ...
    for (int c = 0; c < 16; ++c) {
      ...
      int format =
          SB_BFE(cnt, 29, 2); //(0=PCM8, 1=PCM16, 2=IMA-ADPCM, 3=PSG/Noise);
      if (!enable) {
        audio->channel[c].sample = 0;
        audio->channel[c].lfsr = 0x7FFF;
        audio->channel[c].timer = tmr;
        emu->audio_channel_output[c] =
            emu->audio_channel_output[c] * lowpass_coef;
        continue;
      }
      ...
      if (enable) {
        ...
        switch (format) {
        case 0:
          v = ((int8_t)nds7_read8(nds, sad + audio->channel[c].sample)) / 128.;
          break;
        case 1:
          v = ((int16_t)nds7_read16(nds, sad + audio->channel[c].sample * 2)) /
              32768.;
          break;
        case 2:
          v = ((int16_t)audio->channel[c].adpcm_sample) / 32768.0;
          break;
        case 3:
          if (c >= 8 && c <= 13)
            v = (audio->channel[c].sample < SB_BFE(cnt, 24, 3)) * 2. -
                1.;                      // Todo: add antialiasing
      ...
      while (audio->channel[c].timer > 0x1ffff) {
        ...
        if (audio->channel[c].sample + 1 >= tot_samps) {
          ...
          case 0:
            audio->channel[c].sample = 0;
            enable = false;
            break; // Manual (TODO: Does this repeat?)
          case 1:
            audio->channel[c].sample = pnt;
            if (format == 2) { // ADPCM
              audio->channel[c].adpcm_sample =
                  audio->channel[c].adpcm_sample_latch;
              audio->channel[c].adpcm_index =
                  audio->channel[c].adpcm_index_latch;
            }
            break; // Infinite
          case 2:
            audio->channel[c].sample = 0;
        ...
        if (format == 2) {
          ...
          if (audio->channel[c].sample == 0) {
            ...
            if (audio->channel[c].adpcm_index > 88)
              audio->channel[c].adpcm_index = 88;
          }
          uint8_t data =
              nds7_read8(nds, sad + audio->channel[c].sample / 2 + 4);
          ...
          if (data & 8)
            audio->channel[c].adpcm_sample =
                audio->channel[c].adpcm_sample - diff;
          else
            audio->channel[c].adpcm_sample =
                audio->channel[c].adpcm_sample + diff;
          ...
          if (audio->channel[c].adpcm_sample < -0x7FFF)
            audio->channel[c].adpcm_sample = -0x7fff;
          int new_index =
              audio->channel[c].adpcm_index + adpcm_indextable[data & 7];
          if (new_index > 88)
            new_index = 88;
          if (new_index < 0)
            new_index = 0;
    ...
    if ((sb_ring_buffer_size(&emu->audio_ring_buff) + 3 >
         SB_AUDIO_RING_BUFFER_SIZE))
      continue;
    // Quantization
    unsigned write_entry0 =
        (emu->audio_ring_buff.write_ptr++) % SB_AUDIO_RING_BUFFER_SIZE;
    unsigned write_entry1 =
        (emu->audio_ring_buff.write_ptr++) % SB_AUDIO_RING_BUFFER_SIZE;

    emu->mix_l_volume =
        emu->mix_l_volume * lowpass_coef + fabs(l) * (1.0 - lowpass_coef);
    emu->mix_r_volume =
        emu->mix_r_volume * lowpass_coef + fabs(r) * (1.0 - lowpass_coef);
...
void nds_tick(sb_emu_state_t *emu, nds_t *nds, nds_scratch_t *scratch) {
  ...
  nds->arm9.coprocessor_read = nds->arm7.coprocessor_read =
      nds_coprocessor_read;
  nds->arm9.coprocessor_write = nds->arm7.coprocessor_write =
      nds_coprocessor_write;
  ...
  while (!nds->ppu[0].new_frame) {
    ...
    if (!gx_fifo_full) {
      ...
      if (SB_LIKELY(!nds->dma_processed[0] && !nds->mem.slow_bus_cycles)) {
        ...
        if (int7_if) {
          ...
          int7_if &= ie;
          if ((ime & 0x1) && int7_if)
            arm7_process_interrupts(&nds->arm7, int7_if);
        }
        if (SB_UNLIKELY(nds->arm7.registers[PC] == emu->pc_breakpoint))
          nds->arm7.trigger_breakpoint = true;
        else
      ...
      if (SB_LIKELY(!nds->dma_processed[1])) {
        ...
        if (int9_if) {
          ...
          if ((ime & 0x1) && int9_if)
            arm7_process_interrupts(&nds->arm9, int9_if);
        }
        if (SB_LIKELY(!nds->arm9.wait_for_interrupt)) {
          if (SB_UNLIKELY(nds->arm9.registers[PC] == emu->pc_breakpoint))
            nds->arm9.trigger_breakpoint = true;
          else {
            nds->arm9.i_cycles = 0;
            arm9_exec_instruction(&nds->arm9);
            if (SB_UNLIKELY(nds->arm9.registers[PC] == emu->pc_breakpoint))
              nds->arm9.trigger_breakpoint = true;
            else if (!nds->arm9.i_cycles)
              arm9_exec_instruction(&nds->arm9);
            nds->mem.slow_bus_cycles += nds->arm9.i_cycles / 2;
          }
        }
      }
      if (SB_UNLIKELY(nds->arm7.trigger_breakpoint ||
                      nds->arm9.trigger_breakpoint)) {
    ...
    while (ticks) {
      ...
      if (nds->gpu.cmd_busy_cycles &&
          nds->gpu.cmd_busy_cycles <= ppu_fast_forward)
        ppu_fast_forward = nds->gpu.cmd_busy_cycles;
      int timer_fast_forward = nds->next_timer_clock - nds->current_clock;
      int fast_forward_ticks = ppu_fast_forward < timer_fast_forward
                                   ? ppu_fast_forward
                                   : timer_fast_forward;
      if (SB_LIKELY(fast_forward_ticks)) {
        if (SB_LIKELY(!(nds->arm9.wait_for_interrupt &&
                        nds->arm7.wait_for_interrupt) &&
...
// See:
// http://merry.usamimi.org/archex/SysReg_v84A_xml-00bet7/enc_index.xml#mcr_mrc_32
uint32_t nds_coprocessor_read(void *user_data, int coproc, int opcode, int Cn,
                              int Cm, int Cp) {
  if (coproc != 15) {
  ...
  if (opcode != 0)
    printf("Unsupported opcode(%x) for coproc %d\n", opcode, coproc);
...
void nds_coprocessor_write(void *user_data, int coproc, int opcode, int Cn,
  ...
  if (Cn == 1 && Cm == 0) {
    ...
    if (Cp == 0) {
      ...
      printf("ITCM Start:0x%08x End: 0x%08x\n", nds->mem.itcm_start_address,
             nds->mem.itcm_end_address);
    }
  } else if (Cn == 7) {
    int size = SB_BFE(data, 1, 5);
    int base = SB_BFE(data, 12, 20);
...
static bool nds_run_ar_cheat(nds_t *nds, const uint32_t *buffer,
                             uint32_t size) {
  if (!buffer) {
  ...
  for (int i = 0; i < size; i += 2) {
    ...
    // check if we're in an if that has evaluated to false, and the current
    // instruction isn't an "End-if" or an "End-code"
    if (!if_stack[if_stack_index] && current_byte != 0xD0 &&
        current_byte != 0xD2) {
    ...
    case 0x5: {
      ...
      // If the value at (XXXXXXX or ‘offset’ when address is 0) == YYYYYYYY
      // then execute the following block of instructions
      uint32_t address = buffer[i] & 0x0fffffff;
      uint32_t data = buffer[i + 1];
      if (address == 0)
        address = offset_register;
    ...
    case 0xD: {
      ...
      case 0xD1: {
        ...
        // Also implicitly ends any conditional instructions inside the repeat
        // block
        if (repeat_count > 0) {
          repeat_count--;
    ...
    case 0xF: {
      ...
      // Copies NNNNNNNN bytes from addresses starting at the ‘offset’ register
      // to addresses starting at XXXXXXXX
      uint32_t address = buffer[i] & 0x0fffffff;
      uint32_t count = buffer[i + 1];
