...
static char* zh_localization_array[]={
    ...
    "Load ROM from file (%s)", "从文件中载入 ROM (%s)",
    "You can also drag & drop a ROM to load it", "你也可以通过拖放载入一个 ROM",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "从文件中载入 ROM(%s), save(.sav), 或 GBA bios (gba_bios.bin)",
    ...
    "Bilinear", "双线性",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & 子像素",
    "Smooth Upscale (xBRZ)", "高级平滑过滤 (xBRZ)",
...
static char* hy_localization_array[]={
    ...
    "Load ROM from file (%s)", "Տեղադրեք ROM-ը (%s)",
    "You can also drag & drop a ROM to load it", "Կարող եք նաև քաշել և թողնել որևէ ROM՝ այն տեղադրելու համար",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Տեղադրելու ROM (%s), պահվածկ (.sav) կամ «GBA BIOS» (gba_bios.bin)",
    ...
    "Bilinear", "Երկգծային",
    "LCD", "«LCD»",
    "LCD & Subpixels", "«LCD» և ենթակետներ",
    "Smooth Upscale (xBRZ)", "Հարթ Բարձրակարգ (xBRZ)",
    "Screen Rotation", "Էկրանաին Ռոտացիա",
    "0 degrees", "0 աստիճան",
    "90 degrees", "90 աստիճան",
    "180 degrees", "180 աստիճան",
    "270 degrees", "270 աստիճան",
...
static char* gr_localization_array[]={
    ...
    "Load ROM from file (%s)", "Φόρτωση ROM από αρχείο (%s)",
    "You can also drag & drop a ROM to load it", "Μπορείς επίσης να σύρεις ένα ROM για να το φορτώσεις",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Φόρτωση ROM (%s), αρχείο αποθήκευσης (.sav), ή «GBA bios» (gba_bios.bin)",
    ...
    "Bilinear", "Διγραμμικό",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & Υποπίξελ",
    "Smooth Upscale (xBRZ)", "Ομαλό Upscale (xBRZ)",
    "Screen Rotation", "Περιστροφή Οθόνης",
    "0 degrees", "0 μοίρες",
    "90 degrees", "90 μοίρες",
    "180 degrees", "180 μοίρες",
    "270 degrees", "270 μοίρες",
...
static char* nl_localization_array[]={
    ...
    "Load ROM from file (%s)", "Laad ROM uit bestand (%s)",
    "You can also drag & drop a ROM to load it", "Je kan ook een bestand slepen en neerzetten om het te laden",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Laad ROM (%s), save (.sav) of GBA BIOS (gba_bios.bin)",
    ...
    "Bilinear", "Bilineair",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & Subpixels",
    "Smooth Upscale (xBRZ)", "Gladde Opschaling (xBRZ)",
    "Screen Rotation", "Scherm Rotatie",
    "0 degrees", "0 graden",
    "90 degrees", "90 graden",
    "180 degrees", "180 graden",
    "270 degrees", "270 graden",
...
static char* da_localization_array[]={
    ...
    "Load ROM from file (%s)", "Åbn ROM fra fil (%s)",
    "You can also drag & drop a ROM to load it", "Du kan også trække og slippe et ROM for at åbne det",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Åbn ROM(%s), gemt spil(.sav), eller GBA-bios (gba_bios.bin) fra fil",
    ...
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & subpixels",
    "Smooth Upscale (xBRZ)", "Jævn opskalering (xBRZ)",
    ...
    "Vertical", "Lodret",
    "Horizontal", "Vandret",
    "Hybrid Large Top", "Hybrid: øverst stor",
    "Hybrid Large Bottom", "Hybrid: nederst stor",
    "Vertical Large Top", "Lodret: øverst stor",
    "Vertical Large Bottom", "Lodret: nederst stor",
    "Horizontal Large Top", "Vandret: øverst stor",
    "Horizontal Large Bottom", "Vandret: nederst stor",
...
static char* fr_localization_array[]={
    ...
    "Load ROM from file (%s)", "Charger la ROM depuis un fichier (%s)",
    "You can also a ROM to load it", "Vous pouvez aussi glisser et déposer une ROM pour la charger",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Charger une ROM(%s), sauvegarde(.sav), ou bios GBA (gba_bios.bin) depuis un fichier",
    ...
    "Bilinear", "Bilinéaire",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & Sous-pixels",
    "Smooth Upscale (xBRZ)", "Amélioration Lisse (xBRZ)",
...
static char* de_localization_array[]={
    ...
    "Key %d", "Taste %d",
    "Analog %d (%0.2f)", "Analog %d (%0.2f)",
    "Load ROM from file (%s)", "Lade ROM von Datei (%s)",
    "You can also drag & drop a ROM to load it", "Du kannst ein ROM auch durch Ziehen und Ablegen laden",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Lade ROM (%s), Save (.sav) oder GBA-BIOS (gba_bios.bin)",
    ...
    "Bilinear", "Bilinear",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD und Subpixel",
    "Smooth Upscale (xBRZ)", "Weiche Hochskalierung (xBRZ)",
...
static char* it_localization_array[]={
  ...
  "Load ROM from file (%s)", "Carica ROM da file (%s)",
  "You can also drag & drop a ROM to load it", "Puoi anche trascinare una ROM per caricarla",
  "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Carica una ROM(%s), salvataggio(.sav), o bios GBA (gba_bios.bin) da file",
  ...
  "LCD", "LCD",
  "LCD & Subpixels", "LCD & Subpixels",
  "Smooth Upscale (xBRZ)", "Upscaling Liscio (xBRZ)",
...
static char* ru_localization_array[]={
  ...
  "Load ROM from file (%s)", "Загрузить ROM из файла (%s)",
  "You can also drag & drop a ROM to load it", "Вы также можете перетащить ROM и загрузить его",
  "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Загрузить ROM(%s), сохраненный файл(.sav), или биос GBA (gba_bios.bin) из файла",
  ...
  "Bilinear", "Билинейный",
  "LCD", "LCD",
  "LCD & Subpixels", "LCD & субпиксель",
  "Smooth Upscale (xBRZ)", "Плавно увеличиват разрешение (xBRZ)",
...
static char* pl_localization_array[]={
    ...
    "Key %d", "Klawisz %d",
    "Analog %d (%0.2f)", "Analog %d (%0.2f)",
    "Load ROM from file (%s)", "Otwórz ROM (%s)",
    "You can also drag & drop a ROM to load it", "Możesz też przeciągnąć i upuśćić plik ROM aby go otworzyć",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Otwórz ROM (%s), zapis gry (.sav) lub BIOS GBA (gba_bios.bin)",
    ...
    "Bilinear", "Bilinear",
    "LCD", "Ekran LCD",
    "LCD & Subpixels", "Ekran LCD i subpiksele",
    "Smooth Upscale (xBRZ)", "Płynne skalowanie (xBRZ)",
    "Screen Rotation", "Obrót ekranu",
    "0 degrees", "0 stopni",
    "90 degrees", "90 stopni",
    "180 degrees", "180 stopni",
    "270 degrees", "270 stopni",
...
static char* sw_localization_array[]={
    ...
    "Key %d", "Nyckel %d",
    "Analog %d (%0.2f)", "Analog %d (%0.2f)",
    "Load ROM from file (%s)", "Öppna ROM från fil (%s)",
    "You can also drag & drop a ROM to load it", "Du kan även dra och släppa en ROM fil för at öppna den",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Öppna ROM(%s), Sparfil(.sav), eller GBA bios(gba_bios.bin)",
    ...
    "Bilinear", "Bilinjär",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & Subpixlar",
    "Smooth Upscale (xBRZ)", "Smidig Uppskalning (xBRZ)",
    "Screen Rotation", "Skärm Rotation",
    "0 degrees", "0 grader",
    "90 degrees", "90 grader",
    "180 degrees", "180 grader",
    "270 degrees", "270 grader0",
...
static char* tr_localization_array[]={
    ICON_FK_FILE_O " Load Game", ICON_FK_FILE_O " Oyun Yükle",
    "Up", "Yukarı",
    "Down", "Aşağı",
    "Left", "Sol",
    "Right", "Sağ",
    "Start", "Başlat",
    "Select", "Seç",
    "Fold Screen (NDS)", "Ekranı Göm (NDS)",
    "Tap Screen (NDS)", "Ekrana Dokun (NDS)",
    "Emulator " ICON_FK_PAUSE "/" ICON_FK_PLAY, "Emülatör " ICON_FK_PAUSE "/" ICON_FK_PLAY, 
    "Emulator " ICON_FK_BACKWARD,        "Emülatör " ICON_FK_BACKWARD,
    "Emulator " ICON_FK_FORWARD,         "Emülatör " ICON_FK_FORWARD,
    "Emulator " ICON_FK_FAST_FORWARD,    "Emülatör " ICON_FK_FAST_FORWARD,
    "Capture State 0", "Anı Yakala 0",
    "Restore State 0", "Anı Geri Getir 0",
    "Capture State 1", "Anı Yakala 1",
    "Restore State 1", "Anı Geri Getir 1",
    "Capture State 2", "Anı Yakala 2",
    "Restore State 2", "Anı Geri Getir 2",
    "Capture State 3", "Anı Yakala 3",
    "Restore State 3", "Anı Geri Getir 3",
    "Analog Up/Down", "Analog Yukarı/Aşağı",
    "Analog Left/Right", "Analog Sol/Sağ",
    "Analog L", "Analog L",
    "Analog R", "Analog R",
    "Display FPS: %2.1f\n", "Ekran FPS'i: %2.1f\n",
    "Emulation FPS: %2.1f\n", "Emülasyon FPS'i: %2.1f\n",
    ICON_FK_VOLUME_UP " Audio", ICON_FK_VOLUME_UP " Ses",
    "Left Audio Channel", "Sol Ses Kanalı",
    "Right Audio Channel", "Sağ Ses Kanalı",
    "Channel 0", "Kanal 0",
    "Channel 1", "Kanal 1",
    "Channel 2", "Kanal 2",
    "Channel 3", "Kanal 3",
    ...
    "Channel E", "Kanal E",
    "Channel F", "Kanal F",
    "Channel 1 (Square)", "Kanal 1 (Kare)",
    "Channel 2 (Square)", "Kanal 2 (Kare)",
    "Channel 3 (Wave)", "Kanal 3 (Dalga)",
    "Channel 4 (Noise)", "Kanal 4 (Parazit)",
    "Channel A (FIFO)", "Kanal A (FIFO)",
    "Channel B (FIFO)", "Kanal B (FIFO)",
    "Audio Ring (Samples Available: %d)", "Sağ Halka (Örnek Var): %d)",
    "Audio Watchdog Triggered %d Times", "Ses Gözlemcisi %d Kere Tekrarlandı ",
    ICON_FK_INFO_CIRCLE " Build Info", ICON_FK_INFO_CIRCLE " Yapılandırma Verisi",
    "Commit Hash:", "Commit Hash",
    ICON_FK_SERVER " Registers", ICON_FK_SERVER " Kayıtlar",
    ICON_FK_LIST_OL " Disassembly", ICON_FK_LIST_OL " Söküm",
    ICON_FK_EXCHANGE " Read/Write Memory Address", ICON_FK_EXCHANGE " Bellek Adresi Okuma/Yazma",
    "address", "adres",
    "data (32 bit)", "veri (32 bit)",
    "data (16 bit)", "veri (16 bit)",
    "data (8 bit)", "veri (8 bit)",
    "data (signed 32b)", "veri (32b işaretli)",
    "data (signed 16b)", "veri (16b işaretli)",
    "data (signed 8b)", "veri (8b işaretli)",
    ICON_FK_PENCIL_SQUARE_O " Memory", ICON_FK_PENCIL_SQUARE_O " Bellek",
    ICON_FK_AREA_CHART " Emulator Stats", ICON_FK_AREA_CHART " Emülatör İstatistikleri",
    "Show/Hide %s Panel\n", "%s Panelini Göster/Göm \n",
    "Press new button " ICON_FK_SIGN_IN, "Eklenecek Tuşa Bas " ICON_FK_SIGN_IN,
    "Move Axis ", "Ekseni Hareket Ettir ",
    "Not bound", "Tuş Girdisi Yok",
    "Hat %d %s", "Şapka %d %s",
    "Analog %d %s", "Analog %d %s",
    "Key %d", "Girdi %d",
    "Analog %d (%0.2f)", "Analog %d (%0.2f)",
    "Load ROM from file (%s)", "Dosyayla ROM yükle (%s)",
    "You can also drag & drop a ROM to load it", "Sürükle-bırak ile de ROM dosyası yükleyebilirsiniz ",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "Dosyayla ROM(%s), kayıt(.sav), veya GBA bios(gba_bios.bin) yükle",
    "You can also drag & drop a ROM/save file to load it", "Sürükle-bırak ile de ROM/kayıt dosyası yükleyebilirsiniz ",
    "Open ROM", "ROM'u Aç",
    ICON_FK_CLOCK_O " Load Recently Played Game", ICON_FK_CLOCK_O " Yakın Zamanda Oynanmış Oyunu Aç",
    ICON_FK_DOWNLOAD " Export Save", ICON_FK_DOWNLOAD  " Kaydı Yükle",
    "No recently played games", "Yakın zamanda oynanmış oyun yok",
    ICON_FK_GAMEPAD " Controllers", ICON_FK_GAMEPAD " Kontrolcüler",
    "Controller", "Kontrolcü",
    "No Controller", "Kontrolcü yok",
    "Reset Default Controller Bindings", "Kontrolcü Girdilerini Sıfırla",
    "Rumble Supported", "Rumble Ayarı Açık",
    "Rumble Not Supported", "Rumble Ayarı Kapalı",
    ICON_FK_FLOPPY_O " Save States", ICON_FK_FLOPPY_O " Kayıtlar",
    "Save Slot %d", "Kayıt %d",
    "Capture", "Yakala",
    "Restore", "Geri Getir",
    "This save state came from an incompatible build. SkyEmu has attempted to recover it, but there may be issues", "Bu kayıt alanı uyumsuz bir sürümden kalma. SkyEmu bu sürümü çalıştırmayı deneyecek, ancak hatalar olabilir",
    ICON_FK_DESKTOP " Display Settings", ICON_FK_DESKTOP " Ekran Ayarları",
    "Screen Shader", "Ekran Gölgelendirmesi",
    "Pixelate\0Bilinear\0LCD\0LCD & Subpixels\0Smooth Upscale (xBRZ)\0", "Pikselleştir\0Bilineer\0LCD\0LCD & Subpixel\0Pürüzsüz Upscaling (xBRZ)\0",
    "Screen Rotation", "Ekran ",
    "0 degrees\00090 degrees\000180 degrees\000270 degrees\0", "0 derece\00090 derece\000180 derece\000270 derece",
    "Color Correction", "Renk Doğrulama",
    "Strength: %.2f", "Seviye: %.2f",
    "Screen Ghosting", "Ghosting",
    "Force Integer Scaling", "Tamsayısal Büyütmeyi Zorla",
    "Stretch Screen to Fit", "Ekranı Sığdırmak için Genişlet",
    "Game Boy Color Palette", "Game Boy Renk Paleti",
    "GB Palette %d", "GB Paleti %d",
    "Reset Palette to Defaults", "Paleti Sıfırla",
    ICON_FK_KEYBOARD_O " Keybinds", ICON_FK_KEYBOARD_O " Tuş Atamaları",
    "Reset Default Keybinds", "Tuş Atamalarını Sıfırla",
    ICON_FK_WRENCH " Advanced",ICON_FK_WRENCH " Gelişmiş",
    "Light Mode", "Açık Mod", 
    "Show Debug Tools", "Debugging Araç Gereçlerini Göster",
    "Adjust volume", "Sesi yükselt",
    "Show/Hide Menu Panel", "Paneli Göster/Göm",
    "Rewind at 8x speed", "8x Hızda Geri Sar",
    "Rewind at 4x speed", "4x Hızda Geri Sar",
    "Toggle pause/play.\n When paused, the rom selection screen will be shown.", "Durdurmayı/Oynatmayı Aç.\n Durdurlduğunda, ROM-seçim ekranı gösterilecektir.",
    "Run at 2x Speed", "2x Hızda Çalıştır",
    "Run at the fastest speed possible", "Mümkün olan en yüksek hızda çalıştır",
    "Screen", "Ekran",
    "LCD Shader Init", "LCD Gölgelendirmesini Parafe Et ",
    "Menu", "Menü",
    "Copy as..", "Şöyle kopyala..",
    "Current", "Şu anki",
    "Original", "Orijinal",
    "Opacity", "Saydamlık",
    ICON_FK_HAND_O_RIGHT " Touch Control Settings", ICON_FK_HAND_O_RIGHT " Dokunmatik Ekran Ayarları",
    "Hide when inactive", "Pasifken göm",
    ICON_FK_FILE_O " Dump Memory to File", ICON_FK_FILE_O " Belleği Dosyaya Yığ",
    "Start Address", "Başlangıç Adresi",
    "Size", "Boyut",
    "Save Memory Dump", "Bellek Yığınını Kaydet",
    ICON_FK_RANDOM " Last Branch Locations", ICON_FK_RANDOM " Son Branş Lokasyonu",
    "Opacity: %.2f", "Saydamlık: %.2f",
    "Step Instruction", "Adım Talimatı",
    "Step Frame", "Adım Çerçevesi",
    "Disconnect Log", "Kaydın Bağını Kes",
    ICON_FK_FOLDER_OPEN " Open File From Disk", ICON_FK_FOLDER_OPEN " Dosyayı Diskten Aç",
    "Exit File Browser", "Dosya Gezginini Kapat",
    "Go back to recently loaded games", "En son oynanmış oyunlara geri git",
    "Go to parent directory", "Sahip dizine git",
    ...
    "Turbo L", "Turbo L",
    "Turbo R", "Turbo R",
    "Solar Sensor+", "Solar Sensör +",
    "Solar Sensor-", "Solar Sensör -",
    "Theme", "Tema",
    "Solar Sensor", "Solar Sensör",
    "Brightness: %.2f", "Parlaklık: %.2f",
    "Dark\0Light\0Black\0Custom\0", "Koyu\0Açık\0Siyah\0Özel\0",
    "Always Show Menu/Nav Bar", "Her Zaman Menü/Navigasyon Barını Göster",
    "Language", "Dil",
    "UP", "YUKARI",
    "DOWN", "AŞAĞI",
    "LEFT", "SOL",
    ...
    "INSERT", "INSERT_TUŞU",
    "DELETE", "DELETE_TUŞU",
    "LEFT_SHIFT", "SOL_SHIFT",
    "LEFT_CONTROL", "SOL_KONTROL",
    "LEFT_ALT", "SOL_ALT",
    "LEFT_SUPER", "SOL_SÜPER",
    "RIGHT_SHIFT", "SAĞ_SHIFT",
    "RIGHT_CONTROL", "SAĞ_KONTROL",
    "RIGHT_ALT", "SAĞ_ALT",
    "RIGHT_SUPER", "SAĞ_SÜPER",
    "MENU", "MENÜ",
    "Enable Turbo and Hold Button Modifiers", "Turboyu Çalıştır & Değiştiricilere Basılı Tut",
    "Scale", "Boyut",
    "Scale: %.2f","Boyut: %.2f",
    ICON_FK_CLOUD " Google Drive", ICON_FK_CLOUD " Google Drive",
    ICON_FK_SIGN_IN " Login", ICON_FK_SIGN_IN " Giriş Yap",
    ICON_FK_SIGN_OUT " Logout", ICON_FK_SIGN_OUT " Çıkış Yap",
    ICON_FK_USER_PLUS " Register", ICON_FK_USER_PLUS " Kayıt Yap",
    "GBA Color Correction Type","GBA Renk Doğrulama Tipi",
    ICON_FK_TEXT_HEIGHT " GUI",ICON_FK_TEXT_HEIGHT " GUI",
    "Full Screen","Tam Ekran",
    ICON_FK_CODE_FORK " Additional Search Paths",ICON_FK_CODE_FORK " Ekstra Arama Yolları",
    "Save File/State Path","Dosya Yolunu Kaydet",
    "BIOS/Firmware Path","BIOS/Firmware Yolu",
    "Create new save files in Save Path","Kayıt Yolunda yeni kayıt dosyaları oluştur",
    ICON_FK_CROSSHAIRS " Located Files",ICON_FK_CROSSHAIRS " Bulunan Dosyalar",
    "Force GB games to run in DMG mode","GB oyunlarını DMG modunda çalışmaya zorla",
    "Enable HTTP Control Server","HTTP Kontrol Sunucusunu Aç",
    "Server Port","Sunucu Bağlantı Noktası",
    "Toggle Full Screen","Tam Ekranı Aç",
    "Can't find all needed BIOS/Boot ROM/Firmware Files.","ROM/Firmware Dosyalarını çalıştırmak için gereken BIOS/Boot dosyaları bulunamadı.",
    "Accuracy will suffer and some features won't work.","Doğruluk azalacak ve bazı özellikler çalışmayacak.",
    //New in v3
    "Avoid NDS Touchscreen", "NDS Dokunmatik Ekranından Kaçın",
    ICON_FK_PLUS " New", ICON_FK_PLUS " Yeni",
    ICON_FK_KEY " Action Replay Codes", ICON_FK_KEY " Action Replay Kodları",
    "Create new files in paths", "Yeni dosyaları bu yollarda oluştur",
    "Cheat Code Path", "Hile Kodu Yolu",
    // extra added
    "Hardcore Mode", "Zorlayıcı Mod",
    "Encore Mode", "Tekrar Modu",
    "Notifications", "Bildirimler",
    "Only one notification at a time", "Birden fazla bildirim olmasını kapat",
    "Challenge Indicators", "Udfordringsindikatorer",
    "Progress Indicators", "İlerleme Belirticileri",
    "Theme Path","Tema Yolu",
    "Button Labels", "Tuş Adları",
    "Show Screen Bezel", "Görüntü Aygıtını Göster",
    "Custom Font","Özel Yazıtipi",
    "Font Scale","Yazıtipi Boyutu",
    "Custom Theme Name","Özel Tema Adı",
    "Custom Theme Author","Özel Temanın Yazarı",
    ICON_FK_FILE_O " File Browser", ICON_FK_FILE_O " Dosya Gezgini",
    "Go to home directory","Ana dizine dön",
    "Download Cache Size: %s", "Önbellek Boyutu: %s",
    "Clear Download Cache", "Önbelleği Sil",
    NULL,NULL
};
...
void se_set_language(int language_enum){
    ...
    if(language_enum==SE_LANG_TURKISH)new_map = tr_localization_array;
...
int se_convert_locale_to_enum(const char* clocale) {
    ...
    } else if (strcmp(lowercase_locale, "tr") == 0 || strcmp(lowercase_locale, "tur") == 0 || strcmp(lowercase_locale, "turkish") == 0) {
        return SE_LANG_TURKISH;
    }
...
const char* se_language_string(int language_enum){
    switch (language_enum){
        ...
        case SE_LANG_TURKISH: return "Türkçe";
#endif 
    }
    return "";
}
