...
static char* hy_localization_array[]={
    ...
    "Start", "Սկսեք",
    "Select", "Ընտրեք",
    "Fold Screen (NDS)", "Ծալեկ Եկրանը (NDS)",
    "Tap Screen (NDS)", "Թակեկ Եկրանը (NDS)",
    "Emulator " ICON_FK_PAUSE "/" ICON_FK_PLAY, "Սիմուլյատոր " ICON_FK_PAUSE "/" ICON_FK_PLAY, 
    "Emulator " ICON_FK_BACKWARD,        "Սիմուլյատոր " ICON_FK_BACKWARD,
    "Emulator " ICON_FK_FORWARD,         "Սիմուլյատոր " ICON_FK_FORWARD,
    "Emulator " ICON_FK_FAST_FORWARD,    "Սիմուլյատոր " ICON_FK_FAST_FORWARD,
    "Capture State 0", "կարենք Վիճակը 0",
    "Restore State 0", "կարենք Վիճակը 0",
    "Capture State 1", "կարենք Վիճակը 1",
    "Restore State 1", "կարենք Վիճակը 1",
    "Capture State 2", "կարենք Վիճակը 2",
    "Restore State 2", "կարենք Վիճակը 2",
    "Capture State 3", "կարենք Վիճակը 3",
    "Restore State 3", "կարենք Վիճակը 3",
    "Analog Up/Down", "Անալոգային Վերև/Ներքև",
    "Analog Left/Right", "Անալոգային Ձախ/Աջ",
    "Analog L", "Անալոգային L",
    "Analog R", "Անալոգային R",
    "Display FPS: %2.1f\n", "Էկրանի թարմացման արագություն: %2.1f\n",
    "Emulation FPS: %2.1f\n", "հաշվողական թարմացման արագություն: %2.1f\n",
