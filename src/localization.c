...
static char* fr_localization_array[]={
    ...
    "address", "adresse",
    "data (32 bit)", "données (32 bit)",
    "data (16 bit)", "données (16 bit)",
    "data (8 bit)", "données (8 bit)",
    "data (signed 32b)", "données (-/+32 bit)",
    "data (signed 16b)", "données (-/+16 bit)",
    "data (signed 8b)", "données (-/+8 bit)",
    ...
    ICON_FK_FLOPPY_O " Save States", ICON_FK_FLOPPY_O " Sauvegarder les Etats",
    "Save Slot %d", "Sauvegarder le Slot %d",
    "Capture", "Capturer",
    "Restore", "Restaurer",
    ...
    "Create new files in paths", "Créer de nouveaux fichiers dans le chemin d'accès",
