...
// Japanese translation - TODO: replace placeholder values (currently identical to the English key) with real Japanese text
static char* ja_localization_array[]={
    ICON_FK_FILE_O " Load Game", ICON_FK_FILE_O " ゲームを読み込む",
    "Up", "上",
    "Down", "下",
    "Left", "左",
    "Right", "右",
    "Start", "スタート",
    "Select", "セレクト",
    "Fold Screen (NDS)", "画面を折る (NDS)",
    "Tap Screen (NDS)", "画面をタップ (NDS)",
    "Emulator " ICON_FK_PAUSE "/" ICON_FK_PLAY, "エミュレータ " ICON_FK_PAUSE "/" ICON_FK_PLAY,
    "Emulator " ICON_FK_BACKWARD, "エミュレータ " ICON_FK_BACKWARD,
    "Emulator " ICON_FK_FORWARD, "エミュレータ " ICON_FK_FORWARD,
    "Emulator " ICON_FK_FAST_FORWARD, "エミュレータ " ICON_FK_FAST_FORWARD,
    "Capture State 0", "ステートセーブ 0",
    "Restore State 0", "ステートロード 0",
    "Capture State 1", "ステートセーブ 1",
    "Restore State 1", "ステートロード 1",
    "Capture State 2", "ステートセーブ 2",
    "Restore State 2", "ステートロード 2",
    "Capture State 3", "ステートセーブ 3",
    "Restore State 3", "ステートロード 3",
    "Analog Up/Down", "アナログ 上/下",
    "Analog L", "アナログ L",
    "Analog R", "アナログ R",
    "Display FPS: %2.1f\n", "表示 FPS: %2.1f\n",
    "Emulation FPS: %2.1f\n", "エミュレーション FPS: %2.1f\n",
    ICON_FK_VOLUME_UP " Audio", ICON_FK_VOLUME_UP " オーディオ",
    "Left Audio Channel", "左オーディオチャンネル",
    "Right Audio Channel", "右オーディオチャンネル",
    "Channel 0", "チャンネル 0",
    "Channel 1", "チャンネル 1",
    "Channel 2", "チャンネル 2",
    "Channel 3", "チャンネル 3",
    ...
    "Channel E", "チャンネル E",
    "Channel F", "チャンネル F",
    "Channel 1 (Square)", "チャンネル 1 (矩形波)",
    "Channel 2 (Square)", "チャンネル 2 (矩形波)",
    "Channel 3 (Wave)", "チャンネル 3 (波形)",
    "Channel 4 (Noise)", "チャンネル 4 (ノイズ)",
    "Channel A (FIFO)", "チャンネル A (FIFO)",
    "Channel B (FIFO)", "チャンネル B (FIFO)",
    "Audio Ring (Samples Available: %d)", "オーディオリング (利用可能サンプル数: %d)",
    "Audio Watchdog Triggered %d Times", "オーディオウォッチドッグが %d 回発生",
    ICON_FK_INFO_CIRCLE " Build Info", ICON_FK_INFO_CIRCLE " ビルド情報",
    "Commit Hash:", "コミットハッシュ:",
    ICON_FK_SERVER " Registers", ICON_FK_SERVER " レジスタ",
    ICON_FK_LIST_OL " Disassembly", ICON_FK_LIST_OL " 逆アセンブル",
    ICON_FK_EXCHANGE " Read/Write Memory Address", ICON_FK_EXCHANGE " メモリアドレスの読み書き",
    "address", "アドレス",
    "data (32 bit)", "データ (32bit)",
    "data (16 bit)", "データ (16bit)",
    "data (8 bit)", "データ (8bit)",
    "data (signed 32b)", "データ (符号付き32bit)",
    "data (signed 16b)", "データ (符号付き16bit)",
    "data (signed 8b)", "データ (符号付き8bit)",
    ICON_FK_PENCIL_SQUARE_O " Memory", ICON_FK_PENCIL_SQUARE_O " メモリ",
    ICON_FK_AREA_CHART " Emulator Stats", ICON_FK_AREA_CHART " エミュレータ統計",
    "Show/Hide %s Panel\n", "%s パネルの表示/非表示\n",
    "Press new button " ICON_FK_SIGN_IN, "新しいボタンを押してください " ICON_FK_SIGN_IN,
    "Move Axis ", "軸を動かしてください ",
    "Not bound", "未割り当て",
    "Hat %d %s", "ハット %d %s",
    "Analog %d %s", "アナログ %d %s",
    "Key %d", "キー %d",
    "Analog %d (%0.2f)", "アナログ %d (%0.2f)",
    "Load ROM from file (%s)", "ファイルからROMを読み込む (%s)",
    "You can also drag & drop a ROM to load it", "ドラッグ&ドロップでROMを読み込むこともできます",
    "Load ROM(%s), save(.sav), or GBA bios (gba_bios.bin) from file", "ファイルから ROM(%s)、セーブ(.sav)、または GBA BIOS (gba_bios.bin) を読み込む",
    "You can also drag & drop a ROM/save file to load it", "ROM/セーブファイルをドラッグ&ドロップして読み込むこともできます",
    "Open ROM", "ROMを開く",
    ICON_FK_CLOCK_O " Load Recently Played Game", ICON_FK_CLOCK_O " 最近プレイしたゲームを読み込む",
    ICON_FK_DOWNLOAD " Export Save", ICON_FK_DOWNLOAD " セーブをエクスポート",
    "No recently played games", "最近プレイしたゲームはありません",
    ICON_FK_GAMEPAD " Controllers", ICON_FK_GAMEPAD " コントローラー",
    "No Controller", "コントローラーなし",
    "Reset Default Controller Bindings", "コントローラーの初期設定にリセット",
    "Rumble Supported", "振動対応",
    "Rumble Not Supported", "振動非対応",
    ICON_FK_FLOPPY_O " Save States", ICON_FK_FLOPPY_O " ステートセーブ",
    "Save Slot %d", "スロット %d",
    "Capture", "保存",
    "Restore", "読込",
    "This save state came from an incompatible build. SkyEmu has attempted to recover it, but there may be issues", "このステートセーブは互換性のないビルドで作成されたものです。SkyEmu は復元を試みましたが、問題が発生する可能性があります",
    ICON_FK_DESKTOP " Display Settings", ICON_FK_DESKTOP " 表示設定",
    "Screen Shader", "画面シェーダー",
    "Pixelate", "補完なし",
    "Bilinear", "バイリニア",
    "LCD", "LCD",
    "LCD & Subpixels", "LCD & サブピクセル",
    "Smooth Upscale (xBRZ)", "スムーズアップスケール (xBRZ)",
    ...
    "Strength: %.2f", "強さ: %.2f",
    "Screen Ghosting", "画面の残像",
    "Force Integer Scaling", "整数倍スケーリングを強制",
    "Stretch Screen to Fit", "画面に合わせて引き伸ばす",
    "Game Boy Color Palette", "ゲームボーイカラー パレット",
    ICON_FK_KEYBOARD_O " Keybinds", ICON_FK_KEYBOARD_O " キー割り当て",
    "Reset Default Keybinds", "キー割り当てを初期設定にリセット",
    ICON_FK_WRENCH " Advanced", ICON_FK_WRENCH " 詳細設定",
    "Light Mode", "ライトモード",
    "Show Debug Tools", "デバッグツールを表示",
    "Adjust volume", "音量を調整",
    "Show/Hide Menu Panel", "メニューパネルの表示/非表示",
    "Rewind at 8x speed", "8倍速で巻き戻し",
    "Rewind at 4x speed", "4倍速で巻き戻し",
    "Toggle pause/play.\n When paused, the rom selection screen will be shown.", "一時停止/再生を切り替えます。\n 一時停止中は ROM 選択画面が表示されます。",
    "Run at 2x Speed", "2倍速で実行",
    "Run at the fastest speed possible", "可能な限り高速で実行",
    "Screen", "画面",
    "LCD Shader Init", "LCDシェーダー初期化",
    "Menu", "メニュー",
    "Copy as..", "コピー形式..",
    "Current", "現在",
    "Original", "オリジナル",
    "Opacity", "不透明度",
    ICON_FK_HAND_O_RIGHT " Touch Control Settings", ICON_FK_HAND_O_RIGHT " タッチ操作設定",
    "Hide when inactive", "非アクティブ時に隠す",
    ICON_FK_FILE_O " Dump Memory to File", ICON_FK_FILE_O " メモリをファイルに書き出す",
    "Start Address", "開始アドレス",
    "Size", "サイズ",
    "Save Memory Dump", "メモリダンプを保存",
    ICON_FK_RANDOM " Last Branch Locations", ICON_FK_RANDOM " 直近の分岐位置",
    "Opacity: %.2f", "不透明度: %.2f",
    "Step Instruction", "命令単位でステップ実行",
    "Step Frame", "フレーム単位でステップ実行",
    "Disconnect Log", "切断ログ",
    ICON_FK_FOLDER_OPEN " Open File From Disk", ICON_FK_FOLDER_OPEN " ディスクからファイルを開く",
    "Exit File Browser", "ファイルブラウザを終了",
    "Go back to recently loaded games", "最近読み込んだゲームに戻る",
    "Go to parent directory", "親ディレクトリへ移動",
    "UP", "上",
    "DOWN", "下",
    "LEFT", "左",
    "RIGHT", "右",
    ...
    "Turbo L", "連射 L",
    "Turbo R", "連射 R",
    "Solar Sensor+", "ソーラーセンサー+",
    "Solar Sensor-", "ソーラーセンサー-",
    "Theme", "テーマ",
    "Solar Sensor", "ソーラーセンサー",
    "Brightness: %.2f", "明るさ: %.2f",
    "Dark", "ダーク",
    "Light", "ライト",
    "Black", "ブラック",
    "Custom", "カスタム",
    "Always Show Menu/Nav Bar", "常にメニュー/ナビゲーションバーを表示",
    "Language", "言語",
    "SPACE", "スペース",
    "ESCAPE", "ESC",
    "ENTER", "エンター",
    ...
    "UP", "上",
    "LEFT_SHIFT", "左Shift",
    "LEFT_CONTROL", "左Control",
    "LEFT_ALT", "左Alt",
    "LEFT_SUPER", "左Super",
    "RIGHT_SHIFT", "右Shift",
    "RIGHT_CONTROL", "右Control",
    "RIGHT_ALT", "右Alt",
    "RIGHT_SUPER", "右Super",
    "MENU", "メニュー",
    "Enable Turbo and Hold Button Modifiers", "連射・長押し修飾キーを有効化",
    "Scale", "スケール",
    "Scale: %.2f", "スケール: %.2f",
    "GBA Color Correction Type", "GBA色補正タイプ",
    ICON_FK_TEXT_HEIGHT " GUI", ICON_FK_TEXT_HEIGHT " GUI",
    "Full Screen", "フルスクリーン",
    ICON_FK_CODE_FORK " Additional Search Paths", ICON_FK_CODE_FORK " 追加の検索パス",
    "Save File/State Path", "セーブ/ステート",
    "BIOS/Firmware Path", "BIOS/ファームウェア",
    "Create new save files in Save Path", "セーブパスに新しいセーブファイルを作成",
    "Force GB games to run in DMG mode", "GBゲームをDMGモードで強制実行",
    "Enable HTTP Control Server", "HTTP制御サーバーを有効化",
    "Server Port", "サーバーポート",
    "Toggle Full Screen", "フルスクリーン切り替え",
    "Can't find all needed BIOS/Boot ROM/Firmware Files.", "必要な BIOS/起動 ROM/ファームウェアファイルが見つかりません。",
    "Accuracy will suffer and some features won't work.", "精度が低下し、一部の機能が動作しなくなります。",
    "Avoid NDS Touchscreen", "NDSタッチスクリーンを避ける",
    ICON_FK_PLUS " New", ICON_FK_PLUS " 新規",
    ICON_FK_KEY " Action Replay Codes", ICON_FK_KEY " Action Replay コード",
    "Create new files in paths", "パス内に新しいファイルを作成",
    "Cheat Code Path", "チートコード",
    "Disabled in Hardcore Mode", "ハードコアモードでは無効",
    "Rewind", "巻き戻し",
    "Slow", "低速",
    "Fast Forward", "早送り",
    "Save File", "セーブファイル",
    ICON_FK_CROSSHAIRS " Located Files", ICON_FK_CROSSHAIRS " 検出されたファイル",
    "GUI Scale", "GUIスケール",
    "Auto\0Vertical\0Horizontal\0Hybrid Large Top\0Hybrid Large Bottom\0Vertical Large Top\0Vertical Large Bottom\0Horizontal Large Top\0Horizontal Large Bottom\0\0", "自動\0縦\0横\0ハイブリッド(上大)\0ハイブリッド(下大)\0縦(上大)\0縦(下大)\0横(上大)\0横(下大)\0\0",
    "NDS Screen Layout", "NDS画面レイアウト",
    "Never Overlap Screen", "画面を重ねない",
    "Prevent Overlap in Portrait", "縦画面表示時に重なりを防ぐ",
    "Prevent Overlap in Landscape", "横画面表示時に重なりを防ぐ",
    "Button Labels", "ボタンラベル",
    "Show Screen Bezel", "画面ベゼルを表示",
    "Hardcore Mode", "ハードコアモード",
    "Encore Mode", "アンコールモード",
    "Notifications", "通知",
    "Only one notification at a time", "一度に1つの通知のみ表示",
    "Progress Indicators", "進行状況インジケーター",
    "Leaderboard Trackers", "リーダーボードトラッカー",
    "Challenge Indicators", "チャレンジインジケーター",
    "Theme Path", "テーマのパス",
    "Custom Font", "カスタムフォント",
    "Font Scale", "フォントスケール",
    "Custom Theme Name", "カスタムテーマ名",
    "Custom Theme Author", "カスタムテーマ作者",
    ICON_FK_FILE_O " File Browser", ICON_FK_FILE_O " ファイルブラウザ",
    "Go to home directory", "ホームディレクトリへ移動",
    "Enable Download Cache", "ダウンロードキャッシュを有効化",
    "Download Cache Size: %s", "ダウンロードキャッシュサイズ: %s",
    "Clear Download Cache", "ダウンロードキャッシュを削除",
    "Local", "ローカル",
    "Cloud", "クラウド",
    "% of players", "プレイヤーの%",
    "Show/Hide %s Panel", "%s パネルの表示/非表示",
    "%s (Points: %d)", "%s (ポイント: %d)",
    ICON_FK_SIGN_IN " Login", ICON_FK_SIGN_IN " ログイン",
    ICON_FK_SIGN_OUT " Logout", ICON_FK_SIGN_OUT " ログアウト",
    ICON_FK_USER_PLUS " Register", ICON_FK_USER_PLUS " 新規登録",
    "This game has no achievements", "このゲームには実績がありません",
    "You have %d of %d achievements unlocked.", "%d / %d 個の実績を解除しました。",
    "Points: %d/%d", "ポイント: %d/%d",
    "Unofficial achievement unlocked!", "非公式の実績を解除しました!",
    "Achievement unlocked!", "実績を解除しました!",
    "score", "スコア",
    "Score", "スコア",
    "time", "時間",
    "Time", "時間",
    "Your best %s: %s", "あなたの最高 %s: %s",
    "Ranked %d out of %d", "%d 位 / %d 人中",
    "Leaderboard attempt started: ", "リーダーボードへの挑戦を開始: ",
    "Leaderboard attempt failed: ", "リーダーボードへの挑戦が失敗: ",
    "Leaderboard attempt submitted: ", "リーダーボードへの挑戦を送信: ",
    " for ", " の ",
    "Mastered", "マスター済み",
    "Completed", "達成済み",
    "All %d achievements unlocked", "全 %d 個の実績を解除",
    "Playing %s", "%s をプレイ中",
    "%d/%d points, %d/%d achievements", "%d/%d ポイント、%d/%d 実績",
    "Softcore mode", "ソフトコアモード",
    "Login failed: username is required", "ログイン失敗: ユーザー名が必要です",
    "Branch \"%s\" built on %s %s", "ブランチ \"%s\" (%s %s にビルド)",
    "Unknown", "不明",
    "Almost There", "もう少し",
    "Active Challenges", "進行中のチャレンジ",
    "Recently Unlocked", "最近解除した実績",
    "Unofficial", "非公式",
    "Unsupported", "未対応",
    "Unlocked", "解除済み",
    "Locked", "ロック中",
    "Show/Hide Menu Panel", "メニューパネルの表示/非表示",
    "Show/Hide RetroAchievements Panel", "RetroAchievementsパネルの表示/非表示",
    NULL,NULL
};
...
void se_set_language(int language_enum){
    ...
    if(language_enum==SE_LANG_JAPANESE)new_map = ja_localization_array;
...
const char* se_language_string(int language_enum){
    switch (language_enum){
        ...
        case SE_LANG_JAPANESE: return "日本語";
#endif
    }
    return "";
}
