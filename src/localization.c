...
static char* gr_localization_array[]={
    ...
    "Start", "Εκκίνηση",
    "Select", "Επιλογή",
    "Fold Screen (NDS)", "Δίπλωμα Οθόνης (NDS)",
    "Tap Screen (NDS)", "Άγγιγμα Οθόνης (NDS)",
    ...
    "Capture State 0", "Αποθήκευση Κατάστασης 0",
    "Restore State 0", "Φόρτωση Κατάστασης 0",
    "Capture State 1", "Αποθήκευση Κατάστασης 1",
    "Restore State 1", "Φόρτωση Κατάστασης 1",
    "Capture State 2", "Αποθήκευση Κατάστασης 2",
    "Restore State 2", "Φόρτωση Κατάστασης 2",
    "Capture State 3", "Αποθήκευση Κατάστασης 3",
    "Restore State 3", "Φόρτωση Κατάστασης 3",
    ...
    "Save Slot %d", "Θέση Αποθήκευσης %d",
    "Capture", "Αποθήκευση",
    "Restore", "Επαναφορά",
    ...
    "LEFT", "Αριστερά",
    "RIGHT", "Δεξιά",
    "Reset Game", "Επανεκκίνηση Παιχνιδιού",
    "Turbo A", "Τούρμπο A",
    "Turbo B", "Τούρμπο B",
    "Turbo X", "Τούρμπο X",
    "Turbo Y", "Τούρμπο Y",
    ...
    "MENU", "Μενού",
    "Enable Turbo and Hold Button Modifiers", "Ενεργοποίηση Τροποποιητων Τούρμπο και Πατημένου Κουμπιού",
    "Scale", "Κλίμακα",
    "Scale: %.2f","Κλίμακα: %.2f",
    "GBA Color Correction Type","Τύπος Διόρθωσης Χρώματος GBA",
    ...
    "Save File/State Path","Αποθηκευτικό Μονοπάτι Αρχειου/Καταστασης",
    "BIOS/Firmware Path","BIOS/Υλικολογισμικό Μονοπάτι",
    "Create new save files in Save Path","Δημιουργία νέων αρχείων αποθήκευσης στο Μονοπάτι Αποθήκευσης",
    ICON_FK_CROSSHAIRS " Located BIOS/Firmware Files",ICON_FK_CROSSHAIRS " Βρέθεντα BIOS/Υλικολογισμικά αρχεία",
    "Force GB games to run in DMG mode","Αναγκαστική εκκίνηση GB παιχνιδιών σε DMG λειτουργία",
