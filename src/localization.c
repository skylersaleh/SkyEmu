...
static char* nl_localization_array[]={
    ...
    "Press new button "     , " Klik op de nieuwe knop" ICON_FK_SIGN_IN,
...
static char* tr_localization_array[]={
    ...
    "Reset Default Controller Bindings", "Varsayılan Kontrolcü Girdilerini Sıfırla",
    "Rumble Supported", "Rumble Ayarı Açık",
    "Rumble Not Supported", "Rumble Ayarı Kapalı",
    ICON_FK_FLOPPY_O " Save States", ICON_FK_FLOPPY_O " Kayıt Alanları",
    "Save Slot %d", "Kayıt Alanı %d",
    "Capture", "Yakala",
    "Restore", "Geri Getir",
    ...
    "Pixelate\0Bilinear\0LCD\0LCD & Subpixels\0Smooth Upscale (xBRZ)\0", "Pikselleştir\0Bilineer\0LCD\0LCD & Pikselaltı\0Pürüzsüz Upscaling (xBRZ)\0",
    ...
    "Reset Palette to Defaults", "Paleti Varsayılan Yap",
    ICON_FK_KEYBOARD_O " Keybinds", ICON_FK_KEYBOARD_O " Tuş Atamaları",
    "Reset Default Keybinds", "Varsayılan Tuş Atamalarını Sıfırla",
    ...
    "MENU", "MENÜ",
    "Enable Turbo and Hold Button Modifiers", "Turboyu Aktive Et & Tuş Niteleyicilerine Basılı Tut",
    "Scale", "Boyut",
    "Scale: %.2f","Boyut: %.2f",
