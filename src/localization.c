...
// French translation by Hershel https://github.com/Hrshl7
static char* fr_localization_array[]={
    ...
    ICON_FK_LIST_OL " Disassembly", ICON_FK_LIST_OL " Disassembly",
    ICON_FK_EXCHANGE " Read/Write Memory Address", ICON_FK_EXCHANGE " Adresse de Mémoire Read/Write",
    "address", "adresse",
    "data (32 bit)", "donnée (32 bit)",
    "data (16 bit)", "donnée (16 bit)",
    "data (8 bit)", "dadonnéeto (8 bit)",
    "data (signed 32b)", "donnée (-/+32 bit)",
    "data (signed 16b)", "donnée (-/+16 bit)",
    "data (signed 8b)", "donnée (-/+8 bit)",
    ...
    "Load ROM(.gb, .gbc, .gba, .zip), save(.sav), or GBA bios (gba_bios.bin) from file", "Charger une ROM(.gb, .gbc, .gba, .zip), sauvegarder(.sav), ou bios GBA (gba_bios.bin) depuis un fichier",
    "You can also drag & drop a ROM/save file to load it", "Vous pouvez aussi glisser et déposer une ROM/fichier de sauvegarde pour la/e charger",
    "Open ROM", "Ouvrir ROM",
    ...
    "No recently played games", "Pas de jeux récemment joué",
    ...
    "Capture", "Capturer",
    "Restore", "Restaurer",
    "This save state came from an incompatible build. SkyEmu has attempted to recover it, but there may be issues", "Cet état de sauvegarde provient d'un build incompatible. SkyEmu a essayé de le récupérer, mais il peut y avoir des problèmes",
    ICON_FK_DESKTOP " Display Settings", ICON_FK_DESKTOP " Paramètre d'Affichage",
    "Screen Shader", "Filtre Vidéo",
    "Pixelate\0Bilinear\0LCD\0LCD & Subpixels\0Smooth Upscale (xBRZ)\0", "Pixeliser\0Bilinéaire\0LCD\0LCD & Subpixels\0Amélioration Lisse (xBRZ)\0",
    "Screen Rotation", "Rotation Ecran",
    "0 degrees\00090 degrees\000180 degrees\000270 degrees\0", "0°\00090°\000180°\000270°\0",
    "Color Correction", "Correction de Couleur",
    "Strength: %.2f", "Force: %.2f",
    "Screen Ghosting", "Ghosting d'écran",
    "Force Integer Scaling", "Forcer l'Upscaling Entier",
    "Stretch Screen to Fit", "Ajuster l'Ecran",
    "Game Boy Color Palette", "Palette Game Boy Color",
    ICON_FK_KEYBOARD_O " Keybinds", ICON_FK_KEYBOARD_O " Assignation des Touches",
    "Reset Default Keybinds", "Rétablir l'Assignation des Touches",
    ...
    "Toggle pause/play.\n When paused, the rom selection screen will be shown.", "Alterner pause/play\n Quand mise en pause, l'écran de sélection de rom sera affiché.",
    "Run at 2x Speed", "Faire tourner à une vitesse de 2x",
    "Run at the fastest speed possible", "Faire tourner à la vitesse la plus rapide",
    "Screen", "Ecran",
    ...
    "Start Address", "Adresse de Démarrage",
    "Size", "Taille",
    ...
    "DOWN", "BAS",
    "UP", "HAUT",
    "LEFT_SHIFT", "Maj Gauche",
    "LEFT_CONTROL", "Contrôle Gauche",
    "LEFT_ALT", "Alt Droit",
    "LEFT_SUPER", "Super Gauche",
    "RIGHT_SHIFT", "Maj Droit",
    "RIGHT_CONTROL", "Contrôle Droit",
    "RIGHT_ALT", "Alt Droit",
    "RIGHT_SUPER", "Super Droit",
    "MENU", "MENU",
    "Enable Turbo and Hold Button Modifiers", "Activer les Modificateurs de Boutton Turbo et Hold",
    "Scale", "Echelle",
    "Scale: %.2f","Echelle %.2f",
    "GBA Color Correction Type","Correction de Couleur Type GBA",
    ICON_FK_TEXT_HEIGHT " GUI",ICON_FK_TEXT_HEIGHT " GUI",
    "Full Screen","Plein Ecran",
    ICON_FK_CODE_FORK " Additional Search Paths",ICON_FK_CODE_FORK " Recherche de chemin additionnel",
    ...
    "Force GB games to run in DMG mode","Forcer les jeux GB à tourner en mode DMG",
    ...
    "Can't find all needed BIOS/Boot ROM/Firmware Files.","Impossible de trouver tout les fichiers BIOS/Boot ROM/Firmware nécessaire",
    "Accuracy will suffer and some features won't work.","La précision souffrira et quelques options ne fonctionneront pas.",
    //New in V3
    ...
    ICON_FK_CROSSHAIRS " Located Files", ICON_FK_CROSSHAIRS " Fichiers Localisés",
    ...
    "Never Overlap Screen", "Ne Jamais Superposé l'Ecran",
    ...
    "Branch \"%s\" built on %s %s", "Branche \"%s\" construite sur %s alle %s",
    "Unknown", "Inconnu",
