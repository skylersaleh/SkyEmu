...
const static sb_instr_t sb_decode_table[]={
  ...
  { sb_inc16_impl   , "INC BC"        , "----", 1,2, 2, SB_OP_BC, SB_OP_NONE },
  ...
  { sb_dec16_impl   , "DEC BC"        , "----", 1,2, 2, SB_OP_BC, SB_OP_NONE },
  ...
  { sb_inc16_impl   , "INC DE"        , "----", 1,2, 2, SB_OP_DE, SB_OP_NONE },
  ...
  { sb_dec16_impl   , "DEC DE"        , "----", 1,2, 2, SB_OP_DE, SB_OP_NONE },
  ...
  { sb_inc16_impl   , "INC HL"        , "----", 1,2, 2, SB_OP_HL, SB_OP_NONE },
  ...
  { sb_dec16_impl   , "DEC HL"        , "----", 1,2, 2, SB_OP_HL, SB_OP_NONE },
  ...
  { sb_inc16_impl   , "INC SP"        , "----", 1,2, 2, SB_OP_SP, SB_OP_NONE },
  ...
  { sb_dec16_impl   , "DEC SP"        , "----", 1,2, 2, SB_OP_SP, SB_OP_NONE },
